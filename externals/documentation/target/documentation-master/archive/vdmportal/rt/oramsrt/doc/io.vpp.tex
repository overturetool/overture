\kClass $IO$\index{IO|ClassDef}
\par
\kTypes
\type{\kw{public}\hspace{0.5em}filedirective\index{filedirective|TypeDef}}{\const{start} | \const{append}}
\kFunctions
...
\signature[@p]{\seqof+{\Char } \X @p \X filedirective\index{filedirective|TypeOcc} \Pto \Bool }
