...
\section{A Guided Tour with a Small Example}
...
\subsection{The Combinatorial Testing Perspective}
...
for the VDM Tools (vppgde.exe)\footnote{Only the Graphical version of
  VDM Tools is supported.} will pop-up asking for the path to the
file. 
...
\newpage
\appendix
\section{The Buffers Example in Full}
