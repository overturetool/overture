...
// ***** VDMTOOLS START Name=evaluateSeqComprehension#2|IOmlSequenceComprehension|HashMap KEEP=NO
  public SEM.VAL evaluateSeqComprehension (final IOmlSequenceComprehension expr, final HashMap cxt) throws CGException {
    ...
    if (cond_8.booleanValue()) 
      ...
      pred = null;
    HashSet tmpVal_9 = new HashSet();
    tmpVal_9 = evalBind((IOmlBind) bind, cxt);
    HashSet cxt_us = new HashSet();
    cxt_us = tmpVal_9;
    ...
    boolean tmpQuant_13 = true;
    {
      ...
      {
        for (Iterator enm_42 = cxt_us.iterator(); enm_42.hasNext() && tmpQuant_13; ) {

          HashMap elem_41 = (HashMap) enm_42.next();
          cxt_1 = elem_41;
          ...
          boolean tmpQuant_16 = true;
          {
            ...
            {
              for (Iterator enm_25 = cxt_us.iterator(); enm_25.hasNext() && tmpQuant_16; ) {

                HashMap elem_24 = (HashMap) enm_25.next();
                m = elem_24;
          ...
          var1_15 = new Boolean(tmpQuant_16);
          {
            if ((pred_14 = var1_15).booleanValue()) {
              ...
              boolean tmpQuant_27 = true;
              {

                boolean succ_34 = true;
                HashSet e_set_35 = new HashSet();
                e_set_35.clear();
                e_set_35.addAll(cxt_1.values());
                SEM.VAL elem_1 = null;
                {
                  for (Iterator enm_38 = e_set_35.iterator(); enm_38.hasNext() && tmpQuant_27; ) {

                    Object elem_37 = enm_38.next();
                    succ_34 = true;
                    if (new Boolean((elem_37 instanceof Record)).booleanValue()) 
                      elem_1 = (SEM.VAL) elem_37;
                    else 
                      succ_34 = false;
                    if (succ_34) {
                      ...
                      if ((elem_1 instanceof Record)) 
                        var1_29 = new Boolean(((Object) elem_1 instanceof SEM.NUM));
                      else 
                        var1_29 = new Boolean(false);
                      {
                        if ((pred_28 = var1_29).booleanValue()) {

                          Boolean var2_31 = null;
                          Object argTmp_32 = null;
                          if ((elem_1 instanceof Record)) 
                            if ((elem_1 instanceof SEM.TUPLE)) 
                              argTmp_32 = ((SEM.TUPLE) elem_1).v;
                            else 
                              if ((elem_1 instanceof SEM.TOKEN)) 
                                argTmp_32 = ((SEM.TOKEN) elem_1).v;
                              else 
                                if ((elem_1 instanceof SEM.QUOTE)) 
                                  argTmp_32 = UTIL.ConvertToList(((SEM.QUOTE) elem_1).v);
                                else 
                                  if ((elem_1 instanceof SEM.CHAR)) 
                                    argTmp_32 = ((SEM.CHAR) elem_1).v;
                                  else 
                                    if ((elem_1 instanceof SEM.BOOL)) 
                                      argTmp_32 = ((SEM.BOOL) elem_1).v;
                                    else 
                                      if ((elem_1 instanceof SEM.SET)) 
                                        argTmp_32 = ((SEM.SET) elem_1).v;
                                      else 
                                        if ((elem_1 instanceof SEM.SEQ)) 
                                          argTmp_32 = ((SEM.SEQ) elem_1).v;
                                        else 
                                          if ((elem_1 instanceof SEM.REC)) 
                                            argTmp_32 = ((SEM.REC) elem_1).v;
                                          else 
                                            if ((elem_1 instanceof SEM.NUM)) 
                                              argTmp_32 = ((SEM.NUM) elem_1).v;
                                            else 
                                              argTmp_32 = ((SEM.MAP) elem_1).v;
                          else 
                            UTIL.RunTime("Run-Time Error:A record was expected");
                          var2_31 = new Boolean(UTIL.IsInteger(argTmp_32) && ((Number) argTmp_32).intValue() >= 0);
                          pred_28 = var2_31;
                        }
                      }
              ...
              var2_26 = new Boolean(tmpQuant_27);
              pred_14 = var2_26;
            }
          }
    ...
    if (cond_12.booleanValue()) {
      ...
      HashSet res_s_50 = new HashSet();
      {
        ...
        HashSet unArg_55 = new HashSet();
        HashSet res_s_56 = new HashSet();
        {

          HashMap m = new HashMap();
          {
            for (Iterator enm_62 = cxt_us.iterator(); enm_62.hasNext(); ) {

              HashMap elem_61 = (HashMap) enm_62.next();
              m = elem_61;
              HashSet res_s_57 = new HashSet();
              res_s_57.clear();
              res_s_57.addAll(m.values());
              res_s_56.add(res_s_57);
            }
          }
        }
        unArg_55 = res_s_56;
        HashSet rduset_63 = new HashSet();
        for (Iterator enm_65 = unArg_55.iterator(); enm_65.hasNext(); ) {

          HashSet e_64 = (HashSet) enm_65.next();
          rduset_63.addAll(e_64);
        }
        e_set_54 = rduset_63;
        SEM.VAL val = null;
        {
          for (Iterator enm_67 = e_set_54.iterator(); enm_67.hasNext(); ) {

            Object elem_66 = enm_67.next();
            succ_53 = true;
            if (new Boolean((elem_66 instanceof Record)).booleanValue()) 
              val = (SEM.VAL) elem_66;
            else 
              succ_53 = false;
            if (succ_53) {

              Object res_s_51 = null;
              if ((val instanceof Record)) 
                if ((val instanceof SEM.TUPLE)) 
                  res_s_51 = ((SEM.TUPLE) val).v;
                else 
                  if ((val instanceof SEM.TOKEN)) 
                    res_s_51 = ((SEM.TOKEN) val).v;
                  else 
                    if ((val instanceof SEM.QUOTE)) 
                      res_s_51 = UTIL.ConvertToList(((SEM.QUOTE) val).v);
                    else 
                      if ((val instanceof SEM.CHAR)) 
                        res_s_51 = ((SEM.CHAR) val).v;
                      else 
                        if ((val instanceof SEM.BOOL)) 
                          res_s_51 = ((SEM.BOOL) val).v;
                        else 
                          if ((val instanceof SEM.SET)) 
                            res_s_51 = ((SEM.SET) val).v;
                          else 
                            if ((val instanceof SEM.SEQ)) 
                              res_s_51 = ((SEM.SEQ) val).v;
                            else 
                              if ((val instanceof SEM.REC)) 
                                res_s_51 = ((SEM.REC) val).v;
                              else 
                                if ((val instanceof SEM.NUM)) 
                                  res_s_51 = ((SEM.NUM) val).v;
                                else 
                                  res_s_51 = ((SEM.MAP) val).v;
              else 
                UTIL.RunTime("Run-Time Error:A record was expected");
      ...
      n_us = res_s_50;
      HashSet tmpVal_68 = new HashSet();
      {

        HashSet tmpSet_69 = new HashSet();
        tmpSet_69 = cxt_us;
        HashMap m = new HashMap();
        boolean succ_71 = false;
        for (Iterator enm_73 = tmpSet_69.iterator(); enm_73.hasNext() && !succ_71; ) {

          HashMap tmpElem_72 = (HashMap) enm_73.next();
          succ_71 = true;
          m = tmpElem_72;
        }
        if (!succ_71) 
        ...
        tmpVal_68.clear();
        tmpVal_68.addAll(m.keySet());
      }
      String id = null;
      succ_48 = true;
      HashSet succSet_80 = new HashSet();
      if ((tmpVal_68 instanceof HashSet)) {

        HashSet tmpvarExpr_79 = (HashSet) tmpVal_68;
        if (1 == tmpvarExpr_79.size()) {

          Vector valSeq_75 = new Vector();
          for (Iterator enm_84 = tmpvarExpr_79.iterator(); enm_84.hasNext(); ) {

            String e_83 = UTIL.ConvertToString(enm_84.next());
            valSeq_75.add(e_83);
          }
          HashSet permSL_76 = UTIL.Permute(valSeq_75);
          for (Iterator enm_85 = permSL_76.iterator(); enm_85.hasNext(); ) {

            Vector perm_77 = (Vector) UTIL.ConvertToList(enm_85.next());
            boolean succ_set_v_78 = false;
            if (succ_set_v_78 = (1 == perm_77.size())) 
              id = UTIL.ConvertToString(perm_77.get(0));
            if (succ_set_v_78) 
              succSet_80.add(perm_77);
            if (succ_set_v_78) 
              break;
          }
        }
      }
      if (!succSet_80.isEmpty()) {

        succ_48 = true;
        Vector succElem_81 = (Vector) succSet_80.iterator().next();
        boolean succRes_v_82 = false;
        if (succRes_v_82 = (1 == succElem_81.size())) 
          id = UTIL.ConvertToString(succElem_81.get(0));
      }
      else 
        succ_48 = false;
      if (!succ_48) 
        UTIL.RunTime("Run-Time Error:Pattern match did not succeed in value definition");
      SEM.SEQ rexpr_86 = null;
      Vector tmpVar_87 = null;
      {

        Vector res_l_88 = new Vector();
        HashSet resBind_s_90 = new HashSet();
        resBind_s_90 = n_us;
        Vector bind_l_89 = null;
        bind_l_89 = UTIL.Sort(resBind_s_90);
        Long i = null;
        for (Iterator enm_105 = bind_l_89.iterator(); enm_105.hasNext(); ) {

          Long e_92 = UTIL.NumberToLong(enm_105.next());
          i = e_92;
          SEM.VAL reselem_93 = null;
          {

            HashMap cxt2 = new HashMap();
            HashMap modmap_96 = new HashMap();
            SEM.NUM tmpVar2_100 = null;
            tmpVar2_100 = new SEM.NUM(UTIL.NumberToReal(i));
            modmap_96 = new HashMap();
            modmap_96.put(id, tmpVar2_100);
            cxt2 = new HashMap(cxt);
            cxt2.putAll(modmap_96);
            reselem_93 = (SEM.VAL) (SEM.VAL) evaluateExpression((IOmlExpression) elem, cxt2);
          }
          res_l_88.add(reselem_93);
        }
        tmpVar_87 = res_l_88;
      }
      rexpr_86 = new SEM.SEQ(tmpVar_87);
      return (SEM.VAL) rexpr_86;
    }
    else {

      errorLog.ReportError(expr, RTERR.NUM_uEXPECTED);
      SEM.SEQ rexpr_46 = null;
      rexpr_46 = new SEM.SEQ(new Vector());
...
// ***** VDMTOOLS START Name=evaluateSubsequenceExpression#2|IOmlSubsequenceExpression|HashMap KEEP=NO
  public SEM.VAL evaluateSubsequenceExpression (final IOmlSubsequenceExpression expr, final HashMap cxt) throws CGException {
    ...
    tmpVal_5 = (IOmlExpression) expr.getLower();
    IOmlExpression low = null;
    low = (IOmlExpression) tmpVal_5;
    ...
    if (cond_16.booleanValue()) {
      ...
      if (cond_26.booleanValue()) {
        ...
        errorLog.ReportError(sub, RTERR.SEQ_uEXPECTED);
  ...
  public SEM.VAL evaluateSetRange (final IOmlSetRangeExpression expr, final HashMap cxt) throws CGException {
      ...
      s = new HashSet();
    {
      ...
      if (cond_23.booleanValue()) 
        errorLog.ReportError(expr, RTERR.LOWER_uBOUND_uNOT_uA_uNUMBER);
      ...
      if (cond_29.booleanValue()) 
        errorLog.ReportError(expr, RTERR.UPPER_uBOUND_uNOT_uA_uNUMBER);
...
// ***** VDMTOOLS START Name=evaluateSetComprehension#2|IOmlSetComprehension|HashMap KEEP=NO
  public SEM.VAL evaluateSetComprehension (final IOmlSetComprehension expr, final HashMap cxt) throws CGException {
    ...
    if (cond_8.booleanValue()) 
      ...
      guard = null;
    HashSet tmpVal_9 = new HashSet();
    tmpVal_9 = evalBindList(bind_ul, cxt);
    HashSet cxt_us = new HashSet();
    cxt_us = tmpVal_9;
    ...
    var2_39 = new HashSet();
    var2_39.add(new quotes.NoVAL());
    tmpVar_13 = (HashSet) var1_14.clone();
    tmpVar_13.removeAll(var2_39);
  ...
  public SEM.VAL evaluateMapComprehension (final IOmlMapComprehension expr, final HashMap cxt) throws CGException {
    ...
    cxt_us = tmpVal_9;
    {
      ...
      HashSet res_s_14 = new HashSet();
      {
        ...
        HashMap cxt2 = new HashMap();
        {
          for (Iterator enm_46 = cxt_us.iterator(); enm_46.hasNext(); ) {

            HashMap elem_45 = (HashMap) enm_46.next();
            cxt2 = elem_45;
      ...
      boolean tmpQuant_48 = true;
      {

        HashMap x = new HashMap();
        HashMap y = new HashMap();
        HashSet e_set_74 = m_us;
        {
          for (Iterator enm_76 = e_set_74.iterator(); enm_76.hasNext() && tmpQuant_48; ) {

            HashMap elem_75 = (HashMap) enm_76.next();
            y = elem_75;
            for (Iterator enm_73 = m_us.iterator(); enm_73.hasNext() && tmpQuant_48; ) {

              HashMap elem_72 = (HashMap) enm_73.next();
              x = elem_72;
              Boolean pred_49 = null;
              if (new Boolean(!UTIL.equals(x, y)).booleanValue()) {

                Boolean var2_53 = null;
                boolean tmpQuant_54 = true;
                {

                  boolean succ_62 = true;
                  HashSet e_set_63 = new HashSet();
                  HashSet var1_64 = new HashSet();
                  var1_64.clear();
                  var1_64.addAll(x.keySet());
                  HashSet var2_66 = new HashSet();
                  var2_66.clear();
                  var2_66.addAll(y.keySet());
                  e_set_63 = (HashSet) var1_64.clone();
                  e_set_63.retainAll(var2_66);
                  SEM.VAL z = null;
                  {
                    for (Iterator enm_69 = e_set_63.iterator(); enm_69.hasNext() && tmpQuant_54; ) {

                      Object elem_68 = enm_69.next();
                      succ_62 = true;
                      if (new Boolean((elem_68 instanceof Record)).booleanValue()) 
                        z = (SEM.VAL) elem_68;
                      else 
                        succ_62 = false;
                      if (succ_62) {
                ...
                var2_53 = new Boolean(tmpQuant_54);
                pred_49 = var2_53;
              }
              else 
                pred_49 = new Boolean(true);
      ...
      if (cond_47.booleanValue()) {
        ...
        SEM.MAP rexpr_82 = null;
        HashMap tmpVar_83 = new HashMap();
        HashMap rdmmap_85 = new HashMap();
        for (Iterator enm_92 = m_us.iterator(); enm_92.hasNext(); ) {

          HashMap e_86 = (HashMap) enm_92.next();
          HashSet eq_dom_88 = new HashSet();
          eq_dom_88.addAll(rdmmap_85.keySet());
          eq_dom_88.retainAll(e_86.keySet());
          boolean all_dup_eq_89 = true;
          for (Iterator enm_91 = eq_dom_88.iterator(); enm_91.hasNext() && all_dup_eq_89; ) {

            SEM.VAL d_90 = (SEM.VAL) enm_91.next();
            all_dup_eq_89 = ((SEM.VAL) rdmmap_85.get(d_90)).equals((SEM.VAL) e_86.get(d_90));
          }
          if (!all_dup_eq_89) 
            UTIL.RunTime("Run-Time Error:Duplicate entries for \'merge\' had different values");
          rdmmap_85.putAll(e_86);
        }
        tmpVar_83 = rdmmap_85;
        rexpr_82 = new SEM.MAP(tmpVar_83);
        return (SEM.VAL) rexpr_82;
      }
      else {

        errorLog.ReportError(expr, RTERR.DUPLICATES_uNOT_uEQUAL);
        SEM.MAP rexpr_80 = null;
        rexpr_80 = new SEM.MAP(new HashMap());
        return (SEM.VAL) rexpr_80;
      }
    }
  }
...
// ***** VDMTOOLS START Name=EvalModify#3|IOmlBinaryExpression KEEP=NO
  private SEM.VAL EvalModify (final SEM.VAL l_uv, final SEM.VAL r_uv, final IOmlBinaryExpression expr) throws CGException {
    ...
    if (cond_4.booleanValue()) {
      ...
      errorLog.ReportError(expr, RTERR.MAP_uEXPECTED);
      ...
      if (cond_18.booleanValue()) 
        ...
        if (cond_12.booleanValue()) 
          ...
          errorLog.ReportError(expr, RTERR.MAP_uOR_uSEQ_uEXPECTED);
            ...
            d_uv = (SEM.VAL) elem_10;
            {
              ...
              if (cond_19.booleanValue()) {
                ...
                if (cond_30.booleanValue()) {
                  ...
                  errorLog.ReportError(expr, RTERR.ILLEGAL_uINDICES);
                ...
                errorLog.ReportError(expr, RTERR.INT_uEXPECTED);
...
// ***** VDMTOOLS START Name=EvalPSubset#3|IOmlBinaryExpression KEEP=NO
  private SEM.VAL EvalPSubset (final SEM.VAL l_uv, final SEM.VAL r_uv, final IOmlBinaryExpression expr) throws CGException {
    ...
    if (cond_4.booleanValue()) {
      ...
      errorLog.ReportError(expr, RTERR.SET_uEXPECTED);
      SEM.BOOL rexpr_12 = null;
      rexpr_12 = new SEM.BOOL(new Boolean(true));
      return (SEM.VAL) rexpr_12;
    }
...
// ***** VDMTOOLS START Name=EvalAnd#3|IOmlBinaryExpression KEEP=NO
  private SEM.VAL EvalAnd (final SEM.VAL l_uv, final SEM.VAL r_uv, final IOmlBinaryExpression expr) throws CGException {
    ...
    if (cond_4.booleanValue()) {
      ...
      errorLog.ReportError(expr, RTERR.BOOL_uEXPECTED);
      SEM.BOOL rexpr_12 = null;
      rexpr_12 = new SEM.BOOL(new Boolean(true));
      return (SEM.VAL) rexpr_12;
    }
  ...
  private SEM.VAL EvalTupSel (final SEM.VAL l_uv, final SEM.VAL r_uv, final IOmlBinaryExpression expr) throws CGException {
    ...
    if (cond_4.booleanValue()) {
      ...
      if (cond_24.booleanValue()) {
        ...
        errorLog.ReportError(expr, RTERR.TUPLE_uEXPECTED);
...
// ***** VDMTOOLS START Name=EvalConc#3|IOmlBinaryExpression KEEP=NO
  private SEM.VAL EvalConc (final SEM.VAL l_uv, final SEM.VAL r_uv, final IOmlBinaryExpression expr) throws CGException {
    ...
    if (cond_4.booleanValue()) {
      ...
      errorLog.ReportError(expr, RTERR.SEQ_uEXPECTED);
...
// ***** VDMTOOLS START Name=EvalDivide#3|IOmlBinaryExpression KEEP=NO
  private SEM.VAL EvalDivide (final SEM.VAL l_uv, final SEM.VAL r_uv, final IOmlBinaryExpression expr) throws CGException {
    ...
    if (cond_4.booleanValue()) {
      ...
      if ((r_uv instanceof Record)) 
        if ((r_uv instanceof SEM.TUPLE)) 
          var1_15 = ((SEM.TUPLE) r_uv).v;
        else 
          if ((r_uv instanceof SEM.TOKEN)) 
            var1_15 = ((SEM.TOKEN) r_uv).v;
          else 
            if ((r_uv instanceof SEM.QUOTE)) 
              var1_15 = UTIL.ConvertToList(((SEM.QUOTE) r_uv).v);
            else 
              if ((r_uv instanceof SEM.CHAR)) 
                var1_15 = ((SEM.CHAR) r_uv).v;
              else 
                if ((r_uv instanceof SEM.BOOL)) 
                  var1_15 = ((SEM.BOOL) r_uv).v;
                else 
                  if ((r_uv instanceof SEM.SET)) 
                    var1_15 = ((SEM.SET) r_uv).v;
                  else 
                    if ((r_uv instanceof SEM.SEQ)) 
                      var1_15 = ((SEM.SEQ) r_uv).v;
                    else 
                      if ((r_uv instanceof SEM.REC)) 
                        var1_15 = ((SEM.REC) r_uv).v;
                      else 
                        if ((r_uv instanceof SEM.NUM)) 
                          var1_15 = ((SEM.NUM) r_uv).v;
                        else 
                          var1_15 = ((SEM.MAP) r_uv).v;
      else 
        UTIL.RunTime("Run-Time Error:A record was expected");
      cond_14 = new Boolean(!UTIL.equals(var1_15, new Long(0)));
      if (cond_14.booleanValue()) {

        SEM.NUM rexpr_23 = null;
        Double tmpVar_24 = null;
        Object var1_25 = null;
        if ((l_uv instanceof Record)) 
          if ((l_uv instanceof SEM.TUPLE)) 
            var1_25 = ((SEM.TUPLE) l_uv).v;
          else 
            if ((l_uv instanceof SEM.TOKEN)) 
              var1_25 = ((SEM.TOKEN) l_uv).v;
            else 
              if ((l_uv instanceof SEM.QUOTE)) 
                var1_25 = UTIL.ConvertToList(((SEM.QUOTE) l_uv).v);
              else 
                if ((l_uv instanceof SEM.CHAR)) 
                  var1_25 = ((SEM.CHAR) l_uv).v;
                else 
                  if ((l_uv instanceof SEM.BOOL)) 
                    var1_25 = ((SEM.BOOL) l_uv).v;
                  else 
                    if ((l_uv instanceof SEM.SET)) 
                      var1_25 = ((SEM.SET) l_uv).v;
                    else 
                      if ((l_uv instanceof SEM.SEQ)) 
                        var1_25 = ((SEM.SEQ) l_uv).v;
                      else 
                        if ((l_uv instanceof SEM.REC)) 
                          var1_25 = ((SEM.REC) l_uv).v;
                        else 
                          if ((l_uv instanceof SEM.NUM)) 
                            var1_25 = ((SEM.NUM) l_uv).v;
                          else 
                            var1_25 = ((SEM.MAP) l_uv).v;
        else 
          UTIL.RunTime("Run-Time Error:A record was expected");
        Object var2_27 = null;
        if ((r_uv instanceof Record)) 
          if ((r_uv instanceof SEM.TUPLE)) 
            var2_27 = ((SEM.TUPLE) r_uv).v;
          else 
            if ((r_uv instanceof SEM.TOKEN)) 
              var2_27 = ((SEM.TOKEN) r_uv).v;
            else 
              if ((r_uv instanceof SEM.QUOTE)) 
                var2_27 = UTIL.ConvertToList(((SEM.QUOTE) r_uv).v);
              else 
                if ((r_uv instanceof SEM.CHAR)) 
                  var2_27 = ((SEM.CHAR) r_uv).v;
                else 
                  if ((r_uv instanceof SEM.BOOL)) 
                    var2_27 = ((SEM.BOOL) r_uv).v;
                  else 
                    if ((r_uv instanceof SEM.SET)) 
                      var2_27 = ((SEM.SET) r_uv).v;
                    else 
                      if ((r_uv instanceof SEM.SEQ)) 
                        var2_27 = ((SEM.SEQ) r_uv).v;
                      else 
                        if ((r_uv instanceof SEM.REC)) 
                          var2_27 = ((SEM.REC) r_uv).v;
                        else 
                          if ((r_uv instanceof SEM.NUM)) 
                            var2_27 = ((SEM.NUM) r_uv).v;
                          else 
                            var2_27 = ((SEM.MAP) r_uv).v;
        else 
          UTIL.RunTime("Run-Time Error:A record was expected");
        tmpVar_24 = new Double(((Number) var1_25).doubleValue() / ((Number) var2_27).doubleValue());
        rexpr_23 = new SEM.NUM(tmpVar_24);
        return (SEM.VAL) rexpr_23;
      }
      else {

        errorLog.ReportError(expr, RTERR.DIVISION_uWITH_uZERO);
        SEM.NUM rexpr_21 = null;
        rexpr_21 = new SEM.NUM(UTIL.NumberToReal(new Long(1)));
        return (SEM.VAL) rexpr_21;
      }
    }
    else {
  ...
  private SEM.VAL EvalHd (final SEM.VAL val, final IOmlUnaryExpression expr) throws CGException {
    ...
    if (cond_3.booleanValue()) {
      ...
      if (cond_15.booleanValue()) {
        ...
        errorLog.ReportError(expr, RTERR.NONEMPTY_uSEQ_uEXPECTED);
  ...
  private SEM.VAL EvalDUnion (final SEM.VAL val, final IOmlUnaryExpression expr) throws CGException {
    ...
    if (cond_3.booleanValue()) {
      ...
      if (cond_21.booleanValue()) {
        ...
        errorLog.ReportError(expr, RTERR.ALL_uSETS_uEXPECTED);
  ...
  private SEM.VAL EvalMerge (final SEM.VAL val, final IOmlUnaryExpression expr) throws CGException {
    ...
    if (cond_3.booleanValue()) {
      ...
      if (cond_21.booleanValue()) {
        ...
        errorLog.ReportError(expr, RTERR.ALL_uMAPS_uEXPECTED);
        SEM.MAP rexpr_19 = null;
        rexpr_19 = new SEM.MAP(new HashMap());
        return (SEM.VAL) rexpr_19;
      }
...
// ***** VDMTOOLS START Name=EvalDConc#2|IOmlUnaryExpression KEEP=NO
  private SEM.VAL EvalDConc (final SEM.VAL val, final IOmlUnaryExpression expr) throws CGException {
    ...
    if (cond_3.booleanValue()) {
      ...
      errorLog.ReportError(expr, RTERR.ALL_uSEQS_uEXPECTED);
...
// ***** VDMTOOLS START Name=evaluateNewExpression#2|IOmlNewExpression|HashMap KEEP=NO
  public SEM.VAL evaluateNewExpression (final IOmlNewExpression expr, final HashMap cxt) throws CGException {
    ...
    tmpVal_4 = (IOmlName) expr.getName();
    IOmlName clnm = null;
    clnm = (IOmlName) tmpVal_4;
    Vector par_ul = null;
...
// ***** VDMTOOLS START Name=evaluateIfExpression#2|IOmlIfExpression|HashMap KEEP=NO
  public SEM.VAL evaluateIfExpression (final IOmlIfExpression expr, final HashMap cxt) throws CGException {
    ...
    IOmlExpression tmpVal_7 = null;
    tmpVal_7 = (IOmlExpression) expr.getElseExpression();
    IOmlExpression elseexpr = null;
    elseexpr = (IOmlExpression) tmpVal_7;
...
// ***** VDMTOOLS START Name=evaluateLetExpression#2|IOmlLetExpression|HashMap KEEP=NO
  public SEM.VAL evaluateLetExpression (final IOmlLetExpression expr, final HashMap cxt) throws CGException {
    ...
    tmpVal_4 = expr.getDefinitionList();
    Vector def_ul = null;
    def_ul = tmpVal_4;
    ...
    HashMap cxt2 = cxt;
    {
      ...
      for (Iterator enm_20 = defi_ul.iterator(); enm_20.hasNext(); ) {
        ...
        defi = (IOmlValueShape) elem_4;
        {
          ...
          IOmlPattern tmpVal_8 = null;
          tmpVal_8 = (IOmlPattern) defi.getPattern();
          IOmlPattern pat = null;
          pat = (IOmlPattern) tmpVal_8;
...
// ***** VDMTOOLS START Name=evaluateLetBeExpression#2|IOmlLetBeExpression|HashMap KEEP=NO
  public SEM.VAL evaluateLetBeExpression (final IOmlLetBeExpression expr, final HashMap cxt) throws CGException {
    ...
    HashSet tmpVal_17 = new HashSet();
    tmpVal_17 = evalBind((IOmlBind) bind, cxt);
    HashSet cxt_us = new HashSet();
    cxt_us = tmpVal_17;
    {

      HashSet tmpSet_20 = new HashSet();
      tmpSet_20 = cxt_us;
      HashMap cxt2 = new HashMap();
      boolean succ_22 = false;
      for (Iterator enm_24 = tmpSet_20.iterator(); enm_24.hasNext() && !succ_22; ) {

        HashMap tmpElem_23 = (HashMap) enm_24.next();
        succ_22 = true;
        cxt2 = tmpElem_23;
      }
      if (!succ_22) 
        UTIL.RunTime("Run-Time Error:The binding environment was empty");
      HashMap tmpArg_v_27 = new HashMap();
      tmpArg_v_27 = new HashMap(cxt);
      tmpArg_v_27.putAll(cxt2);
      return (SEM.VAL) evaluateExpression((IOmlExpression) inexpr, tmpArg_v_27);
    }
  }
  ...
  public SEM.VAL evaluateFieldSelect (final IOmlFieldSelect expr, final HashMap cxt) throws CGException {
    ...
    if (cond_10.booleanValue()) {
      ...
      if (cond_12.booleanValue()) {
        ...
        String tmpVal_15 = null;
        if ((val instanceof Record)) 
          tmpVal_15 = ((SEM.OBJ) val).nm;
        else 
          UTIL.RunTime("Run-Time Error:A record was expected");
        String clnm = null;
        clnm = tmpVal_15;
...
// ***** VDMTOOLS START Name=evaluateRecordConstructor#2|IOmlRecordConstructor|HashMap KEEP=NO
  public SEM.VAL evaluateRecordConstructor (final IOmlRecordConstructor expr, final HashMap cxt) throws CGException {
    ...
    name = (IOmlName) expr.getName();
    Vector tmpVal_5 = null;
    tmpVal_5 = expr.getExpressionList();
    Vector e_ul = null;
    e_ul = tmpVal_5;
    ...
    if (cond_8.booleanValue()) 
      tmpVal_6 = name.getClassIdentifier();
    else 
      tmpVal_6 = curcl;
    String clnm = null;
    clnm = tmpVal_6;
...
// ***** VDMTOOLS START Name=evaluateTupleConstructor#2|IOmlTupleConstructor|HashMap KEEP=NO
  public SEM.VAL evaluateTupleConstructor (final IOmlTupleConstructor expr, final HashMap cxt) throws CGException {
    ...
    Vector tmpVal_4 = null;
    tmpVal_4 = expr.getExpressionList();
    Vector e_ul = null;
    e_ul = tmpVal_4;
    Vector v_ul = null;
    {
    ...
    if (new Boolean(new Long(a_ul.size()).intValue() == new Long(1).intValue()).booleanValue()) {
      ...
      if (cond_38.booleanValue()) {
        ...
        if (cond_82.booleanValue()) {
          ...
          errorLog.ReportError(expr, RTERR.ARG_uNOT_uIN_uDOM);
...
// ***** VDMTOOLS START Name=evaluateMuExpression#2|IOmlMuExpression|HashMap KEEP=NO
  public SEM.VAL evaluateMuExpression (final IOmlMuExpression expr, final HashMap cxt) throws CGException {
    ...
    SEM.VAL tmpVal_6 = null;
    tmpVal_6 = (SEM.VAL) (SEM.VAL) evaluateExpression((IOmlExpression) expr, cxt);
    SEM.VAL recval = null;
    recval = (SEM.VAL) tmpVal_6;
    Boolean cond_9 = null;
    ...
    if (cond_9.booleanValue()) 
      ...
      errorLog.ReportError(expr, RTERR.REC_uEXPECTED);
      SEM.SEQ rexpr_14 = null;
  ...
  public SEM.VAL evaluateName (final IOmlName expr, final HashMap cxt) throws CGException {
    ...
    if (cond_5.booleanValue()) 
      ...
      if (hascl.booleanValue()) 
        tmpVal_10 = expr.getClassIdentifier();
      else 
        tmpVal_10 = curcl;
      String clnm = null;
      clnm = tmpVal_10;
...
// ***** VDMTOOLS START Name=evalBindList#2|Vector|HashMap KEEP=NO
  private HashSet evalBindList (final Vector b_ul, final HashMap cxt) throws CGException {
    ...
    if (new Boolean(UTIL.equals(b_ul, new Vector())).booleanValue()) {
      ...
      HashSet c_us1 = evalBind((IOmlBind) (IOmlBind) b_ul.get(0), cxt);
      HashSet c_us2 = evalBindList(new Vector(b_ul.subList(1, b_ul.size())), cxt);
      varRes_3 = CombineContexts(c_us1, c_us2);
    }
    return varRes_3;
  }
...
// ***** VDMTOOLS START Name=evalBind#2|IOmlBind|HashMap KEEP=NO
  private HashSet evalBind (final IOmlBind bind, final HashMap cxt) throws CGException {
    if (new Boolean(bind instanceof IOmlSetBind).booleanValue()) 
      return evalSetBind((IOmlSetBind) bind, cxt);
    else {

      errorLog.ReportError(bind, RTERR.TYPE_uBIND_uEVAL);
...
// ***** VDMTOOLS START Name=evalSetBind#2|IOmlSetBind|HashMap KEEP=NO
  private HashSet evalSetBind (final IOmlSetBind bind, final HashMap cxt) throws CGException {
      ...
      c_ul_us = new HashSet();
    {
      ...
      if (cond_37.booleanValue()) {
        ...
        errorLog.ReportError(bind, RTERR.TYPE_uBIND_uEVAL);
        HashSet rexpr_51 = new HashSet();
        rexpr_51 = new HashSet();
        rexpr_51.add(new HashMap());
        return rexpr_51;
      }
      else {

        HashSet rexpr_40 = new HashSet();
        HashSet res_s_41 = new HashSet();
        {

          Vector c_ul = null;
          {
            for (Iterator enm_47 = c_ul_us.iterator(); enm_47.hasNext(); ) {

              Vector elem_46 = (Vector) UTIL.ConvertToList(enm_47.next());
              c_ul = elem_46;
              res_s_41.add(MergeContextList(c_ul));
            }
          }
        }
        rexpr_40 = res_s_41;
...
// ***** VDMTOOLS START Name=CombineContexts#2|HashSet|HashSet KEEP=NO
  public HashSet CombineContexts (final HashSet c_us1, final HashSet c_us2) throws CGException {
    ...
    HashSet res_s_4 = new HashSet();
    {
      ...
      {
        for (Iterator enm_15 = c_us2.iterator(); enm_15.hasNext(); ) {

          HashMap elem_14 = (HashMap) enm_15.next();
          c2 = elem_14;
          for (Iterator enm_13 = c_us1.iterator(); enm_13.hasNext(); ) {

            HashMap elem_12 = (HashMap) enm_13.next();
            c1 = elem_12;
            HashMap res_s_5 = new HashMap();
            res_s_5 = new HashMap(c1);
            res_s_5.putAll(c2);
            res_s_4.add(res_s_5);
          }
        }
...
// ***** VDMTOOLS END Name=CombineContexts#2|HashSet|HashSet
