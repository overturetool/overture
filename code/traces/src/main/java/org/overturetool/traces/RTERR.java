...
// ***** VDMTOOLS START Name=DIVISION_uWITH_uZERO KEEP=NO
  private static final String DIVISION_uWITH_uZERO = new String("76: Division with zero");
...
// ***** VDMTOOLS START Name=ReportError#2|Object|String KEEP=NO
  static public void ReportError (final Object expr, final String errmsg) throws CGException {
    if (new Boolean(UTIL.equals(expr, null)).booleanValue()) {

      String tmpVal_19 = null;
      tmpVal_19 = Expand.GetCurClass();
      String clnm = null;
      clnm = tmpVal_19;
      String tmpVal_20 = null;
      tmpVal_20 = Expand.GetCurTrace();
      String trnm = null;
      trnm = tmpVal_20;
      AddErrMsg(clnm, trnm, new Long(1), new Long(1), errmsg);
    }
    else {
      ...
      tmpVal_10 = Expand.GetCurClass();
      String clnm = null;
      clnm = tmpVal_10;
      String tmpVal_11 = null;
      tmpVal_11 = Expand.GetCurTrace();
      String trnm = null;
      trnm = tmpVal_11;
...
// ***** VDMTOOLS START Name=AddErrMsg#5|String|String|Long|Long|String KEEP=NO
  static public void AddErrMsg (final String clnm, final String trnm, final Long line, final Long col, final String errmsg) throws CGException {
    ...
    if (cond_6.booleanValue()) {
      ...
      ErrMsg enum_set_27 = null;
      enum_set_27 = new ErrMsg(line, col, errmsg);
      var2_26 = new HashSet();
      var2_26.add(enum_set_27);
      rhs_20 = (HashSet) ((HashSet) ((HashMap) errmsgs.get(clnm)).get(trnm)).clone();
      rhs_20.addAll(var2_26);
      HashMap level_31 = errmsgs.containsKey(clnm) ? (HashMap) errmsgs.get(clnm) : new HashMap();
      level_31.put(trnm, rhs_20);
      errmsgs.put(clnm, level_31);
    }
    else {

      HashSet rhs_9 = new HashSet();
      ErrMsg enum_set_10 = null;
      enum_set_10 = new ErrMsg(line, col, errmsg);
      rhs_9 = new HashSet();
      rhs_9.add(enum_set_10);
      HashMap level_14 = errmsgs.containsKey(clnm) ? (HashMap) errmsgs.get(clnm) : new HashMap();
      level_14.put(trnm, rhs_9);
      errmsgs.put(clnm, level_14);
    }
  }
...
// ***** VDMTOOLS START Name=GetErrMsg#2|String|String KEEP=NO
  static public HashSet GetErrMsg (final String clnm, final String trnm) throws CGException {
...
// ***** VDMTOOLS START Name=HasError#2|String|String KEEP=NO
  static public Boolean HasError (final String clnm, final String trnm) throws CGException {
...
// ***** VDMTOOLS START Name=GetErrors KEEP=NO
  static public HashMap GetErrors () throws CGException {
    return errmsgs;
  }
