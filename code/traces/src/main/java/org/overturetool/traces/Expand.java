...
// ***** VDMTOOLS START Name=ExpandTraceDefs#2|String|IOmlTraceDefinitions KEEP=NO
  protected HashMap ExpandTraceDefs (final String clid, final IOmlTraceDefinitions def_ul) throws CGException {
    ...
    HashMap res_um = new HashMap();
    {
      ...
      for (Iterator enm_19 = sq_3.iterator(); enm_19.hasNext(); ) {

        IOmlNamedTrace elem_4 = (IOmlNamedTrace) enm_19.next();
        ntrace = (OmlNamedTrace) elem_4;
        {

          String name = null;
          name = org.overturetool.vdmj.util.Utils.listToString(ntrace.getName(),"/");
          IOmlTraceDefinition tmpVal_9 = null;
          tmpVal_9 = (IOmlTraceDefinition) ntrace.getDefs();
          IOmlTraceDefinition defs = null;
          defs = (IOmlTraceDefinition) tmpVal_9;
          {
            ...
            par_14 = new HashSet();
            par_14.add(new HashMap());
            rhs_12 = ExpandTraceDef((IOmlTraceDefinition) defs, par_14);
            res_um.put(name, rhs_12);
          }
        }
      }
    }
