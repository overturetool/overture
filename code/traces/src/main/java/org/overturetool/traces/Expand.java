...
// ***** VDMTOOLS START Name=ExtractLetBeSetBinding#3|IOmlSetBind|IOmlExpression|Vector KEEP=NO
  private Vector ExtractLetBeSetBinding (final IOmlSetBind bind, final IOmlExpression best, final Vector cxt_ul) throws CGException {
    ...
    Vector unArg_8 = null;
    {
      ...
      Long i = null;
      for (Iterator enm_91 = bind_l_10.iterator(); enm_91.hasNext(); ) {

        Long e_13 = UTIL.NumberToLong(enm_91.next());
        i = e_13;
        Vector reselem_18 = null;
        {
            ...
            c_ul_ul = new Vector();
          {
            ...
            Long i2 = null;
            for (Iterator enm_89 = bind_l_57.iterator(); enm_89.hasNext(); ) {

              Long e_60 = UTIL.NumberToLong(enm_89.next());
              i2 = e_60;
              Boolean pred_69 = null;
              {
                ...
                Vector var2_77 = null;
                Vector rdcseq_79 = new Vector();
                for (Iterator enm_82 = c_ul_ul.iterator(); enm_82.hasNext(); ) {

                  Vector e_80 = (Vector) UTIL.ConvertToList(enm_82.next());
                  rdcseq_79.addAll(e_80);
                }
                var2_77 = rdcseq_79;
                par_72 = (Vector) var1_73.clone();
                par_72.addAll(var2_77);
                c = (HashMap) eval.MergeContextList(par_72);
                SEM.VAL var1_83 = null;
                var1_83 = (SEM.VAL) eval.evaluateExpression((IOmlExpression) best, c);
                SEM.BOOL var2_86 = null;
                var2_86 = new SEM.BOOL(new Boolean(true));
                pred_69 = new Boolean(UTIL.equals(var1_83, var2_86));
              }
    ...
    Vector rdcseq_92 = new Vector();
    for (Iterator enm_95 = unArg_8.iterator(); enm_95.hasNext(); ) {

      Vector e_93 = (Vector) UTIL.ConvertToList(enm_95.next());
      rdcseq_92.addAll(e_93);
    }
    rexpr_7 = rdcseq_92;
    return rexpr_7;
  }
