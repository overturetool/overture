...
public class StdLib {
	...
	static public String ToString(final Object s) throws CGException {
		...
		boolean succ_3 = true;
		{
			...
			if (!UTIL.equals(new Boolean(true), new Boolean(UTIL.IsInteger(s))))
				succ_3 = false;
			if (succ_3)
				varRes_2 = ToStringInt(UTIL.NumberToLong(s));
		}
		if (!succ_3) {
	...
	// ***** VDMTOOLS START Name=ToStringInt#1|Long KEEP=NO
	static public String ToStringInt(final Long val) throws CGException {

		String varRes_2 = null;
		{

			Long result = new Long((int) (val.doubleValue() - new Long(10).doubleValue()
					* Math.floor(val.doubleValue() / new Long(10).doubleValue())));
			Long vdm_rest = new Long((int) (val.intValue() / new Long(10).intValue()));
	...
	// ***** VDMTOOLS END Name=ToStringInt#1|Long
	...
	static public String GetStringFromNum(final Long val) throws CGException {
		...
		if ((1 <= new Long(val.intValue() + new Long(1).intValue()).intValue())
				&& (new Long(val.intValue() + new Long(1).intValue()).intValue() <= new String("0123456789").length()))
			e_seq_3 = new Character(new String("0123456789").charAt(new Long(val.intValue()
	...
	static public Long StringToInt(final String text) throws CGException {
		...
		if (new Boolean(new Long(text.length()).intValue() == new Long(1).intValue()).booleanValue())
			...
			varRes_2 = new Long(CharToInt(new Character(text.charAt(0)), new Long(text.length())).intValue()
					+ StringToInt(text.substring(1)).intValue());
		return varRes_2;
	}
	...
	static private Long CharToInt(final Character c, final Long pos) throws CGException {
		...
		Long varRes_3 = null;
		{
			...
			Long var2_29 = null;
			var2_29 = new Long((int) Math.pow(new Long(10).intValue(), new Long(pos.intValue()
					- new Long(1).intValue()).intValue()));
			varRes_3 = new Long(UTIL.NumberToLong(valueMap.get(c)).intValue()
					* var2_29.intValue());
		}
		return varRes_3;
	}
	...
	// ***** VDMTOOLS START Name=SetToSeq#1|HashSet KEEP=YES
	static public Vector SetToSeq(final HashSet s) throws CGException {
		//Changed since VDM Tools code gen makes some ??? code which is not needed
		...
		// for (Iterator enm_11 = tmpSet_7.iterator(); enm_11.hasNext() &&
		// !succ_9; ) {
		//
	...
	// ***** VDMTOOLS START Name=Split#2|String|Character KEEP=NO
	static public Vector Split(final String text, final Character delimiter) throws CGException {
		...
		Vector varRes_3 = null;
		{
			...
			Vector del_ul = null;
			{
				...
				Long max_13 = new Long(text.length());
			...
			if (new Boolean(UTIL.equals(del_ul, new Vector())).booleanValue()) {
				...
				Long n2_39 = null;
				Long var1_40 = null;
				if ((1 <= new Long(1).intValue())
						&& (new Long(1).intValue() <= del_ul.size()))
				...
				Vector var2_44 = null;
				{
					...
					for (Iterator enm_80 = bind_l_46.iterator(); enm_80.hasNext();) {
						...
						Long var1_68 = null;
						if ((1 <= i.intValue())
								&& (i.intValue() <= del_ul.size()))
							var1_68 = UTIL.NumberToLong(del_ul.get(i.intValue() - 1));
						else
							UTIL.RunTime("Run-Time Error:Illegal index");
						n1_67 = new Long(var1_68.intValue()
								+ new Long(1).intValue());
						Long n2_72 = null;
						Long var1_73 = null;
						if ((1 <= new Long(i.intValue()
								+ new Long(1).intValue()).intValue())
								&& (new Long(i.intValue()
										+ new Long(1).intValue()).intValue() <= del_ul.size()))
							var1_73 = UTIL.NumberToLong(del_ul.get(new Long(i.intValue()
									+ new Long(1).intValue()).intValue() - 1));
						else
							UTIL.RunTime("Run-Time Error:Illegal index");
						n2_72 = new Long(var1_73.intValue()
								- new Long(1).intValue());
				...
				Long n1_91 = null;
				Long var1_92 = null;
				if ((1 <= new Long(del_ul.size()).intValue())
						&& (new Long(del_ul.size()).intValue() <= del_ul.size()))
