...
//
// Generated at 2009-02-28 by the VDM++ to JAVA Code Generator
                ...
                IOmlNamedTrace df = null;
                {
                  for (Iterator enm_38 = e_set_21.iterator(); enm_38.hasNext(); ) {
                    ...
                    Boolean pred_15 = null;
                    {
                      ...
                      String var1_18 = null;
                      var1_18 = org.overturetool.vdmj.util.Utils.listToString(t.getName(),"/");
                ...
                IOmlNamedTrace df = null;
                {
                  for (Iterator enm_37 = e_set_20.iterator(); enm_37.hasNext(); ) {
                    ...
                    Boolean pred_14 = null;
                    {
                      ...
                      String var1_17 = null;
                      var1_17 = org.overturetool.vdmj.util.Utils.listToString(t.getName(),"/");
...
// ***** VDMTOOLS START Name=ExecuteTraceTestCase#4|String|String|Long|Vector KEEP=NO
  public Vector ExecuteTraceTestCase (final String clnm, final String tdnm, final Long n, final Vector tc_uast) throws CGException {
    ...
    if (cond_5.booleanValue()) {
      ...
      TraceResult e_93 = null;
      e_93 = new TraceResult(new quotes.EXPAND_FAIL(), new String(""));
      res.add(e_93);
      ...
      if (new Boolean(!NoFailedPrefix(tc_uast).booleanValue()).booleanValue()) {
        ...
        expressions = Util.ExprToString(tc_uast);
        {
          ...
          results = tb.runTraceTestCase(clnm, expressions);
          {
            ...
            while ( new Boolean((index.intValue()) <= (new Long(results.size()).intValue())).booleanValue()){
              ...
              ToolBox.InterpreterResult tmpRec_34 = null;
              if ((1 <= index.intValue()) && (index.intValue() <= results.size())) 
                tmpRec_34 = (ToolBox.InterpreterResult) results.get(index.intValue() - 1);
              else 
                UTIL.RunTime("Run-Time Error:Illegal index");
              unArg_33 = (tmpRec_34).successfull;
              cond_32 = new Boolean(!unArg_33.booleanValue());
              if (cond_32.booleanValue()) {

                Boolean cond_49 = null;
                ToolBox.InterpreterResult par_50 = null;
                if ((1 <= index.intValue()) && (index.intValue() <= results.size())) 
                  par_50 = (ToolBox.InterpreterResult) results.get(index.intValue() - 1);
                else 
                  UTIL.RunTime("Run-Time Error:Illegal index");
                cond_49 = tb.IsPreError(par_50);
                if (cond_49.booleanValue()) {

                  TraceResult e_71 = null;
                  String tmpVar_73 = null;
                  ToolBox.InterpreterResult tmpRec_74 = null;
                  if ((1 <= index.intValue()) && (index.intValue() <= results.size())) 
                    tmpRec_74 = (ToolBox.InterpreterResult) results.get(index.intValue() - 1);
                  else 
                    UTIL.RunTime("Run-Time Error:Illegal index");
                  tmpVar_73 = (tmpRec_74).output;
                  e_71 = new TraceResult(new quotes.INCONCLUSIVE(), tmpVar_73);
                  res.add(e_71);
                  HashMap level_80 = inconclusiveTestCase.containsKey(clnm) ? (HashMap) inconclusiveTestCase.get(clnm) : new HashMap();
                  HashMap level_78 = level_80.containsKey(tdnm) ? (HashMap) level_80.get(tdnm) : new HashMap();
                  level_78.put(n, index);
                  level_80.put(tdnm, level_78);
                  inconclusiveTestCase.put(clnm, level_80);
                }
                else {

                  TraceResult e_54 = null;
                  String tmpVar_56 = null;
                  ToolBox.InterpreterResult tmpRec_57 = null;
                  if ((1 <= index.intValue()) && (index.intValue() <= results.size())) 
                    tmpRec_57 = (ToolBox.InterpreterResult) results.get(index.intValue() - 1);
                  else 
                    UTIL.RunTime("Run-Time Error:Illegal index");
                  tmpVar_56 = (tmpRec_57).output;
                  e_54 = new TraceResult(new quotes.FAIL(), tmpVar_56);
                  res.add(e_54);
                  HashMap level_63 = failedTestCases.containsKey(clnm) ? (HashMap) failedTestCases.get(clnm) : new HashMap();
                  HashMap level_61 = level_63.containsKey(tdnm) ? (HashMap) level_63.get(tdnm) : new HashMap();
                  level_61.put(n, index);
                  level_63.put(tdnm, level_61);
                  failedTestCases.put(clnm, level_63);
                }
                index = UTIL.NumberToLong(UTIL.clone(new Long(results.size())));
              }
              else {

                TraceResult e_38 = null;
                String tmpVar_40 = null;
                ToolBox.InterpreterResult tmpRec_41 = null;
                if ((1 <= index.intValue()) && (index.intValue() <= results.size())) 
                  tmpRec_41 = (ToolBox.InterpreterResult) results.get(index.intValue() - 1);
                else 
                  UTIL.RunTime("Run-Time Error:Illegal index");
                tmpVar_40 = (tmpRec_41).output;
                e_38 = new TraceResult(new quotes.OK(), tmpVar_40);
                res.add(e_38);
        ...
        TraceResult e_12 = null;
        e_12 = new TraceResult(new quotes.SKIPPED(), new String(""));
        res.add(e_12);
