...
public class OmlStartStatement extends IOmlStartStatement {
...
// ***** VDMTOOLS START Name=vdm_init_OmlStartStatement KEEP=NO
  private void vdm_init_OmlStartStatement () throws CGException {
    try {
      ivExpression = null;
    }
    catch (Exception e){
...
// ***** VDMTOOLS START Name=OmlStartStatement#1|IOmlExpression KEEP=NO
  public OmlStartStatement (final IOmlExpression p1) throws CGException {

    vdm_init_OmlStartStatement();
    setExpression((IOmlExpression) p1);
  }
// ***** VDMTOOLS END Name=OmlStartStatement#1|IOmlExpression
