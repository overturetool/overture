...
public class OmlTypeName extends IOmlTypeName {
...
// ***** VDMTOOLS START Name=vdm_init_OmlTypeName KEEP=NO
  private void vdm_init_OmlTypeName () throws CGException {
    try {
      ivName = null;
    }
    catch (Exception e){
...
// ***** VDMTOOLS START Name=OmlTypeName#1|IOmlName KEEP=NO
  public OmlTypeName (final IOmlName p1) throws CGException {

    vdm_init_OmlTypeName();
    setName((IOmlName) p1);
  }
// ***** VDMTOOLS END Name=OmlTypeName#1|IOmlName
