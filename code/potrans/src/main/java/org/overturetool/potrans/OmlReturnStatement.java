...
public class OmlReturnStatement extends IOmlReturnStatement {
...
// ***** VDMTOOLS START Name=vdm_init_OmlReturnStatement KEEP=NO
  private void vdm_init_OmlReturnStatement () throws CGException {
    try {
      ivExpression = null;
    }
    catch (Exception e){
...
// ***** VDMTOOLS START Name=OmlReturnStatement#1|IOmlExpression KEEP=NO
  public OmlReturnStatement (final IOmlExpression p1) throws CGException {

    vdm_init_OmlReturnStatement();
    setExpression((IOmlExpression) p1);
  }
// ***** VDMTOOLS END Name=OmlReturnStatement#1|IOmlExpression
