...
public class OmlBracketedExpression extends IOmlBracketedExpression {
...
// ***** VDMTOOLS START Name=vdm_init_OmlBracketedExpression KEEP=NO
  private void vdm_init_OmlBracketedExpression () throws CGException {
    try {
      ivExpression = null;
    }
    catch (Exception e){
...
// ***** VDMTOOLS START Name=OmlBracketedExpression#1|IOmlExpression KEEP=NO
  public OmlBracketedExpression (final IOmlExpression p1) throws CGException {

    vdm_init_OmlBracketedExpression();
    setExpression((IOmlExpression) p1);
  }
// ***** VDMTOOLS END Name=OmlBracketedExpression#1|IOmlExpression
