...
public class OmlSeq0Type extends IOmlSeq0Type {
...
// ***** VDMTOOLS START Name=vdm_init_OmlSeq0Type KEEP=NO
  private void vdm_init_OmlSeq0Type () throws CGException {
    try {
      ivType = null;
    }
    catch (Exception e){
...
// ***** VDMTOOLS END Name=vdm_init_OmlSeq0Type


// ***** VDMTOOLS START Name=OmlSeq0Type KEEP=NO
  public OmlSeq0Type () throws CGException {
    vdm_init_OmlSeq0Type();
  }
// ***** VDMTOOLS END Name=OmlSeq0Type


// ***** VDMTOOLS START Name=identity KEEP=NO
  public String identity () throws CGException {
    return new String("Seq0Type");
  }
...
// ***** VDMTOOLS START Name=accept#1|IOmlVisitor KEEP=NO
  public void accept (final IOmlVisitor pVisitor) throws CGException {
    pVisitor.visitSeq0Type((IOmlSeq0Type) this);
  }
// ***** VDMTOOLS END Name=accept#1|IOmlVisitor


// ***** VDMTOOLS START Name=OmlSeq0Type#1|IOmlType KEEP=NO
  public OmlSeq0Type (final IOmlType p1) throws CGException {

    vdm_init_OmlSeq0Type();
    setType((IOmlType) p1);
  }
// ***** VDMTOOLS END Name=OmlSeq0Type#1|IOmlType
