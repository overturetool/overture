...
public class OmlBracketedType extends IOmlBracketedType {
...
// ***** VDMTOOLS START Name=vdm_init_OmlBracketedType KEEP=NO
  private void vdm_init_OmlBracketedType () throws CGException {
    try {
      ivType = null;
    }
    catch (Exception e){
...
// ***** VDMTOOLS START Name=OmlBracketedType#1|IOmlType KEEP=NO
  public OmlBracketedType (final IOmlType p1) throws CGException {

    vdm_init_OmlBracketedType();
    setType((IOmlType) p1);
  }
// ***** VDMTOOLS END Name=OmlBracketedType#1|IOmlType
