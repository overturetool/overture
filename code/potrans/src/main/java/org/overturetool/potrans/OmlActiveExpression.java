...
public class OmlActiveExpression extends IOmlActiveExpression {
...
// ***** VDMTOOLS START Name=vdm_init_OmlActiveExpression KEEP=NO
  private void vdm_init_OmlActiveExpression () throws CGException {
    try {
...
// ***** VDMTOOLS START Name=OmlActiveExpression#1|Vector KEEP=NO
  public OmlActiveExpression (final Vector p1) throws CGException {

    vdm_init_OmlActiveExpression();
    setNameList(p1);
  }
// ***** VDMTOOLS END Name=OmlActiveExpression#1|Vector
