...
public class OmlSetType extends IOmlSetType {
...
// ***** VDMTOOLS START Name=vdm_init_OmlSetType KEEP=NO
  private void vdm_init_OmlSetType () throws CGException {
    try {
      ivType = null;
    }
    catch (Exception e){
...
// ***** VDMTOOLS END Name=vdm_init_OmlSetType
...
// ***** VDMTOOLS START Name=OmlSetType#1|IOmlType KEEP=NO
  public OmlSetType (final IOmlType p1) throws CGException {

    vdm_init_OmlSetType();
    setType((IOmlType) p1);
  }
// ***** VDMTOOLS END Name=OmlSetType#1|IOmlType
