...
// ***** VDMTOOLS END Name=setExceptions
  ...
  public String toString() {
	  ...
	  try {
		if (hasExternals()) res += this.ivExternals.toString();
		if (hasPreExpression()) res += "\npre " + this.ivPreExpression.toString();
		if (hasPostExpression()) 
			res += "\npost " + this.ivPostExpression.toString();
		else
			res += "\npost true";
