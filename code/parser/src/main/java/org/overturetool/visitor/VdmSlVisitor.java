...
// ***** VDMTOOLS START Name=VdmSlVisitor KEEP=NO
...
// ***** VDMTOOLS END Name=VdmSlVisitor
...
// ***** VDMTOOLS START Name=visitDocument KEEP=NO
  public void visitDocument (final IOmlDocument pcmp) throws CGException {
    ...
    if (cond_2.booleanValue()) {
      ...
      IOmlSpecifications tmpArg_v_4 = null;
      tmpArg_v_4 = (IOmlSpecifications) pcmp.getSpecifications();
      visitSpecifications((IOmlSpecifications) tmpArg_v_4);
    }
    Boolean cond_5 = null;
    cond_5 = pcmp.hasExpression();
    if (cond_5.booleanValue()) {

      IOmlExpression tmpArg_v_7 = null;
      tmpArg_v_7 = (IOmlExpression) pcmp.getExpression();
      visitExpression((IOmlExpression) tmpArg_v_7);
    }
  }
