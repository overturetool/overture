...
// ***** VDMTOOLS START Name=UmlOperation#6|String|IUmlVisibilityKind|IUmlMultiplicityElement|Boolean|IUmlType|Boolean KEEP=NO
  public UmlOperation (final String p1, final IUmlVisibilityKind p2, final IUmlMultiplicityElement p3, final Boolean p4, final IUmlType p5, final Boolean p6) throws CGException {
...
// ***** VDMTOOLS END Name=UmlOperation#6|String|IUmlVisibilityKind|IUmlMultiplicityElement|Boolean|IUmlType|Boolean


// ***** VDMTOOLS START Name=UmlOperation#8|String|IUmlVisibilityKind|IUmlMultiplicityElement|Boolean|IUmlType|Boolean|Integer|Integer KEEP=NO
  public UmlOperation (final String p1, final IUmlVisibilityKind p2, final IUmlMultiplicityElement p3, final Boolean p4, final IUmlType p5, final Boolean p6, final Integer line, final Integer column) throws CGException {
...
// ***** VDMTOOLS END Name=UmlOperation#8|String|IUmlVisibilityKind|IUmlMultiplicityElement|Boolean|IUmlType|Boolean|Integer|Integer
