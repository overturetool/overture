...
// ***** VDMTOOLS START Name=ivSpecification KEEP=NO
  private String ivSpecification = null;
...
// ***** VDMTOOLS START Name=vdm_init_UmlConstraint KEEP=NO
  private void vdm_init_UmlConstraint () throws CGException {
    try {
      ...
      ivSpecification = UTIL.ConvertToString(new String());
    }
    catch (Exception e){
...
// ***** VDMTOOLS START Name=UmlConstraint#2|HashSet|String KEEP=NO
  public UmlConstraint (final HashSet p1, final String p2) throws CGException {
...
// ***** VDMTOOLS END Name=UmlConstraint#2|HashSet|String


// ***** VDMTOOLS START Name=UmlConstraint#4|HashSet|String|Integer|Integer KEEP=NO
  public UmlConstraint (final HashSet p1, final String p2, final Integer line, final Integer column) throws CGException {
...
// ***** VDMTOOLS END Name=UmlConstraint#4|HashSet|String|Integer|Integer
  ...
  public void init (final HashMap data) throws CGException {
    ...
    }
    {
      ...
      if (cond_13.booleanValue()) 
        setSpecification(UTIL.ConvertToString(data.get(fname)));
    }
  }
...
// ***** VDMTOOLS START Name=getSpecification KEEP=NO
  public String getSpecification () throws CGException {
    return ivSpecification;
  }
// ***** VDMTOOLS END Name=getSpecification


// ***** VDMTOOLS START Name=setSpecification#1|String KEEP=NO
  public void setSpecification (final String parg) throws CGException {
    ivSpecification = UTIL.ConvertToString(UTIL.clone(parg));
  }
// ***** VDMTOOLS END Name=setSpecification#1|String
