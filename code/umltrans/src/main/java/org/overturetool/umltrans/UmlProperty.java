...
// ***** VDMTOOLS START Name=UmlProperty#11|String|IUmlVisibilityKind|IUmlMultiplicityElement|IUmlType|Boolean|String|Boolean|Boolean|Boolean|String|IUmlType KEEP=NO
  public UmlProperty (final String p1, final IUmlVisibilityKind p2, final IUmlMultiplicityElement p3, final IUmlType p4, final Boolean p5, final String p6, final Boolean p7, final Boolean p8, final Boolean p9, final String p10, final IUmlType p11) throws CGException {
...
// ***** VDMTOOLS END Name=UmlProperty#11|String|IUmlVisibilityKind|IUmlMultiplicityElement|IUmlType|Boolean|String|Boolean|Boolean|Boolean|String|IUmlType


// ***** VDMTOOLS START Name=UmlProperty#13|String|IUmlVisibilityKind|IUmlMultiplicityElement|IUmlType|Boolean|String|Boolean|Boolean|Boolean|String|IUmlType|Integer|Integer KEEP=NO
  public UmlProperty (final String p1, final IUmlVisibilityKind p2, final IUmlMultiplicityElement p3, final IUmlType p4, final Boolean p5, final String p6, final Boolean p7, final Boolean p8, final Boolean p9, final String p10, final IUmlType p11, final Integer line, final Integer column) throws CGException {
...
// ***** VDMTOOLS END Name=UmlProperty#13|String|IUmlVisibilityKind|IUmlMultiplicityElement|IUmlType|Boolean|String|Boolean|Boolean|Boolean|String|IUmlType|Integer|Integer
