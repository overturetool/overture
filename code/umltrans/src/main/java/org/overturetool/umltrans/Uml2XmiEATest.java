...
public class Uml2XmiEATest extends TestCase {
...
// ***** VDMTOOLS START Name=vdm_init_Uml2XmiEATest KEEP=NO
  private void vdm_init_Uml2XmiEATest () throws CGException {
    try {
      testSpec = null;
    }
    catch (Exception e){
...
// ***** VDMTOOLS END Name=vdm_init_Uml2XmiEATest


// ***** VDMTOOLS START Name=Uml2XmiEATest KEEP=NO
  public Uml2XmiEATest () throws CGException {

    super(new String("Uml2XmiEATest"));
    vdm_init_Uml2XmiEATest();
  }
// ***** VDMTOOLS END Name=Uml2XmiEATest
...
// ***** VDMTOOLS START Name=test01 KEEP=NO
  public void test01 () throws CGException {
    ...
    String fileName = new String("ClassAbstractOperation.xml");
    ...
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassAssociation.xml")));
    ...
    vu = (Vdm2Uml) UTIL.clone(new Vdm2Uml());
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassAssociationN.xml")));
    ...
    vu = (Vdm2Uml) UTIL.clone(new Vdm2Uml());
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassInheritance.xml")));
    ...
    vu = (Vdm2Uml) UTIL.clone(new Vdm2Uml());
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassInstanceUnionType.xml")));
    ...
    vu = (Vdm2Uml) UTIL.clone(new Vdm2Uml());
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassSimpleOperation.xml")));
    ...
    vu = (Vdm2Uml) UTIL.clone(new Vdm2Uml());
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassTemplates.xml")));
    ...
    vu = (Vdm2Uml) UTIL.clone(new Vdm2Uml());
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassWithMap.xml")));
    ...
    vu = (Vdm2Uml) UTIL.clone(new Vdm2Uml());
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassWithTypes.xml")));
    ...
    vu = (Vdm2Uml) UTIL.clone(new Vdm2Uml());
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassWithValues.xml")));
    ...
    vu = (Vdm2Uml) UTIL.clone(new Vdm2Uml());
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassSimpleFunction.xml")));
    ...
    vu = (Vdm2Uml) UTIL.clone(new Vdm2Uml());
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassActive.xml")));
    ...
    vu = (Vdm2Uml) UTIL.clone(new Vdm2Uml());
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassInstanceVar.xml")));
    ...
    vu = (Vdm2Uml) UTIL.clone(new Vdm2Uml());
    xmi = (Uml2XmiEAxml) UTIL.clone(new Uml2XmiEAxml());
    fileName = UTIL.ConvertToString(UTIL.clone(new String("ClassWithMap2.xml")));
    IOmlSpecifications rhs_131 = null;
    OmlDocument obj_132 = null;
    obj_132 = new TestData().ClassWithMap2;
    rhs_131 = (IOmlSpecifications) obj_132.getSpecifications();
    testSpec = (IOmlSpecifications) UTIL.clone(rhs_131);
    IUmlModel par_136 = null;
    par_136 = (IUmlModel) vu.init((IOmlSpecifications) testSpec);
    xmi.Save(fileName, (IUmlModel) par_136);
