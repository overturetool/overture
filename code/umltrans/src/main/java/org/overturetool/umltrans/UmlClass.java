...
// ***** VDMTOOLS START Name=ivSupers KEEP=NO
  private IUmlInheritanceClause ivSupers = null;
// ***** VDMTOOLS END Name=ivSupers
...
// ***** VDMTOOLS START Name=UmlClass#8|String|HashSet|Boolean|IUmlInheritanceClause|IUmlVisibilityKind|Boolean|Boolean|IUmlTemplateSignature KEEP=NO
  public UmlClass (final String p1, final HashSet p2, final Boolean p3, final IUmlInheritanceClause p4, final IUmlVisibilityKind p5, final Boolean p6, final Boolean p7, final IUmlTemplateSignature p8) throws CGException {
    ...
    vdm_init_UmlClass();
    {
      ...
      setClassBody(p2);
      setIsAbstract(p3);
      setSupers((IUmlInheritanceClause) p4);
...
// ***** VDMTOOLS END Name=UmlClass#8|String|HashSet|Boolean|IUmlInheritanceClause|IUmlVisibilityKind|Boolean|Boolean|IUmlTemplateSignature


// ***** VDMTOOLS START Name=UmlClass#10|String|HashSet|Boolean|IUmlInheritanceClause|IUmlVisibilityKind|Boolean|Boolean|IUmlTemplateSignature|Integer|Integer KEEP=NO
  public UmlClass (final String p1, final HashSet p2, final Boolean p3, final IUmlInheritanceClause p4, final IUmlVisibilityKind p5, final Boolean p6, final Boolean p7, final IUmlTemplateSignature p8, final Integer line, final Integer column) throws CGException {
...
// ***** VDMTOOLS END Name=UmlClass#10|String|HashSet|Boolean|IUmlInheritanceClause|IUmlVisibilityKind|Boolean|Boolean|IUmlTemplateSignature|Integer|Integer
...
// ***** VDMTOOLS START Name=getSupers KEEP=NO
  public IUmlInheritanceClause getSupers () throws CGException {
    return (IUmlInheritanceClause) ivSupers;
  }
// ***** VDMTOOLS END Name=getSupers


// ***** VDMTOOLS START Name=hasSupers KEEP=NO
  public Boolean hasSupers () throws CGException {
    return new Boolean(!UTIL.equals(ivSupers, null));
  }
// ***** VDMTOOLS END Name=hasSupers


// ***** VDMTOOLS START Name=setSupers#1|IUmlInheritanceClause KEEP=NO
  public void setSupers (final IUmlInheritanceClause parg) throws CGException {
    ivSupers = (IUmlInheritanceClause) UTIL.clone(parg);
  }
// ***** VDMTOOLS END Name=setSupers#1|IUmlInheritanceClause
