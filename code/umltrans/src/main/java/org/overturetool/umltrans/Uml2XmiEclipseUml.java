...
// ***** VDMTOOLS START Name=PrintClass#1|IUmlClass KEEP=NO
  protected void PrintClass (final IUmlClass cl) throws CGException {
    ...
    if (cond_61.booleanValue()) {
      ...
      PrintGeneralization((IUmlInheritanceClause) tmpArg_v_63);
    }
    doc.StopE(oe);
  }
      ...
      associationId = tmpVal_17;
      {
        ...
        doc.StartA(new String("xmi:type"), new String("uml:Association"));
        {
          ...
          HashSet res_s_59 = new HashSet();
          {
            ...
            e_set_64 = association.getOwnedNavivableEnds();
            IUmlProperty p = null;
            {
          ...
          for (Iterator enm_192 = iset_27.iterator(); enm_192.hasNext(); ) {
            ...
            prop = elem_28;
            {
              ...
              obj_68 = (IUmlProperty) prop.GetField(new Integer(1).intValue());
              ...
              if (cond_67.booleanValue()) {
                ...
                obj_76 = (IUmlProperty) prop.GetField(new Integer(1).intValue());
                ...
                obj_90 = (IUmlProperty) prop.GetField(new Integer(1).intValue());
              ...
              par_104 = (Boolean) prop.GetField(new Integer(2).intValue());
              par_103 = UTIL.ConvertToString(Util.ToStringBool(par_104));
              doc.StartA(new String("isNavigable"), par_103);
              Boolean cond_107 = null;
              Integer var1_108 = null;
              String unArg_109 = null;
              IUmlProperty obj_110 = null;
              obj_110 = (IUmlProperty) prop.GetField(new Integer(1).intValue());
              unArg_109 = obj_110.getName();
              var1_108 = new Integer(unArg_109.length());
              cond_107 = new Boolean((var1_108.intValue()) > (new Integer(0).intValue()));
              if (cond_107.booleanValue()) {

                String par_119 = null;
                IUmlProperty obj_120 = null;
                obj_120 = (IUmlProperty) prop.GetField(new Integer(1).intValue());
              ...
              obj_127 = (IUmlProperty) prop.GetField(new Integer(1).intValue());
              ...
              doc.StartA(new String("visibility"), par_125);
              {
                ...
                String associationEndId = GetNextId();
                {
                  ...
                  obj_139 = (IUmlProperty) prop.GetField(new Integer(1).intValue());
                  ...
                  if (cond_138.booleanValue()) {
                    ...
                    obj_147 = (IUmlProperty) prop.GetField(new Integer(1).intValue());
                    ...
                    obj_152 = (IUmlProperty) prop.GetField(new Integer(1).intValue());
                  ...
                  unArg_156 = (Boolean) prop.GetField(new Integer(2).intValue());
                  ...
                  obj_162 = (IUmlProperty) prop.GetField(new Integer(1).intValue());
                  ...
                  if (cond_161.booleanValue()) {
                    ...
                    obj_169 = (IUmlProperty) prop.GetField(new Integer(1).intValue());
                  ...
                  obj_178 = (IUmlProperty) prop.GetField(new Integer(1).intValue());
...
// ***** VDMTOOLS START Name=PrintGeneralization#1|IUmlInheritanceClause KEEP=NO
  protected void PrintGeneralization (final IUmlInheritanceClause ihc) throws CGException {
...
// ***** VDMTOOLS END Name=PrintGeneralization#1|IUmlInheritanceClause
