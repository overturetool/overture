...
/**
* jp/co/csk/vdm/toolbox/api/corba/VDM/ClientIDHelper.java .
...
{
  private static String  _id = "IDL:VDM/ClientID:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (jp.co.csk.vdm.toolbox.api.corba.VDM.ClientIDHelper.id (), "ClientID", __typeCode);
    }
    return __typeCode;
  }
