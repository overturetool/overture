...
\subsection{Vienna Development Method Specification Language (VDM-SL)}
...
Operations manipulate data stored in the persistent state and mimic the operation of the system.
