...
\maketitle
\begin{abstract}
Sander Verm\"olen has produced a VDM to HOL translator formal prototype together with HOL tactics that allow VDM proof obligations to be discharged in the theorem prover HOL.
