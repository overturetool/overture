...
\item[Release 0.3.0 (June 2010):] The aim for this release is to
  include the following features:  
\begin{enumerate}
\item Decide if we want to include the Update Manager or embed a number of videly used features like Sub Version control.

\item Investigate the posibility of Eclipse p2. (Adding Self-Update to an RCP Application) \url{http://wiki.eclipse.org/RCP_FAQ}
