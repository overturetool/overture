...
\begin{denseitemize}
\item Overture 1.1.2 release, with minor bugfixes \developer{ARI, KEL}
\item DESTECS 1.3.0 release, based on Overture 1.1.2 \developer{ARI, KEL}
\end{denseitemize}

\paragraph{March 2012} 
\begin{denseitemize}
\item DESTECS 1.3.1 release, based on Overture 1.1.2 \developer{ARI, KEL}
\item Overture v2 release, based on New AST \developer{KEL, JWC}
\end{denseitemize}

\paragraph{April 2012}
\begin{denseitemize}
\item DESTECS 1.3.2 release, based on Overture 1.1.2 \developer{ARI, KEL}
\end{denseitemize}
