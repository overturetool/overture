...
additional material (see Figure~\ref{fig:userguire:welcomeWindow}).
...
\section{Run and Debug Launch Configurations}
...
However, there are other launch mode possibilities here as well. The
...
Figure~\ref{fig:userguide:launchconfigRToptions}). In the launch
