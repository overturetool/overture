...
proportional font where all keyword are typeset in a bold font. 
...
\item[post condition:]
\item[function satisfiability:]
\item[function parameter patterns:]
\item[let be st existence:]
\item[unique existence binding:]
