...
\begin{figure}[!hbt]
\begin{center}
  \includegraphics[scale=0.8]{screendumps/projectsettings}
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=\textwidth]{figures/Breakpointconditional}
...
perspective can be seen in Figure~\ref{fig:stracesalarm}.
