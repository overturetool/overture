...
there is no update manager included, however external plug-ins can
still be manually installed.  To install a plug-in there are two
...
So for example in order to add SVN support to the Overture IDE is rather simple:
\begin{enumerate}
