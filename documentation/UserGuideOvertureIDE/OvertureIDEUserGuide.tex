...
from Figure~\ref{fig:userguide:listedConjecturesViolated}, where the response
and trigger of the first and second violation, respectively, occur at the same
point in time. This explains why only three markers (the red circles), are
