...
different VDM source files shall be included\footnote{This feature is
  not fully supported in this version of the Overture IDE.}.
...
The ``\texttt{;}'' operator is used for indicating a sequencing
...
The ``\texttt{|}'' operator is used for indicating alternative
