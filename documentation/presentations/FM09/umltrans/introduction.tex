...
\frame
{
  ...
  \begin{itemize}
	%\itemsep=1cm
  		\item<1-> VDM Specification Language (VDM-SL) ISO released in '96
  		\item<2-> Extended in 1992-94 with object oriented structure and concurrency handling (VDM++).
  		\item<3-> Last extension made for distributed real-time systems (VICE).
  		\item<4-> Two most significant tool suites.
  		\begin{itemize}
