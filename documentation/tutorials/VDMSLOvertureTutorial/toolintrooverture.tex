...
Overture\footnote{Note that the Overture tool suite support three
  ...
  these dialects throughout this tutorial.}; more
...
\noindent The nested let-be statements in the trace
...
let-be expression. In this case, the cardinality of the three
