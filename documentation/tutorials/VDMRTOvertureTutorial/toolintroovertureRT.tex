...
operations so in total this generates 18 (3 times 6) test cases.  If you
...
\caption{Using Combinatorial Testing for the Alarm VDM++ model\label{fig:tracesradnav}}
\end{center}
\end{figure}
