...
the {\tt c1 and r1}, \ldots, {\tt cn and rn}. However, in a VDM-SL
setting where operation quotation of the pre- and post-conditions is
possible the \keyw{errs} parts a the operation definition are not
taken into account. 
