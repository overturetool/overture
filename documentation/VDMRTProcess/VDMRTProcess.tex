...
% A sample execution is shown in Figure~\ref{fig:seqdiagtimestamp}. In this example three clients exist: two ``fast'' clients and one ``slow'' client. The two fast clients each have execution period every 10 time steps, while the slow client has execution period every 30 time steps. 
