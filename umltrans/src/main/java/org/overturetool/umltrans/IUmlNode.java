...
// ***** VDMTOOLS START Name=getContextInfo#1|Integer KEEP=NO
  public IUmlContextInfo getContextInfo (final Integer pci) throws CGException {
...
// ***** VDMTOOLS START Name=addContextInfo#1|IUmlContextInfo KEEP=NO
  public Integer addContextInfo (final IUmlContextInfo pci) throws CGException {
...
// ***** VDMTOOLS START Name=setLine#1|Integer KEEP=NO
  public void setLine (final Integer pl) throws CGException {
    ivLine = UTIL.NumberToInt(UTIL.clone(pl));
  }
...
// ***** VDMTOOLS START Name=setColumn#1|Integer KEEP=NO
  public void setColumn (final Integer pc) throws CGException {
    ivColumn = UTIL.NumberToInt(UTIL.clone(pc));
  }
// ***** VDMTOOLS END Name=setColumn#1|Integer


// ***** VDMTOOLS START Name=setPosition#2|Integer|Integer KEEP=NO
  public void setPosition (final Integer pl, final Integer pc) throws CGException {

    setLine(pl);
    setColumn(pc);
  }
// ***** VDMTOOLS END Name=setPosition#2|Integer|Integer
