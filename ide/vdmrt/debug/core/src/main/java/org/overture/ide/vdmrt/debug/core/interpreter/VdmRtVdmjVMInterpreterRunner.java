...
//
// protected VdmRtVdmjVMInterpreterRunner(IInterpreterInstall install) {
// super(install);
// }
//
...
// IVMInstall vmInstall = myJavaProject.exists() ?
// JavaRuntime.getVMInstall(myJavaProject)
...
// launch.getLaunchConfiguration().getAttribute(VdmRtDebugConstants.VDMRT_DEBUGGING_OPERATION,
// "");
//							
...
// arguments[argNumber++] =
// memberFilesList.get(a).getLocationURI().toASCIIString();
// }
//							
...
// // memberFilesList.add(ProjectUtility.getFile(project,
...
// newCmdLine[1] =
// DLTKCore.getDefault().getStateLocation().append("overture_proxy").toOSString();
//
