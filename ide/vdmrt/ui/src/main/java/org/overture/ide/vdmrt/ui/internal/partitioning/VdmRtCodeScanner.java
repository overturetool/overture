...
public class VdmRtCodeScanner extends AbstractScriptScanner implements IScriptColorTokenLocator
{
	...
	static
	{
		...
		providers.add(new VdmKeywordRules(new VdmRtKeywords()));
	}



	public VdmRtCodeScanner(IColorManager manager, IPreferenceStore store)
	{
		super(manager, store);
		initialize();
	}
