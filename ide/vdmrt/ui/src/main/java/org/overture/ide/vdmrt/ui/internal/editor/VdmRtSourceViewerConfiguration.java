...
import org.overture.ide.vdmrt.ui.completions.VdmRtCompletionProcessor;
		...
		ScriptSourceViewerConfiguration
{
	...
	protected void alterContentAssistant(ContentAssistant assistant) {
		...
		IContentAssistProcessor scriptProcessor = new VdmRtCompletionProcessor(getEditor(), assistant, IDocument.DEFAULT_CONTENT_TYPE);
