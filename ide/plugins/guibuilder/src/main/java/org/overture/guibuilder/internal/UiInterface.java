...
/**
 * This is the base of the graphical user interface. Retrieves the necessary information about the vdm specification,
 * calls ui generators (if necessary), renders the defined ui, and finally manages the ui.
 * 
 * @author carlos
 */
public class UiInterface
{
	 ...
	 * 
	 * @param interpreter
	 *            - the vdmj command interpreter wrapper
	 */
	 ...
	 * 
	 * @param file
	 *            - the swixml file containing the xml description of the window
	 * @param name
	 *            - the name to give the new window
	 * @throws Exception
	 */
	 ...
	 * 
	 * @param file
	 *            - the swixml containing the xml description of the window
	 * @param name
	 *            - the name to give the window
	 * @throws Exception
	 */
	 ...
	 *            - the window's name
	 * @param flag
	 *            - value for the visibility property, false the window's invisible, true, the window's visible
	 * @throws Exception
	 */
	public void setWindowVisible(String windowName, boolean flag)
			throws Exception
	{
		...
		if (cnt == null)
		{
			throw new Exception("Window with id "
					+ NamingPolicies.getObjectWindowId(windowName)
					+ " not found");
		}
	 ...
	 * @throws Exception
	 */
	public void createNewVdmObjectInstance(String name, String className)
			throws Exception
	{
	 ...
	 * 
	 * @param name
	 *            - string containing the name of the instance
	 * @param className
	 *            - string with name of the class
	 * @param constructorArgs
	 *            - list of strings, containing the arguments for the constructor
	 * @throws Exception
	 */
	public void createNewVdmObjectInstance(String name, String className,
			List<String> constructorArgs) throws Exception
	{
	 ...
	 * 
	 * @param instanceName
	 *            - the name of the vdm object instance
	 * @param methodName
	 *            - the name of the method to call
	 * @param arguments
	 *            - list with the method's arguments, if any
	 * @return The result of calling the method in string form.
	 * @throws Exception
	 */
	public String callVdmMethod(String instanceName, String methodName,
	...
	/**
	 * Asks the intepreter to execute a vdm command, returning the result of it's execution
	 * 
	 * @param command
	 *            - a string containing the vdm command to send to the interpreter
	 ...
	 * 
	 * @param reader
	 *            The vdm class reader to extract information from the specification.
	 * @param projectName
	 *            The name of the project.
	 * @param savePath
	 *            The path to save the gui description.
	 * @throws Exception
	 */
	public void buildAndRender(IVdmClassReader reader, String projectName,
			String savePath) throws Exception
	{
		...
		if (classList.size() > 1)
		{
			...
			if (i > 1)
			{
				file = new File(savePath + NamingPolicies.getMainWindowId()
						+ ".xml");
	 ...
	 * 
	 * @param reader
	 *            The vdm class reader that will be used to extract information.
	 * @param projectName
	 *            The name of the project.
	 * @throws Exception
	 */
	 ...
	 * 
	 * @param extractClassName
	 *            The name of the vdm class to search.
	...
	/**
	 * Renders the graphical user interface from the xml ui description files. (The components of the UI are not
	 * immediately set to visible)
	 * 
	 * @param reader
	 *            The vdm class reader to be used.
	 * @param projectName
	 *            The name of the project.
	 * @param xmlFiles
			...
			Vector<File> xmlFiles) throws Exception
	{
		...
		for (File xmlFile : xmlFiles)
		{
			...
			{
				this.renderMainWindow(xmlFile, NamingPolicies.getMainWindowId());
				continue;
			}
