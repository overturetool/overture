 ...
 *******************************************************************************/
package org.overture.ide.plugins.traces.perspectives;
...
public class CombinatorialTestingPerspective implements IPerspectiveFactory {
	...
	private void addViews() {
		...
		bottom.addView("org.overture.ide.plugins.traces.views.TraceTest"); //NON-NLS-1
		...
		right.addView("org.overture.ide.plugins.traces.views.TracesView"); //NON-NLS-1
