...
//
//		if (type != IVdmElement.VDM_MODEL && type != IVdmElement.VDM_PROJECT && type != IVdmElement.PACKAGE_FRAGMENT_ROOT)
//			root= JavaModelUtil.getPackageFragmentRoot(element);
//		if (root != null && getFlag(flags, VdmElementLabels.PREPEND_ROOT_PATH)) {
//			appendPackageFragmentRootLabel(root, VdmElementLabels.ROOT_QUALIFIED);
//			fBuffer.append(VdmElementLabels.CONCAT_STRING);
//		}
//
//		switch (type) {
...
//		}
//
//		if (root != null && getFlag(flags, VdmElementLabels.APPEND_ROOT_PATH)) {
//			int offset= fBuffer.length();
//			fBuffer.append(VdmElementLabels.CONCAT_STRING);
//			appendPackageFragmentRootLabel(root, VdmElementLabels.ROOT_QUALIFIED);
//
//			if (getFlag(flags, VdmElementLabels.COLORIZE)) {
...
//		try {
//			BindingKey resolvedKey= getFlag(flags, VdmElementLabels.USE_RESOLVED) && method.isResolved() ? new BindingKey(method.getKey()) : null;
//			String resolvedSig= (resolvedKey != null) ? resolvedKey.toSignature() : null;
//
//			// type parameters
//			if (getFlag(flags, VdmElementLabels.M_PRE_TYPE_PARAMETERS)) {
//				if (resolvedKey != null) {
...
//
//			// return type
//			if (getFlag(flags, VdmElementLabels.M_PRE_RETURNTYPE) && method.exists() && !method.isConstructor()) {
...
//
//			// qualification
//			if (getFlag(flags, VdmElementLabels.M_FULLY_QUALIFIED)) {
//				appendTypeLabel(method.getDeclaringType(), VdmElementLabels.T_FULLY_QUALIFIED | (flags & QUALIFIER_FLAGS));
//				fBuffer.append('.');
//			}
//
...
//			// parameters
//			fBuffer.append('(');
//			if (getFlag(flags, VdmElementLabels.M_PARAMETER_TYPES | VdmElementLabels.M_PARAMETER_NAMES)) {
//				String[] types= null;
//				int nParams= 0;
//				boolean renderVarargs= false;
//				if (getFlag(flags, VdmElementLabels.M_PARAMETER_TYPES)) {
//					if (resolvedSig != null) {
...
//				}
//				String[] names= null;
//				if (getFlag(flags, VdmElementLabels.M_PARAMETER_NAMES) && method.exists()) {
...
//								// JavaPlugin.logErrorMessage("VdmElementLabels: Number of param types(" + nParams + ") != number of names(" + names.length + "): " + method.getElementName());   //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
...
//					if (i > 0) {
//						fBuffer.append(VdmElementLabels.COMMA_STRING);
//					}
//					if (types != null) {
...
//							}
//							fBuffer.append(VdmElementLabels.ELLIPSIS_STRING);
//						} else {
...
//			fBuffer.append(')');
//
//			if (getFlag(flags, VdmElementLabels.M_EXCEPTIONS)) {
//				String[] types;
//				if (resolvedKey != null) {
...
//
//
//			if (getFlag(flags, VdmElementLabels.M_APP_TYPE_PARAMETERS)) {
//				int offset= fBuffer.length();
//				if (resolvedKey != null) {
//					if (resolvedKey.isParameterizedMethod()) {
//						String[] typeArgRefs= resolvedKey.getTypeArguments();
...
//					}
//				}
//				if (getFlag(flags, VdmElementLabels.COLORIZE) && offset != fBuffer.length()) {
//					fBuffer.setStyle(offset, fBuffer.length() - offset, DECORATIONS_STYLE);
//				}
//			}
//
//			if (getFlag(flags, VdmElementLabels.M_APP_RETURNTYPE) && method.exists() && !method.isConstructor()) {
//				int offset= fBuffer.length();
//				fBuffer.append(VdmElementLabels.DECL_STRING);
//				String returnTypeSig= resolvedSig != null ? Signature.getReturnType(resolvedSig) : method.getReturnType();
//				appendTypeSignatureLabel(method, returnTypeSig, flags);
//				if (getFlag(flags, VdmElementLabels.COLORIZE)) {
//					fBuffer.setStyle(offset, fBuffer.length() - offset, DECORATIONS_STYLE);
...
//
//			// category
//			if (getFlag(flags, VdmElementLabels.M_CATEGORY) && method.exists())
//				appendCategoryLabel(method, flags);
//
//			// post qualification
//			if (getFlag(flags, VdmElementLabels.M_POST_QUALIFIED)) {
//				int offset= fBuffer.length();
//				fBuffer.append(VdmElementLabels.CONCAT_STRING);
//				appendTypeLabel(method.getDeclaringType(), VdmElementLabels.T_FULLY_QUALIFIED | (flags & QUALIFIER_FLAGS));
//				if (getFlag(flags, VdmElementLabels.COLORIZE)) {
...
//				if (i > 0)
//					categoriesBuf.append(VdmElementLabels.CATEGORY_SEPARATOR_STRING);
//				categoriesBuf.append(categories[i]);
//			}
//			fBuffer.append(VdmElementLabels.CONCAT_STRING);
//			fBuffer.append(Messages.format(JavaUIMessages.VdmElementLabels_category, categoriesBuf.toString()));
//			if (getFlag(flags, VdmElementLabels.COLORIZE)) {
...
//		try {
//
//			if (getFlag(flags, VdmElementLabels.F_PRE_TYPE_SIGNATURE) && field.exists() && !Flags.isEnum(field.getFlags())) {
//				if (getFlag(flags, VdmElementLabels.USE_RESOLVED) && field.isResolved()) {
...
//
//			// qualification
//			if (getFlag(flags, VdmElementLabels.F_FULLY_QUALIFIED)) {
//				appendTypeLabel(field.getDeclaringType(), VdmElementLabels.T_FULLY_QUALIFIED | (flags & QUALIFIER_FLAGS));
//				fBuffer.append('.');
//			}
//			fBuffer.append(getElementName(field));
//
//			if (getFlag(flags, VdmElementLabels.F_APP_TYPE_SIGNATURE) && field.exists() && !Flags.isEnum(field.getFlags())) {
//				int offset= fBuffer.length();
//				fBuffer.append(VdmElementLabels.DECL_STRING);
//				if (getFlag(flags, VdmElementLabels.USE_RESOLVED) && field.isResolved()) {
//					appendTypeSignatureLabel(field, new BindingKey(field.getKey()).toSignature(), flags);
...
//
//			// category
//			if (getFlag(flags, VdmElementLabels.F_CATEGORY) && field.exists())
//				appendCategoryLabel(field, flags);
//
//			// post qualification
//			if (getFlag(flags, VdmElementLabels.F_POST_QUALIFIED)) {
//				int offset= fBuffer.length();
//				fBuffer.append(VdmElementLabels.CONCAT_STRING);
//				appendTypeLabel(field.getDeclaringType(), VdmElementLabels.T_FULLY_QUALIFIED | (flags & QUALIFIER_FLAGS));
//				if (getFlag(flags, VdmElementLabels.COLORIZE)) {
...
//		if (getFlag(flags, VdmElementLabels.F_PRE_TYPE_SIGNATURE)) {
//			appendTypeSignatureLabel(localVariable, localVariable.getTypeSignature(), flags);
//			fBuffer.append(' ');
//		}
//
//		if (getFlag(flags, VdmElementLabels.F_FULLY_QUALIFIED)) {
//			appendElementLabel(localVariable.getParent(), VdmElementLabels.M_PARAMETER_TYPES | VdmElementLabels.M_FULLY_QUALIFIED | VdmElementLabels.T_FULLY_QUALIFIED | (flags & QUALIFIER_FLAGS));
//			fBuffer.append('.');
//		}
//
//		fBuffer.append(getElementName(localVariable));
//
//		if (getFlag(flags, VdmElementLabels.F_APP_TYPE_SIGNATURE)) {
//			int offset= fBuffer.length();
//			fBuffer.append(VdmElementLabels.DECL_STRING);
//			appendTypeSignatureLabel(localVariable, localVariable.getTypeSignature(), flags);
//			if (getFlag(flags, VdmElementLabels.COLORIZE)) {
...
//
//			// post qualification
//			if (getFlag(flags, VdmElementLabels.TP_POST_QUALIFIED)) {
//				fBuffer.append(VdmElementLabels.CONCAT_STRING);
//				appendElementLabel(declaringMember, VdmElementLabels.M_PARAMETER_TYPES | VdmElementLabels.M_FULLY_QUALIFIED | VdmElementLabels.T_FULLY_QUALIFIED | (flags & QUALIFIER_FLAGS));
//			}
//
//		} catch (JavaModelException e) {
//			JavaPlugin.log(e); // NotExistsException will not reach this point
...
//		// qualification
//		if (getFlag(flags, VdmElementLabels.I_FULLY_QUALIFIED)) {
//			appendTypeLabel(initializer.getDeclaringType(), VdmElementLabels.T_FULLY_QUALIFIED | (flags & QUALIFIER_FLAGS));
//			fBuffer.append('.');
//		}
//		fBuffer.append(JavaUIMessages.VdmElementLabels_initializer);
//
//		// post qualification
//		if (getFlag(flags, VdmElementLabels.I_POST_QUALIFIED)) {
//			int offset= fBuffer.length();
//			fBuffer.append(VdmElementLabels.CONCAT_STRING);
//			appendTypeLabel(initializer.getDeclaringType(), VdmElementLabels.T_FULLY_QUALIFIED | (flags & QUALIFIER_FLAGS));
//			if (getFlag(flags, VdmElementLabels.COLORIZE)) {
...
//	}
//
//	protected void appendTypeSignatureLabel(IVdmElement enclosingElement, String typeSig, long flags) {
...
//	 */
//	protected String getSimpleTypeName(IVdmElement enclosingElement, String typeSig) {
//		return Signature.getSimpleName(Signature.toString(typeSig));
//	}
//
//	private void appendTypeArgumentSignaturesLabel(IVdmElement enclosingElement, String[] typeArgsSig, long flags) {
...
//
//		if (getFlag(flags, VdmElementLabels.T_FULLY_QUALIFIED)) {
...
//			}
//		}
//		if (getFlag(flags, VdmElementLabels.T_FULLY_QUALIFIED | VdmElementLabels.T_CONTAINER_QUALIFIED)) {
//			IType declaringType= type.getDeclaringType();
//			if (declaringType != null) {
//				appendTypeLabel(declaringType, VdmElementLabels.T_CONTAINER_QUALIFIED | (flags & QUALIFIER_FLAGS));
//				fBuffer.append('.');
//			}
//			int parentType= type.getParent().getElementType();
//			if (parentType == IVdmElement.METHOD || parentType == IVdmElement.FIELD || parentType == IVdmElement.INITIALIZER) { // anonymous or local
...
//					typeName= '{' + VdmElementLabels.ELLIPSIS_STRING + '}';
//				} else {
...
//					}
//					typeName= Messages.format(JavaUIMessages.VdmElementLabels_anonym_type , supertypeName);
//				}
//			} catch (JavaModelException e) {
//				//ignore
//				typeName= JavaUIMessages.VdmElementLabels_anonym;
//			}
//		}
//		fBuffer.append(typeName);
//		if (getFlag(flags, VdmElementLabels.T_TYPE_PARAMETERS)) {
//			if (getFlag(flags, VdmElementLabels.USE_RESOLVED) && type.isResolved()) {
...
//
//		// category
//		if (getFlag(flags, VdmElementLabels.T_CATEGORY) && type.exists()) {
//			try {
...
//
//		// post qualification
//		if (getFlag(flags, VdmElementLabels.T_POST_QUALIFIED)) {
//			int offset= fBuffer.length();
//			fBuffer.append(VdmElementLabels.CONCAT_STRING);
//			IType declaringType= type.getDeclaringType();
//			if (declaringType != null) {
//				appendTypeLabel(declaringType, VdmElementLabels.T_FULLY_QUALIFIED | (flags & QUALIFIER_FLAGS));
//				int parentType= type.getParent().getElementType();
//				if (parentType == IVdmElement.METHOD || parentType == IVdmElement.FIELD || parentType == IVdmElement.INITIALIZER) { // anonymous or local
//					fBuffer.append('.');
//					appendElementLabel(type.getParent(), 0);
...
//
//	/**
//	 * Returns the string for rendering the {@link IVdmElement#getElementName() element name} of the given element.
//	 *
//	 * @param element the element to render
//	 * @return the string for rendering the element name
//	 */
//	protected String getElementName(IVdmElement element) {
...
//	 */
//	public void appendDeclarationLabel(IVdmElement declaration, long flags) {
//		if (getFlag(flags, VdmElementLabels.D_QUALIFIED)) {
//			IVdmElement openable= (IVdmElement) declaration.getOpenable();
//			if (openable != null) {
//				appendElementLabel(openable, VdmElementLabels.CF_QUALIFIED | VdmElementLabels.CU_QUALIFIED | (flags & QUALIFIER_FLAGS));
//				fBuffer.append('/');
//			}
//		}
//		if (declaration.getElementType() == IVdmElement.IMPORT_CONTAINER) {
//			fBuffer.append(VdmUIMessages.VdmElementLabels_import_container);
//		} else {
//			fBuffer.append(declaration.getElementName());
//		}
//		// post qualification
//		if (getFlag(flags, VdmElementLabels.D_POST_QUALIFIED)) {
//			int offset= fBuffer.length();
//			IVdmElement openable= (IVdmElement) declaration.getOpenable();
//			if (openable != null) {
//				fBuffer.append(VdmElementLabels.CONCAT_STRING);
...
//		if (getFlag(flags, VdmElementLabels.CF_QUALIFIED)) {
...
//
//		if (getFlag(flags, VdmElementLabels.CF_POST_QUALIFIED)) {
//			int offset= fBuffer.length();
//			fBuffer.append(VdmElementLabels.CONCAT_STRING);
...
//		if (getFlag(flags, VdmElementLabels.CU_QUALIFIED)) {
...
//
//		if (getFlag(flags, VdmElementLabels.CU_POST_QUALIFIED)) {
//			int offset= fBuffer.length();
//			fBuffer.append(VdmElementLabels.CONCAT_STRING);
...
//		if (getFlag(flags, VdmElementLabels.P_QUALIFIED)) {
//			appendPackageFragmentRootLabel((IPackageFragmentRoot) pack.getParent(), VdmElementLabels.ROOT_QUALIFIED);
//			fBuffer.append('/');
//		}
//		if (pack.isDefaultPackage()) {
//			fBuffer.append(VdmElementLabels.DEFAULT_PACKAGE);
//		} else if (getFlag(flags, VdmElementLabels.P_COMPRESSED)) {
//			appendCompressedPackageFragment(pack);
//		} else {
//			fBuffer.append(pack.getElementName());
//		}
//		if (getFlag(flags, VdmElementLabels.P_POST_QUALIFIED)) {
//			int offset= fBuffer.length();
//			fBuffer.append(VdmElementLabels.CONCAT_STRING);
//			appendPackageFragmentRootLabel((IPackageFragmentRoot) pack.getParent(), VdmElementLabels.ROOT_QUALIFIED);
//			if (getFlag(flags, VdmElementLabels.COLORIZE)) {
...
//		if (getFlag(flags, VdmElementLabels.ROOT_VARIABLE) && appendVariableLabel(root, flags))
//			return;
//		if (root.isArchive())
...
//
//				if (getFlag(flags, VdmElementLabels.REFERENCED_ROOT_POST_QUALIFIED)) {
...
//		boolean rootQualified= getFlag(flags, VdmElementLabels.ROOT_QUALIFIED);
//		boolean referencedQualified= getFlag(flags, VdmElementLabels.REFERENCED_ROOT_POST_QUALIFIED) && isReferenced(root);
//		if (rootQualified) {
//			fBuffer.append(root.getPath().makeRelative().toString());
//		} else {
...
//			} else if (getFlag(flags, VdmElementLabels.ROOT_POST_QUALIFIED)) {
//				fBuffer.append(VdmElementLabels.CONCAT_STRING);
