...
public class Strings {
	 ...
	 * @since 3.1
	 */
	public static int computeIndentUnits(String line, IVdmProject project) {
		//TODO: FIX THIS
//		return IndentManipulation.measureIndentUnits(line, CodeFormatterUtil.getTabWidth(project), CodeFormatterUtil.getIndentWidth(project));
	 ...
	 * @since 3.1
	 */
//	public static String trimIndent(String line, int indentsToRemove, IVdmProject project) {
...
//	}
	 ...
	 * @since 3.1
	 */
//	public static void trimIndentation(String[] lines, IVdmProject project) {
...
//	}
	 ...
	 * @since 3.1
	 */
//	public static void trimIndentation(String[] lines, IVdmProject project, boolean considerFirstLine) {
...
//	}
	 ...
	 * @since 3.1
	 */
//	public static String getIndentString(String line, IVdmProject project) {
...
//	}
	 ...
	 * @since 3.1
	 */
//	public static String changeIndent(String code, int codeIndentLevel, IVdmProject project, String newIndent, String lineDelim) {
...
//	public static String trimIndentation(String source, IVdmProject project, boolean considerFirstLine) {
