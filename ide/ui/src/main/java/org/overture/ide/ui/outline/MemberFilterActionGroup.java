...
//			}
			...
			hideFields.setDescription("Hide fields");
			hideFields.setToolTipText("Hide Fields");
			VdmPluginImages.setLocalImageDescriptors(hideFields, "fields_co.gif"); //$NON-NLS-1$
		...
		if (isSet(filterProperty, availableFilters)) {
			...
			hideStatic.setDescription("Hide static");
			hideStatic.setToolTipText("Hide Static Fields and Methods");
			VdmPluginImages.setLocalImageDescriptors(hideStatic, "static_co.gif"); //$NON-NLS-1$
		...
		if (isSet(filterProperty, availableFilters)) {
			...
			hideNonPublic.setDescription("Hide Non-Public Members");
			hideNonPublic.setToolTipText("Hide Non-Public Members");
			VdmPluginImages.setLocalImageDescriptors(hideNonPublic, "public_co.gif"); //$NON-NLS-1$
		...
		if (isSet(filterProperty, availableFilters)) {
			...
			hideLocalTypes.setDescription("Hide Local Types");
			hideLocalTypes.setToolTipText("Hide Local Types");
			VdmPluginImages.setLocalImageDescriptors(hideLocalTypes, "localtypes_co.gif"); //$NON-NLS-1$
