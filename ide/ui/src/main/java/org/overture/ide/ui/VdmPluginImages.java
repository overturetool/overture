...
public class VdmPluginImages
{
	...
	private static final String NAME_PREFIX = "org.overture.ide.ui."; //$NON-NLS-1$
	...
	public static final String IMG_TYPE_PUBLIC = NAME_PREFIX
			+ "type_public_obj.gif"; //$NON-NLS-1$
	public static final String IMG_TYPE_PROTECTED = NAME_PREFIX
			+ "type_protected_obj.gif"; //$NON-NLS-1$
	public static final String IMG_TYPE_PRIVATE = NAME_PREFIX
			+ "type_private_obj.gif"; //$NON-NLS-1$
	public static final String IMG_TYPE_DEFAULT = NAME_PREFIX
			+ "type_default_obj.gif"; //$NON-NLS-1$

	public static final String IMG_TRACE_DEFAULT = NAME_PREFIX
			+ "trace_default_obj.gif"; //$NON-NLS-1$
	//
	...
	public static final String IMG_OBJS_SYSTEM = NAME_PREFIX + "system_obj.gif"; //$NON-NLS-1$
	public static final String IMG_OBJS_MODULE = NAME_PREFIX + "module_obj.gif"; //$NON-NLS-1$
	//	
	public static final String IMG_OBJS_VDM_LIBRARY = NAME_PREFIX
			+ "vdm_library_obj.gif"; //$NON-NLS-1$
	...
	// public static final ImageDescriptor DESC_OBJS_EMPTY_LOGICAL_PACKAGE= createManagedFromKey(T_OBJ,
	// IMG_OBJS_EMPTY_LOGICAL_PACKAGE);
	// public static final ImageDescriptor DESC_OBJS_LOGICAL_PACKAGE= createManagedFromKey(T_OBJ,
	// IMG_OBJS_LOGICAL_PACKAGE);
	// public static final ImageDescriptor DESC_OBJS_EMPTY_PACKAGE_RESOURCES= createManagedFromKey(T_OBJ,
	...
	// public static final ImageDescriptor DESC_OBJS_PROJECT_SETTINGS= createManagedFromKey(T_OBJ,
	...
	//	
	//
	// public static final ImageDescriptor DESC_OBJS_INNER_CLASS_PUBLIC= createManagedFromKey(T_OBJ,
	// IMG_OBJS_INNER_CLASS_PUBLIC);
	// public static final ImageDescriptor DESC_OBJS_INNER_CLASS_DEFAULT= createManagedFromKey(T_OBJ,
	// IMG_OBJS_INNER_CLASS_DEFAULT);
	// public static final ImageDescriptor DESC_OBJS_INNER_CLASS_PROTECTED= createManagedFromKey(T_OBJ,
	// IMG_OBJS_INNER_CLASS_PROTECTED);
	// public static final ImageDescriptor DESC_OBJS_INNER_CLASS_PRIVATE= createManagedFromKey(T_OBJ,
	...
	// public static final ImageDescriptor DESC_OBJS_INTERFACE_DEFAULT= createManagedFromKey(T_OBJ,
	// IMG_OBJS_INTERFACE_DEFAULT);
	//
	// public static final ImageDescriptor DESC_OBJS_INNER_INTERFACE_PUBLIC= createManagedFromKey(T_OBJ,
	// IMG_OBJS_INNER_INTERFACE_PUBLIC);
	// public static final ImageDescriptor DESC_OBJS_INNER_INTERFACE_DEFAULT= createManagedFromKey(T_OBJ,
	// IMG_OBJS_INNER_INTERFACE_DEFAULT);
	// public static final ImageDescriptor DESC_OBJS_INNER_INTERFACE_PROTECTED= createManagedFromKey(T_OBJ,
	// IMG_OBJS_INNER_INTERFACE_PROTECTED);
	// public static final ImageDescriptor DESC_OBJS_INNER_INTERFACE_PRIVATE= createManagedFromKey(T_OBJ,
	...
	// public static final ImageDescriptor DESC_OBJS_ANNOTATION_DEFAULT= createManagedFromKey(T_OBJ,
	// IMG_OBJS_ANNOTATION_DEFAULT);
	// public static final ImageDescriptor DESC_OBJS_ANNOTATION_PROTECTED= createManagedFromKey(T_OBJ,
	// IMG_OBJS_ANNOTATION_PROTECTED);
	// public static final ImageDescriptor DESC_OBJS_ANNOTATION_PRIVATE= createManagedFromKey(T_OBJ,
	// IMG_OBJS_ANNOTATION_PRIVATE);
	// public static final ImageDescriptor DESC_OBJS_ANNOTATION_ALT= createManagedFromKey(T_OBJ,
	...
	// public static final ImageDescriptor DESC_OBJS_ENUM_PROTECTED= createManagedFromKey(T_OBJ,
	...
	// public static final ImageDescriptor DESC_OBJS_BREAKPOINT_INSTALLED= createManagedFromKey(T_OBJ,
	...
	// public static final ImageDescriptor DESC_OBJS_FIXABLE_PROBLEM= createManagedFromKey(T_OBJ,
	...
	//
	// // public static final ImageDescriptor DESC_OBJS_SNIPPET_EVALUATING= createManaged(T_OBJ,
	// IMG_OBJS_SNIPPET_EVALUATING);
	//
	...
	//
	// public static final ImageDescriptor DESC_OBJS_ACCESSRULES_ATTRIB= createManagedFromKey(T_OBJ,
	...
	//
	// public static final ImageDescriptor DESC_OBJS_REFACTORING_FATAL= createManagedFromKey(T_OBJ,
	// IMG_OBJS_REFACTORING_FATAL);
	// public static final ImageDescriptor DESC_OBJS_REFACTORING_ERROR= createManagedFromKey(T_OBJ,
	// IMG_OBJS_REFACTORING_ERROR);
	// public static final ImageDescriptor DESC_OBJS_REFACTORING_WARNING= createManagedFromKey(T_OBJ,
	// IMG_OBJS_REFACTORING_WARNING);
	// public static final ImageDescriptor DESC_OBJS_REFACTORING_INFO= createManagedFromKey(T_OBJ,
	...
	// public static final ImageDescriptor DESC_OBJS_NLS_NEVER_TRANSLATE= createManagedFromKey(T_OBJ,
	...
	//
	// public static final ImageDescriptor DESC_OBJS_SEARCH_READACCESS= createManagedFromKey(T_OBJ,
	// IMG_OBJS_SEARCH_READACCESS);
	// public static final ImageDescriptor DESC_OBJS_SEARCH_WRITEACCESS= createManagedFromKey(T_OBJ,
	// IMG_OBJS_SEARCH_WRITEACCESS);
	// public static final ImageDescriptor DESC_OBJS_SEARCH_OCCURRENCE= createManagedFromKey(T_OBJ,
	// IMG_OBJS_SEARCH_OCCURRENCE);
	//
	// public static final ImageDescriptor DESC_OBJS_LOCAL_VARIABLE= createManagedFromKey(T_OBJ,
	...
	// outline
	//	public static final ImageDescriptor DESC_METHOD_PRIVATE =  createManagedFromKey(T_OBJ, IMG_METHOD_PRIVATE); 					//$NON-NLS-1$
	//
	//	public static final ImageDescriptor DESC_METHOD_PUBLIC = createManagedFromKey(T_OBJ, IMG_METHOD_PUBLIC); 					//$NON-NLS-1$
	//
	//	public static final ImageDescriptor DESC_METHOD_PROTECTED = createManagedFromKey(T_OBJ, IMG_METHOD_PROTECTED); 					//$NON-NLS-1$
	//
	//	public static final ImageDescriptor DESC_METHOD_DEFAULT = createManagedFromKey(T_OBJ, IMG_METHOD_DEFAULT); 	 					//$NON-NLS-1$
	//
	// public static final ImageDescriptor DESC_OBJS_SYSTEM = createManagedFromKey(T_OBJ, IMG_OBJS_SYSTEM);
	//
	// public static final ImageDescriptor DESC_OBJS_CLASS = createManagedFromKey(T_DLCL, IMG_OBJS_CLASS);
	//
	// public static final ImageDescriptor DESC_OBJS_MODULE = createManagedFromKey(T_DLCL, IMG_OBJS_MODULE);
	//
	// public static final ImageDescriptor DESC_TRACE_DEFAULT = createManagedFromKey(T_OBJ, IMG_TRACE_DEFAULT);
	//
	// public static final ImageDescriptor DESC_OBJS_LOCK = createManagedFromKey(T_OBJ, IMG_OBJS_LOCK);
	...
	//
	// //Explorer
	// public static final ImageDescriptor DESC_OBJS_PACKFRAG_ROOT = createManagedFromKey(T_OBJ,
			...
			String key)
	{
		...
		if (fgImageRegistry != null)
		{
			VdmUIPlugin.logErrorMessage("Image registry already defined"); //$NON-NLS-1$
		}
		return result;
	}
