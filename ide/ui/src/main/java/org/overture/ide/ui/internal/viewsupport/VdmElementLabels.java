...
public class VdmElementLabels {
	 ...
	 */
	public final static String CONCAT_STRING= VdmUIMessages.VdmElementLabels_concat_string;
	/**
	 * User-readable string for separating list items (e.g. ", ").
	 */
	public final static String COMMA_STRING= VdmUIMessages.VdmElementLabels_comma_string;
	/**
	 * User-readable string for separating the return type (e.g. " : ").
	 */
	public final static String DECL_STRING= VdmUIMessages.VdmElementLabels_declseparator_string;
	/**
	 * User-readable string for concatenating categories (e.g. " ").
	 * @since 3.5
	 */
	public final static String CATEGORY_SEPARATOR_STRING= VdmUIMessages.VdmElementLabels_category_separator_string;
	/**
	 ...
	 */
	public final static String DEFAULT_PACKAGE= VdmUIMessages.VdmElementLabels_default_package;


	private static final Styler DECORATIONS_STYLE= StyledString.DECORATIONS_STYLER;


	private VdmElementLabels() {
	}
...
//			return getElementLabel((IVdmElement) obj, flags);
//
...
//		if (obj instanceof IVdmElement) {
//			return getStyledElementLabel((IVdmElement) obj, flags);
//
//		} else if (obj instanceof IResource) {
...
//	}
	...
	public static StyledString getStyledTextLabel(Object element, long l) {
...
//	}
	 ...
	 */
//	public static String getElementLabel(IVdmElement element, long flags) {
//		StringBuffer result= new StringBuffer();
//		getElementLabel(element, flags, result);
//		return Strings.markLTR(result.toString(), VdmElementLabelComposer.ADDITIONAL_DELIMITERS);
//	}
	 ...
	 * @since 3.4
	 */
//	public static StyledString getStyledElementLabel(IVdmElement element, long flags) {
//		StyledString result= new StyledString();
//		getElementLabel(element, flags, result);
//		return Strings.markLTR(result, VdmElementLabelComposer.ADDITIONAL_DELIMITERS);
//	}
	 ...
	 */
//	public static void getElementLabel(IVdmElement element, long flags, StringBuffer buf) {
//		new VdmElementLabelComposer(buf).appendElementLabel(element, flags);
//	}
	 ...
	 * @since 3.4
	 */
//	public static void getElementLabel(IVdmElement element, long flags, StyledString result) {
...
//		new VdmElementLabelComposer(buf).appendMethodLabel(method, flags);
//	}
...
//	 * @since 3.4
//	 */
//	public static StyledString getStyledContainerEntryLabel(IPath containerPath, IVdmProject project) {
//		try {
//			IClasspathContainer container= JavaCore.getClasspathContainer(containerPath, project);
