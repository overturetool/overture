...
import org.overture.ide.core.ISourceRange;
import org.overture.ide.core.ISourceReference;
import org.overture.ide.core.IVdmElement;
import org.overture.ide.core.VdmModelException;
...
public class VdmProblemsLabelDecorator implements ILabelDecorator, ILightweightLabelDecorator {
	...
	public Image decorateImage(Image image, Object obj) {
		...
		if (adornmentFlags != 0) {
			...
			return getRegistry().get(new VdmElementImageDescriptor(baseImage, adornmentFlags, new Point(bounds.width, bounds.height)));
		}
		return image;
	}
...
//						ICompilationUnit cu= (ICompilationUnit) element.getAncestor(IVdmElement.COMPILATION_UNIT);
//						if (cu != null) {
//							ISourceReference ref= (type == IVdmElement.COMPILATION_UNIT) ? null : (ISourceReference) element;
...
//	}
	 ...
	 * @param sourceElement Source element (must be a IVdmElement)
