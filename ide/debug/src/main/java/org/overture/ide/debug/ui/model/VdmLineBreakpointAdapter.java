...
public class VdmLineBreakpointAdapter implements IToggleBreakpointsTarget
{
			...
			throws CoreException
	{
		...
		if (textEditor != null)
		{
			...
			VdmLineBreakpoint lineBreakpoint = new VdmLineBreakpoint(resource,
					lineNumber + 1);
	...
	/**
	 * Returns the editor being used to edit a PDA file, associated with the given part, or <code>null</code>
	 * if none.
	 * 
	 * @param part
	 *            workbench part
	 * @return the editor being used to edit a PDA file, associated with the given part, or <code>null</code>
	 *         if none
	 */
