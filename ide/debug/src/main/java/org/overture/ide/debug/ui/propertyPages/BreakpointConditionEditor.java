...
public class BreakpointConditionEditor {
	 ...
	 */
	public BreakpointConditionEditor(Composite parent, VdmLineBreakpointPropertyPage page) {
		fPage = page;
		...
		try {
			...
			fViewer = new VdmSourceViewer(parent, null, null, false, SWT.BORDER | SWT.V_SCROLL | SWT.H_SCROLL | SWT.LEFT_TO_RIGHT);
