...
public class VdmjSlInstallType extends AbstractInterpreterInstallType {
	...
	protected IInterpreterInstall doCreateInterpreterInstall(String id) {
		...
		return new VdmjVdmSlInterpreterInstall(this,id);			
	}
	...
	protected ILog getLog() {
		return DebugSlPlugin.getDefault().getLog();
	}
	...
	protected String getPluginId() {
		return VdmSlDebugConstants.VDMSL_DEBUG_PLUGIN_ID;
	}

	@Override
	protected String[] getPossibleInterpreterNames() {
		return new String[] {VdmSlDebugConstants.VDMSL_VDMJ_InterpreterType}; //TODO more than one VDMJ interpreter (like version 0.1, 0.2)????? 
	...
	public String getName() {
		return VdmSlDebugConstants.VDMSL_VDMJ_InterpreterName;
	}
