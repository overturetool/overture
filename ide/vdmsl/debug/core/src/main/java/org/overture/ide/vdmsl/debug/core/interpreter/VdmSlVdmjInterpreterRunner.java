...
public class VdmSlVdmjInterpreterRunner extends AbstractInterpreterRunner {
	...
	public VdmSlVdmjInterpreterRunner(IInterpreterInstall install) {
		super(install);
	}
...
//							}
							...
							try {
								...
								RootNode rootNode = astManager.getRootNode(proj.getProject(), VdmSlProjectNature.VDM_SL_NATURE);
								...
								else
								{
									...
									throw new CoreException(new Status(IStatus.ERROR, VdmSlDebugConstants.VDMSL_DEBUG_PLUGIN_ID, "The project is not type checked"));
								}
							} catch (Exception e) {
								return;
