...
public class VdmSlCodeScanner extends AbstractScriptScanner implements IScriptColorTokenLocator
{
	...
	static
	{
		...
		providers.add(new VdmKeywordRules(new VdmSlKeywords()));
	}



	public VdmSlCodeScanner(IColorManager manager, IPreferenceStore store)
	{
		super(manager, store);
		initialize();
	}
