 ...
 * of a tree of Vdm elements. The changes to the elements are described by
 * the associated delta object carried by this event.
 * <p>
 * This class is not intended to be instantiated or subclassed by clients.
 * Instances of this class are automatically created by the Vdm model.
 * </p>
 *
...
public enum DeltaType{
	 ...
	 * to one or more Vdm element(s) expressed as a hierarchical
	 ...
	 * any VdmModel operation  and/or resource change.
	 *
	 * @see IVdmElementDelta
...
POST_CHANGE (1),
	 ...
	 * information relative to the previous VdmModel operations (in other words,
	 * it ignores the possible resources which have changed outside Vdm operations).
	 * In particular, it is possible that the VdmModel be inconsistent with respect to
	 * resources, which got modified outside VdmModel operations (it will only be
...
private DeltaType(int value){
	 ...
	 *
	 * @param delta the Vdm element delta.
