...
public class JmlExpressionsList extends JmlPrimarySuffix implements IJmlExpressionsList {
...
// ***** VDMTOOLS START Name=JmlExpressionsList KEEP=NO
  public JmlExpressionsList () throws CGException {
    try {
      ivList = new Vector();
    }
    catch (Exception e){
...
// ***** VDMTOOLS END Name=JmlExpressionsList


// ***** VDMTOOLS START Name=identity KEEP=NO
  public String identity () throws CGException {
    return new String("ExpressionsList");
  }
...
// ***** VDMTOOLS START Name=accept KEEP=NO
  public void accept (final IJmlVisitor pVisitor) throws CGException {
    pVisitor.visitExpressionsList((IJmlExpressionsList) this);
  }
// ***** VDMTOOLS END Name=accept


// ***** VDMTOOLS START Name=JmlExpressionsList KEEP=NO
  public JmlExpressionsList (final Vector p1) throws CGException {
...
// ***** VDMTOOLS START Name=JmlExpressionsList KEEP=NO
  public JmlExpressionsList (final Vector p1, final Long line, final Long column) throws CGException {
...
// ***** VDMTOOLS END Name=addList
  ...
  public String toString() {
	  ...
	  for(i = 0; i < this.ivList.size(); i++) {
		...
		str += ((JmlExpression) this.ivList.get(i)).toString() + ";\n"; 
	  }
