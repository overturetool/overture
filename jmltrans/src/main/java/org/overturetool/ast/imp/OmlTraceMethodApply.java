  ...
  public String toString() {
	  ...
	  if (size > 0) {
		  ...
		  for(i=0; i<size-1; i++) {
			  ...
			  lst += this.ivArgs.get(i).toString() + ", ";
		  }
		  
		  lst += this.ivArgs.get(size-1).toString();
	  }
	  
	  if(this.ivMethodName.length() == 0 || this.ivVariableName.length() == 0) {
		  return "";
	  }
	  else
		  return this.ivVariableName + "." + this.ivMethodName + "(" + lst + ")";
  }
}
;
