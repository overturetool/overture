...
public class OvertureConsolePreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		IPreferenceStore store = OvertureDebugUIPlugin.getDefault().getPreferenceStore();
		store.setDefault(OvertureConsoleConstants.PREF_NEW_PROMPT, OvertureConsoleConstants.DEFAULT_NEW_PROMPT);
		store.setDefault(OvertureConsoleConstants.PREF_CONTINUE_PROMPT, OvertureConsoleConstants.DEFAULT_CONTINUE_PROMPT);
	}
