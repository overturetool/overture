 ...
 * @see IWordDetector
 */
public class OvertureWordRule implements IRule {
     ...
     */
    public OvertureWordRule(IWordDetector detector, IToken defaultToken, IToken classNameToken, IToken funcNameToken) {
