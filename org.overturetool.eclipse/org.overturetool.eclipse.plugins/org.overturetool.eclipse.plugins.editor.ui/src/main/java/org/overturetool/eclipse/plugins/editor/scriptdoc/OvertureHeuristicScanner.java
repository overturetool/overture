 ...
 * @since 3.0
 */
public final class OvertureHeuristicScanner implements Symbols {
	/**
	...
	private static class NonWhitespace extends
			OvertureHeuristicScanner.StopCondition {
		/*
	 ...
	 * 
	 * @see OvertureHeuristicScanner.NonWhitespace
	 */
	private final class NonWhitespaceDefaultPartition extends
			OvertureHeuristicScanner.NonWhitespace {
		/*
		 * @see org.eclipse.jdt.internal.ui.text.JavaHeuristicScanner.StopCondition#stop(char)
		 */
		public boolean stop(char ch, int position, boolean forward) {
	 ...
	 * 
	 * @see OvertureHeuristicScanner.NonJavaIdentifierPart
	 */
	private final class NonJavaIdentifierPartDefaultPartition extends
			OvertureHeuristicScanner.NonJavaIdentifierPart {
		/*
		 * @see org.eclipse.jdt.internal.ui.text.JavaHeuristicScanner.StopCondition#stop(char)
		 */
		public boolean stop(char ch, int position, boolean forward) {
	...
	private final OvertureHeuristicScanner.StopCondition fNonWSDefaultPart = new NonWhitespaceDefaultPartition();
	private final static OvertureHeuristicScanner.StopCondition fNonWS = new NonWhitespace();
	private final OvertureHeuristicScanner.StopCondition fNonIdent = new NonJavaIdentifierPartDefaultPartition();
	 ...
	 *            the partition to scan in
	 */
	public OvertureHeuristicScanner(IDocument document, String partitioning,
			String partition) {
	 ...
	 *            the document to scan.
	 */
	public OvertureHeuristicScanner(IDocument document) {
		this(document, IOverturePartitions.OVERTURE_PARTITIONING,
	...
	public int scanForward(int start, int bound,
			OvertureHeuristicScanner.StopCondition condition) {
		Assert.isLegal(start >= 0);
