...
public class OvertureOutlineInformationControl extends ScriptOutlineInformationControl {
	
	
	public OvertureOutlineInformationControl(Shell parent, int shellStyle, int treeStyle, String commandId) {
