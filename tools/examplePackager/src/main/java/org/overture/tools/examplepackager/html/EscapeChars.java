 ...
 * <P>
 * To keep you safe by default, WEB4J goes to some effort to escape characters in your data when appropriate, such that
 * you <em>usually</em> don't need to think too much about escaping special characters. Thus, you shouldn't need to
...
public final class EscapeChars
{
  ...
  must be escaped.</em>
	...
	/**
	 * Escapes characters for text appearing as data in the <a href='http://www.json.org/'>Javascript Object
	 * Notation</a> (JSON) data interchange format.
	 * <P>
	 ...
	 * </table>
	 * <P>
	 * See <a href='http://www.ietf.org/rfc/rfc4627.txt'>RFC 4627</a> for more information.
	 */
