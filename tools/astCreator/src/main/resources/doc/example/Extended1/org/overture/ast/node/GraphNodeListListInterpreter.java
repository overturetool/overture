...
public class GraphNodeListListInterpreter<E extends INodeInterpreter> extends NodeListListInterpreter<E> {
	...
	public GraphNodeListListInterpreter(INodeInterpreter parent) {
		super(null);
	}
	
	public GraphNodeListListInterpreter(INodeInterpreter parent, Collection<List<E>> c) {
		this(parent);
		addAll(c);
	}
	}
