...
public class NodeListListInterpreter<E extends INodeInterpreter> extends LinkedList<List<E>> {
	INodeInterpreter parent;
	
	protected void setParentOfInnterList(List<? extends E> list, INodeInterpreter parent)
	{
		for (E e : list)
		{
			e.parent(parent);
	...
	public NodeListListInterpreter(INodeInterpreter parent) {
		super();
		this.parent = parent;
	}
	
	public NodeListListInterpreter(INodeInterpreter parent, Collection<List<E>> c) {
		this(parent);
		addAll(c);
	}
	...
	public @Override boolean remove(Object o) {
		if (super.remove(o)) {
			((INodeInterpreter)o).parent(null);
			return true;
		}
		return false;
	}
	...
	public @Override Object clone() {
		...
		{
			NodeListInterpreter<E> ll = new NodeListInterpreter<E>(null);
			for (E e : list) {
				ll.add((E) e.clone());
			}
			clone.add(ll);
