...
public class NodeListInterpreter<E extends INodeInterpreter> extends LinkedList<E> {
	INodeInterpreter parent;
	
	protected void setParent(INodeInterpreter n) {
	...
	public NodeListInterpreter(INodeInterpreter parent) {
		super();
		this.parent = parent;
	}
	
	public NodeListInterpreter(INodeInterpreter parent, Collection<? extends E> c) {
		this(parent);
		addAll(c);
	}
