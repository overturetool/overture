...
*
*/
public class AE4ExpInterpreter extends AE4Exp implements PExpInterpreter
{
...
//	protected AE2ExpInterpreter _field2;
	...
	* @param field1_ the {@link AE1ExpInterpreter} node for the {@code field1} child of this {@link AE4ExpInterpreter} node
	* @param parent_ the {@link INodeInterpreter} node for the {@code parent} child of this {@link AE4ExpInterpreter} node
	*/
	public AE4ExpInterpreter(AE1ExpInterpreter field2_)
	{
		super(null);
	...
	/**
	 * Creates a new {@link AE4ExpInterpreter} node with no children.
	 */
	public AE4ExpInterpreter()
	{
	...
	/**
	 * Creates a deep clone of this {@link AE4ExpInterpreter} node while putting all
	 * old node-new node relations in the map {@code oldToNewMap}.
	 * @param oldToNewMap the map filled with the old node-new node relation
	 * @return a deep clone of this {@link AE4ExpInterpreter} node
	 */
	public AE4ExpInterpreter clone(Map<INode,INode> oldToNewMap)
	{
		AE4ExpInterpreter node = new AE4ExpInterpreter(
			cloneNode((AE1ExpInterpreter)_field2, oldToNewMap)
		);
	...
	**/
	...
	{
		if (o != null && o instanceof AE4ExpInterpreter)		{
	...
	/**
	 * Returns a deep clone of this {@link AE4ExpInterpreter} node.
	 * @return a deep clone of this {@link AE4ExpInterpreter} node
	 */
	public AE4ExpInterpreter clone()
	{
		return new AE4ExpInterpreter(
			cloneNode((AE1ExpInterpreter)_field2)
		);
	}


	/**
	 * Removes the {@link INodeInterpreter} {@code child} as a child of this {@link AE4ExpInterpreter} node.
	 * Do not call this method with any graph fields of this node. This will cause any child's
	 * with the same reference to be removed unintentionally or {@link RuntimeException}will be thrown.
	 * @param child the child node to be removed from this {@link AE4ExpInterpreter} node
	 * @throws RuntimeException if {@code child} is not a child of this {@link AE4ExpInterpreter} node
	 */
	...
	/**
	 * Sets the {@code _field1} child of this {@link AE4ExpInterpreter} node.
	 * @param value the new {@code _field1} child of this {@link AE4ExpInterpreter} node
	*/
	public void setField2(AE1ExpInterpreter value)
	{
	...
	/**
	 * @return the {@link AE1ExpInterpreter} node which is the {@code _field1} child of this {@link AE4ExpInterpreter} node
	*/
	public AE1Exp getField2()
	{
		return (AE1Exp)_field2;
	}


	/**
	* Calls the {@link IAnalysisInterpreter#caseAE3ExpInterpreter(AE4ExpInterpreter)} of the {@link IAnalysisInterpreter} {@code analysis}.
	* @param analysis the {@link IAnalysisInterpreter} to which this {@link AE4ExpInterpreter} node is applied
	*/
	@Override
	public void apply(IAnalysisInterpreter analysis)
	{
		analysis.caseAE4ExpInterpreter(this);
	}


	/**
	* Calls the {@link IAnswerInterpreter#caseAE3ExpInterpreter(AE4ExpInterpreter)} of the {@link IAnswerInterpreter} {@code caller}.
	* @param caller the {@link IAnswerInterpreter} to which this {@link AE4ExpInterpreter} node is applied
	*/
	@Override
	public <A> A apply(IAnswerInterpreter<A> caller)
	{
		return caller.caseAE4ExpInterpreter(this);
	}


	/**
	* Calls the {@link IQuestionInterpreter#caseAE3ExpInterpreter(AE4ExpInterpreter, Object)} of the {@link IQuestionInterpreter} {@code caller}.
	* @param caller the {@link IQuestionInterpreter} to which this {@link AE4ExpInterpreter} node is applied
	* @param question the question provided to {@code caller}
	*/
	@Override
	public <Q> void apply(IQuestionInterpreter<Q> caller, Q question)
	{
		caller.caseAE4ExpInterpreter(this, question);
	}


	/**
	* Calls the {@link IQuestionAnswerInterpreter#caseAE3ExpInterpreter(AE4ExpInterpreter, Object)} of the {@link IQuestionAnswerInterpreter} {@code caller}.
	* @param caller the {@link IQuestionAnswerInterpreter} to which this {@link AE4ExpInterpreter} node is applied
	* @param question the question provided to {@code caller}
	*/
	@Override
	public <Q, A> A apply(IQuestionAnswerInterpreter<Q, A> caller, Q question)
	{
		return caller.caseAE4ExpInterpreter(this, question);
	}
