...
import org.overture.ast.expressions.PExpBaseInterpreter;
...
*
*/
public class AE2ExpInterpreter extends PExpBaseInterpreter
{
	...
	**/
	 ...
	 */
	public AE2ExpInterpreter clone(Map<INode,INode> oldToNewMap)
	{
		AE2ExpInterpreter node = new AE2ExpInterpreter(
		);
	 ...
	 * @return a deep clone of this {@link AE2ExpInterpreter} node
	 */
	public AE2ExpInterpreter clone()
	{
		return new AE2ExpInterpreter(
		);
	}
	...
	/**
	* Calls the {@link IAnalysisInterpreter#caseAE2ExpInterpreter(AE2ExpInterpreter)} of the {@link IAnalysisInterpreter} {@code analysis}.
	* @param analysis the {@link IAnalysisInterpreter} to which this {@link AE2ExpInterpreter} node is applied
	*/
	@Override
	public void apply(IAnalysisInterpreter analysis)
	{
		analysis.caseAE2ExpInterpreter(this);
	}


	/**
	* Calls the {@link IAnswerInterpreter#caseAE2ExpInterpreter(AE2ExpInterpreter)} of the {@link IAnswerInterpreter} {@code caller}.
	* @param caller the {@link IAnswerInterpreter} to which this {@link AE2ExpInterpreter} node is applied
	*/
	@Override
	public <A> A apply(IAnswerInterpreter<A> caller)
	{
		return caller.caseAE2ExpInterpreter(this);
	}


	/**
	* Calls the {@link IQuestionInterpreter#caseAE2ExpInterpreter(AE2ExpInterpreter, Object)} of the {@link IQuestionInterpreter} {@code caller}.
	* @param caller the {@link IQuestionInterpreter} to which this {@link AE2ExpInterpreter} node is applied
	* @param question the question provided to {@code caller}
	*/
	@Override
	public <Q> void apply(IQuestionInterpreter<Q> caller, Q question)
	{
		caller.caseAE2ExpInterpreter(this, question);
	}


	/**
	* Calls the {@link IQuestionAnswerInterpreter#caseAE2ExpInterpreter(AE2ExpInterpreter, Object)} of the {@link IQuestionAnswerInterpreter} {@code caller}.
	* @param caller the {@link IQuestionAnswerInterpreter} to which this {@link AE2ExpInterpreter} node is applied
	* @param question the question provided to {@code caller}
	*/
	@Override
	public <Q, A> A apply(IQuestionAnswerInterpreter<Q, A> caller, Q question)
	{
		return caller.caseAE2ExpInterpreter(this, question);
	}
