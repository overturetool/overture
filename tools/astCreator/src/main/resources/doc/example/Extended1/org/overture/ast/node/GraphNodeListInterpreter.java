...
public class GraphNodeListInterpreter<E extends INodeInterpreter> extends NodeListInterpreter<E> {
	...
	public GraphNodeListInterpreter(INodeInterpreter parent) {
		super(null);
	}
	
	public GraphNodeListInterpreter(INodeInterpreter parent, Collection<? extends E> c) {
		this(null);
		addAll(c);
	}
