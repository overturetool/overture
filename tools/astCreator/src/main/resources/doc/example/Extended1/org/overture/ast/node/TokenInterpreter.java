...
public abstract class TokenInterpreter extends NodeInterpreter implements ITokenInterpreter,IToken {
...
//	public abstract TokenEnum kindToken();
	 ...
	 */
	@Override public NodeEnumInterpreter kindNodeInterpreter() {
		return NodeEnumInterpreter.TOKEN;
	}
...
//	}
	...
	/**
	 * Implements the {@link INodeInterpreter#removeChild(INodeInterpreter)} method. Since tokens have no
	 ...
	 */
	public @Override void removeChild(INodeInterpreter child) {
