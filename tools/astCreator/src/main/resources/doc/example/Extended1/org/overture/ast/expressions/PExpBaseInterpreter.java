...
*
*/
public abstract class PExpBaseInterpreter extends NodeInterpreter implements PExpInterpreter
{
	...
	**/
	...
	{
		if (o != null && o instanceof PExpBaseInterpreter)		{
