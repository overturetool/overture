...
public class BaseEnvironment
  {
    public static final IInterfaceDefinition   voidDef         = new PredefinedClassDefinition(
                                                                   "", "void",
                                                                   true);
    public static final IInterfaceDefinition   stringDef       = new PredefinedClassDefinition(
                                                                   "",
                                                                   "String",
                                                                   true);
    
    public static final IInterfaceDefinition   serializableDef = new PredefinedClassDefinition(
                                                                   "java.io",
                                                                   "Serializable",
                                                                   true);
    public static final IInterfaceDefinition   listDef         = new PredefinedClassDefinition(
                                                                   "java.util",
                                                                   "List", true);
    
    public static final IInterfaceDefinition   queueDef        = new PredefinedClassDefinition(
                                                                   "java.util",
                                                                   "Queue",
                                                                   true);
    public static final IInterfaceDefinition   setDef          = new PredefinedClassDefinition(
                                                                   "java.util",
                                                                   "Set", true);
    
    public static final IInterfaceDefinition   vectorDef       = new PredefinedClassDefinition(
                                                                   "java.util",
                                                                   "Vector",
                                                                   true);
    public static final IInterfaceDefinition   linkedListDef   = new PredefinedClassDefinition(
                                                                   "java.util",
                                                                   "LinkedList",
                                                                   true);
    public static final IInterfaceDefinition   collectionDef   = new PredefinedClassDefinition(
                                                                   "java.util",
                                                                   "Collection",
                                                                   true);
    ...
    public BaseEnvironment(String name)
      {
        ...
        nodeListList = new PredefinedClassDefinition(defaultPackage,
            "NodeListList");
        graphNodeList = new PredefinedClassDefinition(defaultPackage,
            "GraphNodeList");
        graphNodeListList = new PredefinedClassDefinition(defaultPackage,
            "GraphNodeListList");
        token = new PredefinedClassDefinition(defaultPackage, "Token");
        externalNode = new PredefinedClassDefinition(defaultPackage,
            "ExternalNode");
        // setup env
        addClass(node);
        addClass(nodeList);
