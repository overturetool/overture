...
// ***** VDMTOOLS START Name=getContextInfo KEEP=NO
  public IOmlContextInfo getContextInfo (final Long pci) throws CGException {
    ...
    if (!this.pre_getContextInfo(pci).booleanValue()) 
...
// ***** VDMTOOLS START Name=pre_getContextInfo KEEP=NO
  public Boolean pre_getContextInfo (final Long pci) throws CGException {

    Boolean varRes_2 = null;
    varRes_2 = new Boolean(ivInfo.containsKey(pci));
    return varRes_2;
  }
// ***** VDMTOOLS END Name=pre_getContextInfo
