...
public class OmlScope extends IOmlScope {
...
// ***** VDMTOOLS START Name=vdm_init_OmlScope KEEP=NO
  private void vdm_init_OmlScope () throws CGException {
    try {
      val = null;
    }
    catch (Exception e){
...
// ***** VDMTOOLS END Name=vdm_init_OmlScope
...
// ***** VDMTOOLS START Name=OmlScope#1|Integer KEEP=NO
  public OmlScope (final Integer pv) throws CGException {

    vdm_init_OmlScope();
    setValue(pv);
  }
// ***** VDMTOOLS END Name=OmlScope#1|Integer
