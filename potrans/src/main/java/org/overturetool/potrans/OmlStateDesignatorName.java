...
public class OmlStateDesignatorName extends IOmlStateDesignatorName {
...
// ***** VDMTOOLS START Name=vdm_init_OmlStateDesignatorName KEEP=NO
  private void vdm_init_OmlStateDesignatorName () throws CGException {
    try {
      ivName = null;
    }
    catch (Exception e){
...
// ***** VDMTOOLS START Name=OmlStateDesignatorName#1|IOmlName KEEP=NO
  public OmlStateDesignatorName (final IOmlName p1) throws CGException {

    vdm_init_OmlStateDesignatorName();
    setName((IOmlName) p1);
  }
// ***** VDMTOOLS END Name=OmlStateDesignatorName#1|IOmlName
