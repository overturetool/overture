...
public class OmlSetEnumPattern extends IOmlSetEnumPattern {
...
// ***** VDMTOOLS START Name=vdm_init_OmlSetEnumPattern KEEP=NO
  private void vdm_init_OmlSetEnumPattern () throws CGException {
    try {
...
// ***** VDMTOOLS START Name=OmlSetEnumPattern#1|Vector KEEP=NO
  public OmlSetEnumPattern (final Vector p1) throws CGException {

    vdm_init_OmlSetEnumPattern();
    setPatternList(p1);
  }
// ***** VDMTOOLS END Name=OmlSetEnumPattern#1|Vector
