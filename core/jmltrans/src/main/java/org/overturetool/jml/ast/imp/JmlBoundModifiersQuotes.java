...
public class JmlBoundModifiersQuotes implements IJmlBoundModifiersQuotes {
...
// ***** VDMTOOLS START Name=static KEEP=NO
  static {
    try {
      ...
      JmlBoundModifiersQuotes.qmap = new HashMap();
      JmlBoundModifiersQuotes.qmap.put(IQNULLABLE, new String("nullable"));
      JmlBoundModifiersQuotes.qmap.put(IQNONNULL, new String(" "));
    }
    catch (Throwable e){
...
// ***** VDMTOOLS START Name=JmlBoundModifiersQuotes KEEP=NO
  public JmlBoundModifiersQuotes () throws CGException {}
// ***** VDMTOOLS END Name=JmlBoundModifiersQuotes
