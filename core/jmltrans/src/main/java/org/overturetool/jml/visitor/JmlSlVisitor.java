...
public class JmlSlVisitor extends JmlVisitor {
...
// ***** VDMTOOLS START Name=JmlSlVisitor KEEP=NO
  public JmlSlVisitor () throws CGException {
    try {
...
// ***** VDMTOOLS END Name=JmlSlVisitor
...
// ***** VDMTOOLS START Name=visitDocument KEEP=NO
  public void visitDocument (final IJmlDocument pcmp) throws CGException {
    ...
    Boolean cond_2 = null;
    cond_2 = pcmp.hasSpecifications();
    if (cond_2.booleanValue()) {

      IJmlSpecifications tmpArg_v_4 = null;
      tmpArg_v_4 = (IJmlSpecifications) pcmp.getSpecifications();
      visitSpecifications((IJmlSpecifications) tmpArg_v_4);
    }
  }
...
// ***** VDMTOOLS START Name=visitLexem KEEP=NO
  public void visitLexem (final IJmlLexem pcmp) throws CGException {
    ...
    String str = new String("mk_ JmlLexem(");
...
// ***** VDMTOOLS START Name=visitOperationDefinition KEEP=NO
  public void visitOperationDefinition (final IJmlOperationDefinition pcmp) throws CGException {
    ...
    if (cond_84.booleanValue()) {
      ...
      result = UTIL.ConvertToString(UTIL.clone(new String("nil")));
    String rhs_88 = null;
    rhs_88 = str.concat(result);
    str = UTIL.ConvertToString(UTIL.clone(rhs_88));
    popNL();
    String rhs_92 = null;
    String var1_93 = null;
    var1_93 = str.concat(getNL());
    rhs_92 = var1_93.concat(new String(")"));
    str = UTIL.ConvertToString(UTIL.clone(rhs_92));
    result = UTIL.ConvertToString(UTIL.clone(str));
  }
