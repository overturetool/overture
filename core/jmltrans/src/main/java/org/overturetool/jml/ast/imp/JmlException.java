...
public class JmlException extends JmlNode implements IJmlException {
...
// ***** VDMTOOLS START Name=ivType KEEP=NO
  private IJmlExceptionType ivType = null;
...
// ***** VDMTOOLS START Name=JmlException KEEP=NO
  public JmlException () throws CGException {
    try {
...
// ***** VDMTOOLS END Name=JmlException
...
// ***** VDMTOOLS START Name=accept KEEP=NO
  public void accept (final IJmlVisitor pVisitor) throws CGException {
    pVisitor.visitException((IJmlException) this);
  }
// ***** VDMTOOLS END Name=accept


// ***** VDMTOOLS START Name=JmlException KEEP=NO
  public JmlException (final IJmlExceptionType p1, final String p2) throws CGException {
...
// ***** VDMTOOLS START Name=JmlException KEEP=NO
  public JmlException (final IJmlExceptionType p1, final String p2, final Long line, final Long column) throws CGException {
  ...
  public void init (final HashMap data) throws CGException {

    {
      ...
      if (cond_4.booleanValue()) 
        setType((IJmlExceptionType) data.get(fname));
    }
    {
...
// ***** VDMTOOLS START Name=getType KEEP=NO
  public IJmlExceptionType getType () throws CGException {
    return (IJmlExceptionType) ivType;
  }
// ***** VDMTOOLS END Name=getType


// ***** VDMTOOLS START Name=setType KEEP=NO
  public void setType (final IJmlExceptionType parg) throws CGException {
    ivType = (IJmlExceptionType) UTIL.clone(parg);
  }
