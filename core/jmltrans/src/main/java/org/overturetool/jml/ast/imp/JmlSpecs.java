...
public class JmlSpecs extends JmlNode implements IJmlSpecs {
...
// ***** VDMTOOLS START Name=JmlSpecs KEEP=NO
  public JmlSpecs () throws CGException {
    try {
      ivList = new Vector();
    }
    catch (Exception e){
...
// ***** VDMTOOLS START Name=accept KEEP=NO
  public void accept (final IJmlVisitor pVisitor) throws CGException {
    pVisitor.visitSpecs((IJmlSpecs) this);
  }
// ***** VDMTOOLS END Name=accept


// ***** VDMTOOLS START Name=JmlSpecs KEEP=NO
  public JmlSpecs (final Vector p1) throws CGException {
...
// ***** VDMTOOLS START Name=JmlSpecs KEEP=NO
  public JmlSpecs (final Vector p1, final Long line, final Long column) throws CGException {
...
// ***** VDMTOOLS END Name=addList
  ...
  public String toString() {
	  ...
	  for(i = 0; i < this.ivList.size(); i++) {
		  ...
		  res += this.ivList.get(i).toString() + "\n";
	  }
