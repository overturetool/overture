...
public class JmlScopeQuotes implements IJmlScopeQuotes {
...
// ***** VDMTOOLS START Name=static KEEP=NO
  static {
    try {
      ...
      JmlScopeQuotes.qmap = new HashMap();
      JmlScopeQuotes.qmap.put(IQPROTECTED, new String("protected"));
      JmlScopeQuotes.qmap.put(IQPRIVATE, new String("private"));
      JmlScopeQuotes.qmap.put(IQDEFAULT, new String(""));
      JmlScopeQuotes.qmap.put(IQPUBLIC, new String("public"));
    }
    catch (Throwable e){
...
// ***** VDMTOOLS START Name=JmlScopeQuotes KEEP=NO
  public JmlScopeQuotes () throws CGException {}
// ***** VDMTOOLS END Name=JmlScopeQuotes
