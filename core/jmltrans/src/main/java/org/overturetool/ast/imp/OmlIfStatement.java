...
// ***** VDMTOOLS END Name=setElseStatement
  ...
  public String toString() {
	  int i, size = this.ivElseifStatement.size();
	  String lst = new String();
	  
	  for(i=0; i<size; i++) {
		  lst += this.ivElseifStatement.get(i).toString() + "\n";
	  }
	  return "if " + this.ivExpression.toString() + " \nthen " + this.ivThenStatement.toString() +
	  lst + " \nelse " + this.ivElseStatement.toString(); 
  }
}
;
