...
// ***** VDMTOOLS END Name=setSystemSpec
  ...
  public String toString() {
	  ...
	  //TODO: genericTypes
	  String genericTypes = new String();
	  String inherit = new String();
	  String body = new String();
	  String systemSpec = new String();
	  int i, size = this.ivClassBody.size();
	  
	  try {
		if (hasInheritanceClause()) {
			  inherit = this.ivInheritanceClause.toString();
		  }
	} catch (CGException e) {
	  ...
	  if (this.ivSystemSpec) systemSpec = "dlclass";
	  else systemSpec = "class";
	  
	  return systemSpec + " " + this.ivIdentifier + inherit + "\n\n" + body + "end " + 
	  this.ivIdentifier;
  }
}
;
