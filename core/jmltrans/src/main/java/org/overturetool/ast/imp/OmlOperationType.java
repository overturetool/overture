...
public class OmlOperationType extends OmlType implements IOmlOperationType {
...
// ***** VDMTOOLS START Name=OmlOperationType KEEP=NO
  public OmlOperationType (final IOmlType p1, final IOmlType p2, final Long line, final Long column) throws CGException {
...
// ***** VDMTOOLS END Name=setRngType
  ...
  public String toString() {
	  return this.ivDomType.toString() + " \n\t==> " + this.ivRngType.toString() + "\n";
  }
}
;
