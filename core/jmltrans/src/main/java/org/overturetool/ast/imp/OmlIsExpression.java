...
public class OmlIsExpression extends OmlExpression implements IOmlIsExpression {
...
// ***** VDMTOOLS START Name=OmlIsExpression KEEP=NO
  public OmlIsExpression (final IOmlType p1, final IOmlExpression p2, final Long line, final Long column) throws CGException {
...
// ***** VDMTOOLS END Name=setExpression
  ...
  public String toString() {
	  return "is_" + this.ivType.toString() + "(" + this.ivExpression.toString() + ")"; 
  }
}
;
