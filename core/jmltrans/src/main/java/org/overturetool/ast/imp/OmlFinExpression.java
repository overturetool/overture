...
public class OmlFinExpression extends OmlExpression implements IOmlFinExpression {
...
// ***** VDMTOOLS START Name=OmlFinExpression KEEP=NO
  public OmlFinExpression (final Vector p1, final Long line, final Long column) throws CGException {
