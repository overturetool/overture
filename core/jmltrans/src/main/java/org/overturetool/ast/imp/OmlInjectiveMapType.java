...
public class OmlInjectiveMapType extends OmlType implements IOmlInjectiveMapType {
...
// ***** VDMTOOLS START Name=OmlInjectiveMapType KEEP=NO
  public OmlInjectiveMapType (final IOmlType p1, final IOmlType p2, final Long line, final Long column) throws CGException {
...
// ***** VDMTOOLS END Name=setRngType
  ...
  public String toString() {
	  return "inmap " + this.ivDomType.toString() + " to " + this.ivRngType.toString() + "\n";
  }
}
;
