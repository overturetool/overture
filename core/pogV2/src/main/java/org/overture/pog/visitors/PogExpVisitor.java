...
import org.overture.pogV2.assistants.ACaseAlternativeAssistantPOG;
import org.overture.pogV2.assistants.PDefinitionAssistantPOG;
import org.overture.pogV2.obligations.CasesExhaustiveObligation;
import org.overture.pogV2.obligations.FiniteMapObligation;
import org.overture.pogV2.obligations.FuncComposeObligation;
import org.overture.pogV2.obligations.FunctionApplyObligation;
import org.overture.pogV2.obligations.LetBeExistsObligation;
import org.overture.pogV2.obligations.MapApplyObligation;
import org.overture.pogV2.obligations.MapCompatibleObligation;
import org.overture.pogV2.obligations.MapComposeObligation;
import org.overture.pogV2.obligations.MapIterationObligation;
import org.overture.pogV2.obligations.MapSeqOfCompatibleObligation;
import org.overture.pogV2.obligations.MapSetOfCompatibleObligation;
import org.overture.pogV2.obligations.NonEmptySeqObligation;
import org.overture.pogV2.obligations.NonZeroObligation;
import org.overture.pogV2.obligations.POContextStack;
import org.overture.pogV2.obligations.PODefContext;
import org.overture.pogV2.obligations.POForAllContext;
import org.overture.pogV2.obligations.POForAllPredicateContext;
import org.overture.pogV2.obligations.POImpliesContext;
import org.overture.pogV2.obligations.POLetDefContext;
import org.overture.pogV2.obligations.PONameContext;
import org.overture.pogV2.obligations.PONotImpliesContext;
import org.overture.pogV2.obligations.ProofObligation;
import org.overture.pogV2.obligations.ProofObligationList;
import org.overture.pogV2.obligations.RecursiveObligation;
import org.overture.pogV2.obligations.SeqApplyObligation;
import org.overture.pogV2.obligations.SubTypeObligation;
import org.overture.pogV2.obligations.TupleSelectObligation;
import org.overture.pogV2.obligations.UniqueExistenceObligation;
		...
		QuestionAnswerAdaptor<POContextStack, ProofObligationList>
{
			...
			ADistIntersectUnaryExp node, POContextStack question)
	{
		...
		obligations.add(new org.overture.pogV2.obligations.NonEmptySetObligation(node.getExp(), question));
		return obligations;
	}
			...
			AMapInverseUnaryExp node, POContextStack question)
	{
		...
		{
			obligations.add(new org.overture.pogV2.obligations.InvariantObligation(node, question));
		}
		return obligations;
	}
			...
			POContextStack question)
	{
		...
		{
			obligations.add(new org.overture.pogV2.obligations.SeqModificationObligation(node, question));
		}
			...
			POContextStack question)
	{
		...
		if (PTypeAssistant.isFunction(lType))
		{
			...
			if (preName == null || !preName.equals(""))
			{
				obligations.add(new org.overture.pogV2.obligations.FuncIterationObligation(node, preName, question));
			}
		}
...

	{
		...
		if (finiteTest)
		{
			obligations.add(new org.overture.pogV2.obligations.FiniteSetObligation(node, node.getSetType(), question));
		}
