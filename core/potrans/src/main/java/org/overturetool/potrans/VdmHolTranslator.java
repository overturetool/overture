...
import org.overturetool.potrans.quotes.existential;
import org.overturetool.potrans.quotes.type;
import org.overturetool.potrans.quotes.universal;
...
public class VdmHolTranslator implements EvaluatePP {
...
// ***** VDMTOOLS START Name=uniqueNumber KEEP=NO
  private volatile Integer uniqueNumber = null;
...
// ***** VDMTOOLS START Name=VdmHolTranslatorSentinel KEEP=NO
  class VdmHolTranslatorSentinel extends Sentinel {

    public final int getUniqueID = 0;

    public final int nr_functions = 1;


    public VdmHolTranslatorSentinel () throws CGException {}


    public VdmHolTranslatorSentinel (EvaluatePP instance) throws CGException {
      init(nr_functions, instance);
    }

  }
// ***** VDMTOOLS END Name=VdmHolTranslatorSentinel
;
...
// ***** VDMTOOLS START Name=setSentinel KEEP=NO
  public void setSentinel () {
    try {
      sentinel = new VdmHolTranslatorSentinel(this);
    }
    catch (CGException e) {
...
// ***** VDMTOOLS START Name=getUniqueID KEEP=NO
  private String getUniqueID () throws CGException {
    ...
    sentinel.entering(((VdmHolTranslatorSentinel) sentinel).getUniqueID);
    try {
      ...
      sentinel.leaving(((VdmHolTranslatorSentinel) sentinel).getUniqueID);
    }
  }
...
// ***** VDMTOOLS START Name=translateSimpleTypeDefinition#1|IOmlSimpleType KEEP=NO
  private Vector translateSimpleTypeDefinition (final IOmlSimpleType typeDef) throws CGException {
    ...
    Vector varRes_2 = null;
    {
      ...
      typeId = new HolTypeIdentifier(arg_7);
      {
...
// ***** VDMTOOLS START Name=translateType#1|IOmlType KEEP=NO
  private HolTypeTranslation translateType (final IOmlType type) throws CGException {
    ...
    if (new Boolean(type instanceof IOmlUnionType).booleanValue()) 
      ...
      if (new Boolean(type instanceof IOmlBracketedType).booleanValue()) 
        varRes_2 = translateBracketedType((IOmlBracketedType) type);
      else 
...
// ***** VDMTOOLS START Name=translateBracketedType#1|IOmlBracketedType KEEP=NO
  private HolTypeTranslation translateBracketedType (final IOmlBracketedType type) throws CGException {

    HolTypeTranslation varRes_2 = null;
    {

      HolTypeTranslation val = null;
      IOmlType par_5 = null;
      par_5 = (IOmlType) type.getType();
      val = translateType((IOmlType) par_5);
      HolBracketedType tmpVar_6 = null;
      HolType arg_7 = null;
      arg_7 = (HolType) (val).type;
      tmpVar_6 = new HolBracketedType(arg_7);
      Vector tmpVar_9 = null;
      tmpVar_9 = (val).additionalTypeDefs;
      varRes_2 = new HolTypeTranslation((HolType) tmpVar_6, tmpVar_9);
    }
    return varRes_2;
  }
// ***** VDMTOOLS END Name=translateBracketedType#1|IOmlBracketedType
...
// ***** VDMTOOLS START Name=translateExplicitFunction#1|IOmlExplicitFunction KEEP=NO
  private Vector translateExplicitFunction (final IOmlExplicitFunction fun) throws CGException {
    ...
    if (!this.pre_translateExplicitFunction(fun).booleanValue()) 
      UTIL.RunTime("Run-Time Error:Precondition failure in translateExplicitFunction");
    Vector varRes_2 = null;
    {
...
// ***** VDMTOOLS START Name=pre_translateExplicitFunction#1|IOmlExplicitFunction KEEP=NO
  private Boolean pre_translateExplicitFunction (final IOmlExplicitFunction fun) throws CGException {

    Boolean varRes_2 = null;
    Integer var1_3 = null;
    Vector unArg_4 = null;
    HolTypeTranslation tmpRec_5 = null;
    IOmlType par_6 = null;
    par_6 = (IOmlType) fun.getType();
    tmpRec_5 = translateType((IOmlType) par_6);
    unArg_4 = (tmpRec_5).additionalTypeDefs;
    var1_3 = new Integer(unArg_4.size());
    varRes_2 = new Boolean(var1_3.intValue() == new Integer(0).intValue());
    return varRes_2;
  }
// ***** VDMTOOLS END Name=pre_translateExplicitFunction#1|IOmlExplicitFunction
...
// ***** VDMTOOLS START Name=translateImplicitFunction#1|IOmlImplicitFunction KEEP=NO
  private Vector translateImplicitFunction (final IOmlImplicitFunction fun) throws CGException {
    ...
    if (!this.pre_translateImplicitFunction(fun).booleanValue()) 
      UTIL.RunTime("Run-Time Error:Precondition failure in translateImplicitFunction");
    Vector varRes_2 = null;
    {
...
// ***** VDMTOOLS START Name=pre_translateImplicitFunction#1|IOmlImplicitFunction KEEP=NO
  private Boolean pre_translateImplicitFunction (final IOmlImplicitFunction fun) throws CGException {
    ...
    HolTypeTranslation tmpRec_5 = null;
    IOmlType par_6 = null;
    IOmlIdentifierTypePair obj_7 = null;
    Vector tmp_l_8 = null;
    tmp_l_8 = fun.getIdentifierTypePairList();
    if ((1 <= new Integer(1).intValue()) && (new Integer(1).intValue() <= tmp_l_8.size())) 
      obj_7 = (IOmlIdentifierTypePair) tmp_l_8.get(new Integer(1).intValue() - 1);
    else 
      UTIL.RunTime("Run-Time Error:Illegal index");
    par_6 = (IOmlType) obj_7.getType();
    tmpRec_5 = translateType((IOmlType) par_6);
    unArg_4 = (tmpRec_5).additionalTypeDefs;
    var1_3 = new Integer(unArg_4.size());
    varRes_2 = new Boolean(var1_3.intValue() == new Integer(0).intValue());
...
// ***** VDMTOOLS END Name=pre_translateImplicitFunction#1|IOmlImplicitFunction
...
// ***** VDMTOOLS START Name=translatePatternTypePairList#2|Vector|IOmlType KEEP=NO
  private Tuple translatePatternTypePairList (final Vector ptpl, final IOmlType advancingType) throws CGException {
    ...
    if (!this.pre_translatePatternTypePairList(ptpl, advancingType).booleanValue()) 
      UTIL.RunTime("Run-Time Error:Precondition failure in translatePatternTypePairList");
    Tuple varRes_3 = new Tuple(2);
    {
      ...
      parametersOfThisType = translatePatternListToParameters(par_6);
      {
        ...
        par_11 = (IOmlType) obj_12.getType();
        newType = (IOmlType) generateTimesType((IOmlType) par_11, new Integer(parametersOfThisType.size()), (IOmlType) advancingType);
...
// ***** VDMTOOLS START Name=pre_translatePatternTypePairList#2|Vector|IOmlType KEEP=NO
  private Boolean pre_translatePatternTypePairList (final Vector ptpl, final IOmlType advancingType) throws CGException {
    return new Boolean(!UTIL.equals(ptpl, new Vector()));
  }
// ***** VDMTOOLS END Name=pre_translatePatternTypePairList#2|Vector|IOmlType
...
// ***** VDMTOOLS START Name=generateTimesType#3|IOmlType|Integer|IOmlType KEEP=NO
  private IOmlType generateTimesType (final IOmlType typeToAdd, final Integer times, final IOmlType advancingType) throws CGException {
    ...
    if (!this.pre_generateTimesType(typeToAdd, times, advancingType).booleanValue()) 
      UTIL.RunTime("Run-Time Error:Precondition failure in generateTimesType");
...
// ***** VDMTOOLS START Name=pre_generateTimesType#3|IOmlType|Integer|IOmlType KEEP=NO
  private Boolean pre_generateTimesType (final IOmlType typeToAdd, final Integer times, final IOmlType advancingType) throws CGException {
    return new Boolean((times.intValue()) > (new Integer(0).intValue()));
  }
// ***** VDMTOOLS END Name=pre_generateTimesType#3|IOmlType|Integer|IOmlType
...
// ***** VDMTOOLS START Name=translateCasesAlternatives#3|Vector|HolExpression|HolExpression KEEP=NO
  private HolConditional translateCasesAlternatives (final Vector alts, final HolExpression matchVal, final HolExpression closure) throws CGException {
    ...
    if (!this.pre_translateCasesAlternatives(alts, matchVal, closure).booleanValue()) 
      UTIL.RunTime("Run-Time Error:Precondition failure in translateCasesAlternatives");
...
// ***** VDMTOOLS START Name=pre_translateCasesAlternatives#3|Vector|HolExpression|HolExpression KEEP=NO
  private Boolean pre_translateCasesAlternatives (final Vector alts, final HolExpression matchVal, final HolExpression closure) throws CGException {

    Boolean varRes_4 = null;
    {
      if ((varRes_4 = new Boolean((new Integer(alts.size()).intValue()) > (new Integer(0).intValue()))).booleanValue()) {

        Boolean var2_9 = null;
        if (new Boolean(UTIL.equals(closure, null)).booleanValue()) 
          var2_9 = new Boolean((new Integer(alts.size()).intValue()) > (new Integer(1).intValue()));
        else 
          var2_9 = new Boolean(true);
        varRes_4 = var2_9;
      }
    }
    return varRes_4;
  }
// ***** VDMTOOLS END Name=pre_translateCasesAlternatives#3|Vector|HolExpression|HolExpression
...
// ***** VDMTOOLS START Name=translateUnaryOperator#1|IOmlUnaryOperator KEEP=NO
  private HolIdentifier translateUnaryOperator (final IOmlUnaryOperator vdm_operator) throws CGException {
    ...
    cond_4 = new Boolean(var1_5.intValue() == OmlUnaryOperatorQuotes.IQCARD.intValue());
    if (cond_4.booleanValue()) 
      ...
      cond_44 = new Boolean(var1_45.intValue() == OmlUnaryOperatorQuotes.IQTL.intValue());
      if (cond_44.booleanValue()) 
        ...
        cond_40 = new Boolean(var1_41.intValue() == OmlUnaryOperatorQuotes.IQINDS.intValue());
        if (cond_40.booleanValue()) 
          ...
          cond_36 = new Boolean(var1_37.intValue() == OmlUnaryOperatorQuotes.IQELEMS.intValue());
          if (cond_36.booleanValue()) 
            ...
            cond_32 = new Boolean(var1_33.intValue() == OmlUnaryOperatorQuotes.IQDOM.intValue());
            if (cond_32.booleanValue()) 
              ...
              cond_28 = new Boolean(var1_29.intValue() == OmlUnaryOperatorQuotes.IQHD.intValue());
              if (cond_28.booleanValue()) 
                ...
                cond_24 = new Boolean(var1_25.intValue() == OmlUnaryOperatorQuotes.IQRNG.intValue());
                if (cond_24.booleanValue()) 
                  ...
                  cond_20 = new Boolean(var1_21.intValue() == OmlUnaryOperatorQuotes.IQLEN.intValue());
                  if (cond_20.booleanValue()) 
                    ...
                    cond_16 = new Boolean(var1_17.intValue() == OmlUnaryOperatorQuotes.IQNOT.intValue());
                    if (cond_16.booleanValue()) 
                      ...
                      cond_12 = new Boolean(var1_13.intValue() == new Integer(15).intValue());
                      if (cond_12.booleanValue()) 
                        varRes_2 = new HolNativeIdentifier(new String("~"));
                      else {
...
// ***** VDMTOOLS START Name=translateBinaryOperator#1|IOmlBinaryOperator KEEP=NO
  private HolIdentifier translateBinaryOperator (final IOmlBinaryOperator vdm_operator) throws CGException {
    ...
    Long var1_5 = null;
    var1_5 = vdm_operator.getValue();
    cond_4 = new Boolean(var1_5.intValue() == OmlBinaryOperatorQuotes.IQUNION.intValue());
    if (cond_4.booleanValue()) 
      ...
      Long var1_113 = null;
      var1_113 = vdm_operator.getValue();
      cond_112 = new Boolean(var1_113.intValue() == OmlBinaryOperatorQuotes.IQMINUS.intValue());
      if (cond_112.booleanValue()) 
        varRes_2 = new HolNativeIdentifier(new String("$-"));
      else {

        Boolean cond_108 = null;
        Long var1_109 = null;
        var1_109 = vdm_operator.getValue();
        cond_108 = new Boolean(var1_109.intValue() == OmlBinaryOperatorQuotes.IQPSUBSET.intValue());
        if (cond_108.booleanValue()) 
          varRes_2 = new HolNativeIdentifier(new String("$PSUBSET"));
        else {

          Boolean cond_104 = null;
          Long var1_105 = null;
          var1_105 = vdm_operator.getValue();
          cond_104 = new Boolean(var1_105.intValue() == OmlBinaryOperatorQuotes.IQEQ.intValue());
          if (cond_104.booleanValue()) 
            varRes_2 = new HolNativeIdentifier(new String("$="));
          else {

            Boolean cond_100 = null;
            Long var1_101 = null;
            var1_101 = vdm_operator.getValue();
            cond_100 = new Boolean(var1_101.intValue() == OmlBinaryOperatorQuotes.IQNOTINSET.intValue());
            if (cond_100.booleanValue()) 
              ...
              cond_96 = new Boolean(var1_97.intValue() == OmlBinaryOperatorQuotes.IQLT.intValue());
              if (cond_96.booleanValue()) 
                ...
                cond_92 = new Boolean(var1_93.intValue() == OmlBinaryOperatorQuotes.IQGT.intValue());
                if (cond_92.booleanValue()) 
                  ...
                  cond_88 = new Boolean(var1_89.intValue() == OmlBinaryOperatorQuotes.IQNE.intValue());
                  if (cond_88.booleanValue()) 
                    ...
                    cond_84 = new Boolean(var1_85.intValue() == OmlBinaryOperatorQuotes.IQDIFFERENCE.intValue());
                    if (cond_84.booleanValue()) 
                      ...
                      cond_80 = new Boolean(var1_81.intValue() == OmlBinaryOperatorQuotes.IQINSET.intValue());
                      if (cond_80.booleanValue()) 
                        ...
                        cond_76 = new Boolean(var1_77.intValue() == OmlBinaryOperatorQuotes.IQOR.intValue());
                        if (cond_76.booleanValue()) 
                          ...
                          cond_72 = new Boolean(var1_73.intValue() == OmlBinaryOperatorQuotes.IQGE.intValue());
                          if (cond_72.booleanValue()) 
                            ...
                            cond_68 = new Boolean(var1_69.intValue() == OmlBinaryOperatorQuotes.IQMAPDOMRESBY.intValue());
                            if (cond_68.booleanValue()) 
                              ...
                              cond_64 = new Boolean(var1_65.intValue() == OmlBinaryOperatorQuotes.IQAND.intValue());
                              if (cond_64.booleanValue()) 
                                ...
                                cond_60 = new Boolean(var1_61.intValue() == OmlBinaryOperatorQuotes.IQINTER.intValue());
                                if (cond_60.booleanValue()) 
                                  ...
                                  cond_56 = new Boolean(var1_57.intValue() == OmlBinaryOperatorQuotes.IQMAPRNGRESTO.intValue());
                                  if (cond_56.booleanValue()) 
                                    ...
                                    cond_52 = new Boolean(var1_53.intValue() == OmlBinaryOperatorQuotes.IQLE.intValue());
                                    if (cond_52.booleanValue()) 
                                      ...
                                      cond_48 = new Boolean(var1_49.intValue() == OmlBinaryOperatorQuotes.IQMODIFY.intValue());
                                      if (cond_48.booleanValue()) 
                                        ...
                                        Long var1_45 = null;
                                        var1_45 = vdm_operator.getValue();
                                        cond_44 = new Boolean(var1_45.intValue() == OmlBinaryOperatorQuotes.IQSUBSET.intValue());
                                        if (cond_44.booleanValue()) 
                                          ...
                                          Long var1_41 = null;
                                          var1_41 = vdm_operator.getValue();
                                          cond_40 = new Boolean(var1_41.intValue() == OmlBinaryOperatorQuotes.IQMUNION.intValue());
                                          if (cond_40.booleanValue()) 
                                            ...
                                            Long var1_37 = null;
                                            var1_37 = vdm_operator.getValue();
                                            cond_36 = new Boolean(var1_37.intValue() == OmlBinaryOperatorQuotes.IQPLUS.intValue());
                                            if (cond_36.booleanValue()) 
                                              varRes_2 = new HolNativeIdentifier(new String("$+"));
                                            else {
                                              ...
                                              Long var1_33 = null;
                                              var1_33 = vdm_operator.getValue();
                                              cond_32 = new Boolean(var1_33.intValue() == OmlBinaryOperatorQuotes.IQIMPLY.intValue());
                                              if (cond_32.booleanValue()) 
                                                varRes_2 = new HolNativeIdentifier(new String("$==>"));
                                              else {
                                                ...
                                                Long var1_29 = null;
                                                var1_29 = vdm_operator.getValue();
                                                cond_28 = new Boolean(var1_29.intValue() == OmlBinaryOperatorQuotes.IQCONC.intValue());
                                                if (cond_28.booleanValue()) 
                                                  varRes_2 = new HolNativeIdentifier(new String("$++"));
                                                else {
                                                  ...
                                                  Long var1_25 = null;
                                                  var1_25 = vdm_operator.getValue();
                                                  cond_24 = new Boolean(var1_25.intValue() == OmlBinaryOperatorQuotes.IQCOMP.intValue());
                                                  if (cond_24.booleanValue()) 
                                                    varRes_2 = new HolNativeIdentifier(new String("(\\fun1 fun2. (\\param1. fun1 (fun2 param1)))"));
                                                  else {

                                                    Boolean cond_20 = null;
                                                    Long var1_21 = null;
                                                    var1_21 = vdm_operator.getValue();
                                                    cond_20 = new Boolean(var1_21.intValue() == OmlBinaryOperatorQuotes.IQDIVIDE.intValue());
                                                    if (cond_20.booleanValue()) 
                                                      varRes_2 = new HolNativeIdentifier(new String("$/"));
                                                    else {
                                                      ...
                                                      Long var1_17 = null;
                                                      var1_17 = vdm_operator.getValue();
                                                      cond_16 = new Boolean(var1_17.intValue() == OmlBinaryOperatorQuotes.IQDIV.intValue());
                                                      if (cond_16.booleanValue()) 
                                                        varRes_2 = new HolNativeIdentifier(new String("$DIV"));
                                                      else {

                                                        Boolean cond_12 = null;
                                                        Long var1_13 = null;
                                                        var1_13 = vdm_operator.getValue();
                                                        cond_12 = new Boolean(var1_13.intValue() == OmlBinaryOperatorQuotes.IQMULTIPLY.intValue());
                                                        if (cond_12.booleanValue()) 
                                                          varRes_2 = new HolNativeIdentifier(new String("$*"));
                                                        else {
    ...
    HolSelect varRes_2 = null;
    {
      ...
      bindList = compr.getBindList();
      {
        ...
        SndT = new HolApplication(new HolNativeIdentifier(new String("SND")), arg_41);
        {
          ...
          mapCorrectness = new HolQuantifier(new universal(), arg_62, null, arg_64);
          Vector arg_82 = null;
          arg_82 = new Vector();
...
// ***** VDMTOOLS START Name=translateExists#1|IOmlExistsExpression KEEP=YES
  private HolQuantifier translateExists (final IOmlExistsExpression ex) throws CGException {
    ...
    HolQuantifier varRes_2 = null;
    {
      ...
      varRes_2 = new HolQuantifier(new existential(), ids, null, arg_19);
    }
...
// ***** VDMTOOLS START Name=translateForAll#1|IOmlForAllExpression KEEP=NO
  private HolQuantifier translateForAll (final IOmlForAllExpression fall) throws CGException {
    ...
    HolQuantifier varRes_2 = null;
    {
      ...
      arg_21.add(e_seq_25);
      arg_19 = new HolApplication(new HolNativeIdentifier(new String("$==>")), arg_21);
      varRes_2 = new HolQuantifier(new universal(), ids, null, arg_19);
    }
    return (HolQuantifier) varRes_2;
  }
...
// ***** VDMTOOLS START Name=translatePatternExprPairs#2|Vector|Vector KEEP=NO
  private HolPatternTranslation translatePatternExprPairs (final Vector patterns, final Vector exprs) throws CGException {
    ...
    if (!this.pre_translatePatternExprPairs(patterns, exprs).booleanValue()) 
      UTIL.RunTime("Run-Time Error:Precondition failure in translatePatternExprPairs");
    HolPatternTranslation varRes_3 = null;
    if (new Boolean(UTIL.equals(patterns, new Vector())).booleanValue()) 
      varRes_3 = new HolPatternTranslation(new Vector(), new Vector());
    else {
...
// ***** VDMTOOLS START Name=pre_translatePatternExprPairs#2|Vector|Vector KEEP=NO
  private Boolean pre_translatePatternExprPairs (final Vector patterns, final Vector exprs) throws CGException {
    return new Boolean(new Integer(patterns.size()).intValue() == new Integer(exprs.size()).intValue());
  }
// ***** VDMTOOLS END Name=pre_translatePatternExprPairs#2|Vector|Vector
...
// ***** VDMTOOLS START Name=flattenSetBind#1|IOmlSetBind KEEP=NO
  private Vector flattenSetBind (final IOmlSetBind bind) throws CGException {
    ...
    if (!this.pre_flattenSetBind(bind).booleanValue()) 
      UTIL.RunTime("Run-Time Error:Precondition failure in flattenSetBind");
    Vector varRes_2 = null;
    Boolean cond_4 = null;
    Integer var1_5 = null;
    Vector unArg_6 = null;
...
// ***** VDMTOOLS START Name=pre_flattenSetBind#1|IOmlSetBind KEEP=NO
  private Boolean pre_flattenSetBind (final IOmlSetBind bind) throws CGException {

    Boolean varRes_2 = null;
    Integer var1_3 = null;
    Vector unArg_4 = null;
    unArg_4 = bind.getPattern();
    var1_3 = new Integer(unArg_4.size());
    varRes_2 = new Boolean((var1_3.intValue()) > (new Integer(0).intValue()));
    return varRes_2;
  }
// ***** VDMTOOLS END Name=pre_flattenSetBind#1|IOmlSetBind
...
// ***** VDMTOOLS START Name=flattenTypeBind#1|IOmlTypeBind KEEP=NO
  private Vector flattenTypeBind (final IOmlTypeBind bind) throws CGException {
    ...
    if (!this.pre_flattenTypeBind(bind).booleanValue()) 
      UTIL.RunTime("Run-Time Error:Precondition failure in flattenTypeBind");
    Vector varRes_2 = null;
    Boolean cond_4 = null;
    Integer var1_5 = null;
    Vector unArg_6 = null;
...
// ***** VDMTOOLS START Name=pre_flattenTypeBind#1|IOmlTypeBind KEEP=NO
  private Boolean pre_flattenTypeBind (final IOmlTypeBind bind) throws CGException {
...
// ***** VDMTOOLS END Name=pre_flattenTypeBind#1|IOmlTypeBind
  ...
  private HolBindTranslation translateTypeBind (final IOmlTypeBind bind, final HolIdentifier freeVariable, final HolExpression originalExpression) throws CGException {
    ...
    HolBindTranslation varRes_4 = null;
    {
      ...
      type = (HolType) (tmpRec_10).type;
      {
        ...
        patternMatches = new HolQuantifier(new existential(), arg_23, null, (HolExpression) translatePatternToPredicate((IOmlPattern) pattern, (HolExpression) freeVariable));
  ...
  private HolBindTranslation translateSetBind (final IOmlSetBind bind, final HolIdentifier freeVariable, final HolExpression originalExpression) throws CGException {
    ...
    HolBindTranslation varRes_4 = null;
    {
        ...
        UTIL.RunTime("Run-Time Error:Illegal index");
      {
        ...
        patternMatches = new HolQuantifier(new existential(), arg_19, null, (HolExpression) translatePatternToPredicate((IOmlPattern) pattern, (HolExpression) freeVariable));
        HolLetExpression patternVariableRewriting = null;
        Vector par_29 = null;
        par_29 = new Vector();
        par_29.add(pattern);
