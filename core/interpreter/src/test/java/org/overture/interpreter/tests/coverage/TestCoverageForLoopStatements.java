...
public class TestCoverageForLoopStatements extends BaseTestCase {
    ...
    public void test() throws Exception {
        ...
        Value test = InterpreterUtil.interpret(Dialect.VDM_PP, "new TestFor().Remove([1,2,3,4],4)", new File("src/test/java/org/overture/interpreter/tests/coverage/resources/test_for_loop_statements.vdmpp".replace('/', File.separatorChar)), true);
