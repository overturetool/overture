...
public class InterpreterStringSlTestCase extends InterpreterStringBaseTestCase
{
	...
	public InterpreterStringSlTestCase(File rootSource, String name, String content)
	{
		super(rootSource, name, content);
	}
	
	public InterpreterStringSlTestCase(File file, String suiteName, File testSuiteRoot)
	{
