...
public class Utils
{
	...
	public static String ifToString(PExpInterpreter ifExp, PExpInterpreter thenExp, List<AElseIfExpInterpreter> elseList, PExpInterpreter elseExp)
	{
		StringBuilder sb = new StringBuilder();
		sb.append("(if " + ifExp + "\nthen " + thenExp);
	
		for (AElseIfExpInterpreter s: elseList)
		{
			sb.append("\n");
