...
public class InvariantValue extends ReferenceValue
{
	...
	public final ANamedInvariantTypeInterpreter type;

	public InvariantValue(ANamedInvariantTypeInterpreter type, Value value, Context ctxt)
	...
	// For clone only
	private InvariantValue(ANamedInvariantTypeInterpreter type, Value value)
	{
		super(value);
		this.type = type;
	}
