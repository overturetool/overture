...
public class StatementEvaluatorWithCoverage extends DelegateExpressionEvaluator
{
    CoverageToXML coverage_to_xml;

    public StatementEvaluatorWithCoverage(){
	...
	{
        coverage_to_xml.setContext(ctxt);
        node.apply(coverage_to_xml);
