...
public class NextGenBusMessageEvent implements Serializable, INextGenEvent {
	...
	public String toString() 
	{
		...
		case REQUEST:			
			...
			s.append(" busid: "); s.append(this.message.bus.id);
			s.append(" fromcpu: "); s.append(this.message.fromCpu.id);
			s.append(" tocpu: "); s.append(this.message.toCpu.id);
			s.append(" msgid: "); s.append(this.message.id);
