...
//	}
//	
	public static AFunctionTypeInterpreter getType(AExplicitFunctionDefinitionInterpreter efd, PTypeInterpreterList actualTypes)
	{
		Iterator<PTypeInterpreter> ti = actualTypes.iterator();
		AFunctionTypeInterpreter ftype = (AFunctionTypeInterpreter)efd.getType();
