...
public class NextGenBusMessageReplyRequestEvent extends NextGenBusMessageEvent {
	...
	public String toString() {
		...
		s.append(" busid: "); s.append(this.replyMessage.bus.id);
		s.append(" fromcpu: "); s.append(this.replyMessage.fromCpu.id);
		s.append(" tocpu: "); s.append(this.replyMessage.toCpu.id);
		s.append(" msgid: "); s.append(this.replyMessage.id);
		s.append(" origmsgid: "); s.append(this.message.id);
