...
public class DelegateStatementEvaluatorWithCoverage extends StatementEvaluatorWithCoverage
{
    public DelegateStatementEvaluatorWithCoverage(CoverageToXML ctx){
        this.coverage_to_xml = ctx;
    }
