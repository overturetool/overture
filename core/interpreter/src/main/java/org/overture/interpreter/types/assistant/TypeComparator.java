...
//
//import org.overture.interpreter.ast.types.AUnresolvedTypeInterpreter;
...
//	{
//		public PTypeInterpreter a;
//		public PTypeInterpreter b;
//		public Result result;
//
//		public TypePair(PTypeInterpreter a, PTypeInterpreter b)
//		{
//			this.a = a;
//			this.b = b;
...
//	 */
//
//	public synchronized static boolean compatible(PTypeInterpreter to, PTypeInterpreter from)
//	{
//		done.clear();
//		return searchCompatible(to, from, false) == Result.Yes;
//	}
//
//	public synchronized static boolean compatible(PTypeInterpreter to, PTypeInterpreter from, boolean paramOnly)
//	{
//		done.clear();
...
//	 */
//
//	public synchronized static boolean compatible(List<PTypeInterpreter> to, List<PTypeInterpreter> from)
//	{
//		done.clear();
...
//	 */
//
//	private static Result allCompatible(List<PTypeInterpreter> to, List<PTypeInterpreter> from, boolean paramOnly)
//	{
...
//	 */
//
//	private static Result searchCompatible(PTypeInterpreter to, PTypeInterpreter from, boolean paramOnly)
//	{
...
//	 */
//
//	private static Result test(PTypeInterpreter to, PTypeInterpreter from, boolean paramOnly)
//	{
//		if (to instanceof AUnresolvedTypeInterpreter)
//		{
//			throw new TypeCheckException("Unknown type: " + to, to.getLocation());
//		}
//
//		if (from instanceof AUnresolvedTypeInterpreter)
//		{
...
//
//			for (PTypeInterpreter ta: ua.getTypes())
//			{
...
//
//				for (PTypeInterpreter tb: ub.getTypes())
//				{
...
//				}
//
//				List<PTypeInterpreter> ta = ((AProductType)to).getTypes();
//				List<PTypeInterpreter> tb = ((AProductType)from).getTypes();
...
//	 */
//
//	public synchronized static boolean isSubType(PTypeInterpreter sub, PTypeInterpreter sup)
//	{
//		done.clear();
...
//	 */
//
//	private static Result allSubTypes(List<PTypeInterpreter> sub, List<PTypeInterpreter> sup)
//	{
...
//	 */
//
//	private static Result searchSubType(PTypeInterpreter sub, PTypeInterpreter sup)
//	{
...
//	 */
//
//	private static Result subtest(PTypeInterpreter sub, PTypeInterpreter sup)
//	{
...
//
//			for (PTypeInterpreter suba: subu.getTypes())
//			{
...
//
//				for (PTypeInterpreter supt: supu.getTypes())
//				{
...
//				}
//
//				List<PTypeInterpreter> subl = ((AProductType)sub).getTypes();
//				List<PTypeInterpreter> supl = ((AProductType)sup).getTypes();
//
