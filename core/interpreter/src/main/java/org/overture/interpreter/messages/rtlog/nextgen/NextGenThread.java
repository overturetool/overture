...
public class NextGenThread implements Serializable {
	...
	public NextGenThread(long id, NextGenCpu cpu, NextGenObject object, boolean periodic, ThreadType type) 
	{
		this.id = id;
		this.cpu = cpu;
		this.object = object;
	...
	public String toString() {
		...
		s.append(" cpuid: "); s.append(this.cpu.id);
		s.append(" type: "); s.append(this.type);
