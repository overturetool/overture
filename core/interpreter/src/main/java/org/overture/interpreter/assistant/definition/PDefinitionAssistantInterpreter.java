...
public class PDefinitionAssistantInterpreter extends PDefinitionAssistantTC
{
			...
			Context initialContext)
	{
		...
		// {
		// return AExplicitFunctionDefinitionAssistantInterpreter.getNamedValues((AExplicitFunctionDefinition) def,
		// initialContext);
		// } else if (def instanceof AExplicitOperationDefinition)
		// {
		// return AExplicitOperationDefinitionAssistantInterpreter.getNamedValues((AExplicitOperationDefinition) def,
		// initialContext);
		// } else if (def instanceof AImplicitFunctionDefinition)
		// {
		// return AImplicitFunctionDefinitionAssistantInterpreter.getNamedValues((AImplicitFunctionDefinition) def,
		// initialContext);
		// } else if (def instanceof AImplicitOperationDefinition)
		// {
		// return AImplicitOperationDefinitionAssistantInterpreter.getNamedValues((AImplicitOperationDefinition) def,
		// initialContext);
		...
		// {
		// return AInstanceVariableDefinitionAssistantInterpreter.getNamedValues((AInstanceVariableDefinition) def,
		// initialContext);
	...
	public PExp findExpression(PDefinition def, int lineno)
	{
		...
		// } else if (def instanceof AExplicitFunctionDefinition)
		// {
		// return AExplicitFunctionDefinitionAssistantInterpreter.findExpression((AExplicitFunctionDefinition) def,
		// lineno);
		// } else if (def instanceof AExplicitOperationDefinition)
		// {
		// return AExplicitOperationDefinitionAssistantInterpreter.findExpression((AExplicitOperationDefinition) def,
		// lineno);
		// } else if (def instanceof AImplicitFunctionDefinition)
		// {
		// return AImplicitFunctionDefinitionAssistantInterpreter.findExpression((AImplicitFunctionDefinition) def,
		// lineno);
		// } else if (def instanceof AImplicitOperationDefinition)
		// {
		// return AImplicitOperationDefinitionAssistantInterpreter.findExpression((AImplicitOperationDefinition) def,
		// lineno);
		// } else if (def instanceof AInstanceVariableDefinition)
		// {
		// return AInstanceVariableDefinitionAssistantInterpreter.findExpression((AInstanceVariableDefinition) def,
		// lineno);
	...
	private PStm findStatement(PDefinition def, int lineno)
	{
		...
		// } else if (def instanceof AExplicitOperationDefinition)
		// {
		// return AExplicitOperationDefinitionAssistantInterpreter.findStatement((AExplicitOperationDefinition) def,
		// lineno);
		// } else if (def instanceof AImplicitOperationDefinition)
		// {
		// return AImplicitOperationDefinitionAssistantInterpreter.findStatement((AImplicitOperationDefinition) def,
		// lineno);
		// } else if (def instanceof AThreadDefinition)
		// {
