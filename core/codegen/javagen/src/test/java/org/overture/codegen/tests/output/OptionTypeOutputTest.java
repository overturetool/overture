...
public class OptionTypeOutputTest extends PpSpecificationTest
{
	public static final String ROOT = "src" + File.separatorChar + "test"
			+ File.separatorChar + "resources" + File.separatorChar
			+ "optiontype_specs";

	public OptionTypeOutputTest(String nameParameter, String inputParameter,
	...
	{
		return OutputTestUtil.UPDATE_PROPERTY_PREFIX + "optiontype";
	}
}
