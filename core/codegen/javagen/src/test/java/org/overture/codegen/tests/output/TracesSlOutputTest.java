...
import org.overture.codegen.tests.output.base.Sl2JavaOutputTestBase;
import org.overture.codegen.tests.output.util.OutputTestUtil;
import org.overture.core.tests.PathsProvider;

@RunWith(Parameterized.class)
public class TracesSlOutputTest extends Sl2JavaOutputTestBase
{
	public static final String ROOT = "src" + File.separatorChar + "test"
			+ File.separatorChar + "resources" + File.separatorChar
			+ "traces_sl_specs";

	public TracesSlOutputTest(String nameParameter,
	...
	{
		return OutputTestUtil.UPDATE_PROPERTY_PREFIX + "tracessl";
	}
}
