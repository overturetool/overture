...
abstract public class CodeGenBase implements IREventCoordinator
{
	 ...
	 */
	abstract protected GeneratedData genVdmToTargetLang(
	 ...
	 */
	protected void removeUnreachableStms(List<? extends INode> ast)
			throws AnalysisException
	{
	 ...
	 *            The VDM AST subject to processing.
	 * @throws AnalysisException
	 *             If something goes wrong during the renaming process.
	 */
	protected void handleOldNames(List<? extends INode> vdmAst)
			throws AnalysisException
	{
	 ...
	 *             If something goes wrong during the code generation process.
	 */
	protected Generated genIrExp(IRStatus<SExpIR> expStatus,
