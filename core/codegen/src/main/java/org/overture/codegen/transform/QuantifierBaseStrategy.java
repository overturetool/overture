...
public abstract class QuantifierBaseStrategy extends AbstractIterationStrategy
{
	...
	public QuantifierBaseStrategy(ITransformationConfig config, TransformationAssistantCG transformationAssistant, PExpCG predicate, String resultVarName, ILanguageIterator langIterator)
	{
