...
public class IsaGenParamTest extends ParamStandardTest<CgIsaTestResult> {
    ...
    private static final List<String> skippedTests = Arrays.asList("NoParamPrePost.vdmsl","2ParamsPrePost.vdmsl","NoParamNoPre.vdmsl",
    		...
    		"FuncDeclNoParam.vdmsl","FuncDepSimple.vdmsl","FuncApplyNoParam.vdmsl","FuncPost.vdmsl","FuncApply1Param.vdmsl",
