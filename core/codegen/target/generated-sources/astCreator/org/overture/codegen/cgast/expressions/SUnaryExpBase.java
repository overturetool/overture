...
*
*/
public abstract class SUnaryExpBase extends SExpCGBase implements SUnaryExpCG
{
	...
	* @param exp_ the {@link SExpCG} node for the {@code exp} child of this {@link SUnaryExpBase} node
	*/
	public SUnaryExpBase(SourceNode sourceNode_, Object tag_, STypeCG type_, SExpCG exp_)
	{
	...
	* @param exp_ the {@link SExpCG} node for the {@code exp} child of this {@link SUnaryExpBase} node
	*/
	public SUnaryExpBase(SourceNode sourceNode_, STypeCG type_, SExpCG exp_)
	{
	 ...
	 */
	@Override
	public abstract SUnaryExpCG clone();
	...
	**/
	 ...
	 */
	@Override
	public abstract SUnaryExpCG clone(Map<INode,INode> oldToNewMap);
	...
	*/
	...
	/**
	 * @return the {@link SExpCG} node which is the {@code _exp} child of this {@link SUnaryExpBase} node
	*/
