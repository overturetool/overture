...
*
*/
public abstract class SNumericBinaryBase extends SBinaryExpBase implements SNumericBinaryExpCG
{
	...
	*/
	public SNumericBinaryBase(SourceNode sourceNode_, STypeCG type_, SExpCG left_, SExpCG right_)
	{
	...
	* The basic child nodes are removed from their previous parents.
	*/
	public SNumericBinaryBase(SourceNode sourceNode_, Object tag_, STypeCG type_, SExpCG left_, SExpCG right_)
	{
