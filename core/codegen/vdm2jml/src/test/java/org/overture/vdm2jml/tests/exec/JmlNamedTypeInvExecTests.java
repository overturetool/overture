...
{
	public static final String TEST_DIR = JmlExecTestBase.TEST_RES_DYNAMIC_ANALYSIS_ROOT + "namedtypeinv";

	public static final String PROPERTY_ID = "namedtypeinv";
	
	public JmlNamedTypeInvExecTests(File inputFile)
	{
		super(inputFile);
	}
