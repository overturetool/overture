...
public class NameGenTests
{
	...
	public static final String TEST_FILE = "src" + File.separatorChar
			+ "test" + File.separatorChar + "resources" + File.separatorChar + "NameGenTests.vdmpp";
	...
	public void init()
	{
		...
		Assert.assertTrue("Expected model to type check without errors: " + res, res.parserResult.errors.isEmpty() && res.errors.isEmpty());
