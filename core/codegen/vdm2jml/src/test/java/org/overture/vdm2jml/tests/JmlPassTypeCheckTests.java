...
public class JmlPassTypeCheckTests
{
	private static final String VDMSL_FILE_EXT = ".vdmsl";

	private static final String TEST_RESOURCES = "src" + File.separatorChar
	...
	{
		List<File> files = GeneralUtils.getFiles(new File(TEST_RESOURCES));
	...
	public void tcFiles()
	{
		...
		Assert.assertTrue("Got unexpected file name '" + inputFile.getName() + "'", dotIdx > 0);
