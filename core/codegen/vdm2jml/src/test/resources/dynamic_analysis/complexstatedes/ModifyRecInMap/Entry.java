...
final public class Entry {
  ...
  public static Number useOk() {
    ...
    project.Entrytypes.A a =
        new project.Entrytypes.A(MapUtil.map(new Maplet(1L, new project.Entrytypes.B(2L))));
    //@ assert Utils.is_(a,project.Entrytypes.A.class);

    VDMMap stateDes_1 = a.get_m();

    project.Entrytypes.B stateDes_2 = ((project.Entrytypes.B) Utils.get(stateDes_1, 1L));
  ...
  public static Number useNotOk() {
    ...
    project.Entrytypes.B stateDes_4 = ((project.Entrytypes.B) Utils.get(stateDes_3, 1L));
