...
public class UnreachableStmRemoverTest extends GlobalFileTester {
		ObjectMapper mapper = new ObjectMapper();
		private File inputFile;
		public static final String ROOT_INPUT = "src" + File.separatorChar + "test"
				+ File.separatorChar + "resources" + File.separatorChar + "unreachableStmRemoverInputs";
		public static final String ROOT_RESULT = "src" + File.separatorChar + "test"
				+ File.separatorChar + "resources" + File.separatorChar + "unreachableStmRemoverResults"
				+ File.separatorChar;
					
		public UnreachableStmRemoverTest(File inputFile){
			super();
