...
public class ConvertFunctionToOperationTest extends GlobalFileTester  {

		ObjectMapper mapper = new ObjectMapper();
		private File inputFile;

		public static final String ROOT_INPUT = "src" + File.separatorChar + "test"
				+ File.separatorChar + "resources" + File.separatorChar + "convertFunctionToOperationTestInputs";
		public static final String ROOT_RESULT = "src" + File.separatorChar + "test"
				+ File.separatorChar + "resources" + File.separatorChar + "convertFunctionToOperationTestResults"
				+ File.separatorChar;
					
		public ConvertFunctionToOperationTest(File inputFile){
			super();
