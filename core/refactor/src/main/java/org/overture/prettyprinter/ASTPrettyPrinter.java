...
class ASTPrettyPrinter extends QuestionAnswerAdaptor < IndentTracker, String >
    implements IPrettyPrinter {
        ...
        public ASTPrettyPrinter(IPrettyPrinter root, ISymbolTable nst) {
            rootNpp = root;
            mytable = nst;
        }
        ...
        @Override
        public String caseAExplicitOperationDefinition(AExplicitOperationDefinition node, IndentTracker question)
        	throws AnalysisException {
