...
//
//public class TracesHelper implements ITracesHelper {
...
//
//	/* (non-Javadoc)
//	 * @see org.overturetool.traces.utility.ITaskHelper#GetTraceClasNames()
//	 */
...
//
//	/* (non-Javadoc)
//	 * @see org.overturetool.traces.utility.ITaskHelper#GetTraces(java.lang.String)
//	 */
...
//
//	/* (non-Javadoc)
//	 * @see org.overturetool.traces.utility.ITaskHelper#GetTraceTestCases(java.lang.String, java.lang.String)
//	 */
...
//
//	/* (non-Javadoc)
//	 * @see org.overturetool.traces.utility.ITaskHelper#GetTraceDefinition(java.lang.String, java.lang.String)
//	 */
...
//
//	@SuppressWarnings("unchecked")
//	public List<TestStatus> RunAll() throws CGException {
//
...
//	}
//
//	public List<TestStatus> RunSingle(String className, String traceName, String number) throws CGException {
//
...
//
//	public ITraceTestResult GetResult(String className, String trace, Integer num) throws CGException {
...
//		ArrayList<String> stat = new ArrayList<String>();
//
//		ITraceTestResult testResult = new TestResult();
//		testResult.number = num;
//		testResult.arguments = args;
//		
...
//			stat.add(tmp);
//
//			testResult.results.add(tr.output);
//		}
//		TestResultType status = GetStatus(stat.toArray());
//
...
//		
//		
//		return testResult; //new TestResult(className, trace, num, status, argsString, resString);
//	}
//
//	public ITraceTestStatus GetStatus(String className, String trace, Integer num) throws CGException {
//		Long n = num.longValue();
