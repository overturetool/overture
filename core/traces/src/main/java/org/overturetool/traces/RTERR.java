...
// ***** VDMTOOLS START Name=WarningMsg KEEP=NO
  public static class WarningMsg implements Record {
    ...
    public WarningMsg (Long p1, Long p2, String p3) {
    ...
    public Object clone () {
      return new WarningMsg(line, col, mes);
    }


    public String toString () {
      return "mk_RTERR`WarningMsg(" + UTIL.toString(line) + "," + UTIL.toString(col) + "," + UTIL.toString(mes) + ")";
    }


    public boolean equals (Object obj) {
      if (!(obj instanceof WarningMsg)) 
        return false;
      else {

        WarningMsg temp = (WarningMsg) obj;
        return UTIL.equals(line, temp.line) && UTIL.equals(col, temp.col) && UTIL.equals(mes, temp.mes);
      }
    }
...
// ***** VDMTOOLS START Name=internals KEEP=NO
  private Vector internals = null;
// ***** VDMTOOLS END Name=internals
...
// ***** VDMTOOLS START Name=INTERNAL_uERROR KEEP=NO
  public static final String INTERNAL_uERROR = new String("164: Internal error, please report");
...
// ***** VDMTOOLS START Name=ONLY_uID_uSUPPORTED KEEP=NO
  public static final String ONLY_uID_uSUPPORTED = new String("288: Only value definitions using identifiers are supported");
// ***** VDMTOOLS END Name=ONLY_uID_uSUPPORTED
...
// ***** VDMTOOLS START Name=ReportInternalError#3|Object|String|Boolean KEEP=NO
  public void ReportInternalError (final Object expr, final String errmsg, final Boolean err) throws CGException {
    if (new Boolean(UTIL.equals(expr, null)).booleanValue()) {

      ErrMsg e_23 = null;
      e_23 = new ErrMsg(new Long(1), new Long(1), errmsg);
      internals.add(e_23);
    }
    else {
      ...
      IOmlNode node = (IOmlNode) expr;
      Long tmpVal_9 = null;
      tmpVal_9 = node.getLine();
      Long line = null;
      line = tmpVal_9;
      Long tmpVal_10 = null;
      tmpVal_10 = node.getColumn();
      Long col = null;
      col = tmpVal_10;
      if (err.booleanValue()) {

        ErrMsg e_18 = null;
        e_18 = new ErrMsg(line, col, errmsg);
        internals.add(e_18);
      }
      else {

        WarningMsg e_13 = null;
        e_13 = new WarningMsg(line, col, errmsg);
        internals.add(e_13);
      }
    }
  }
// ***** VDMTOOLS END Name=ReportInternalError#3|Object|String|Boolean
