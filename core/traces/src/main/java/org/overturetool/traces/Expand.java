    ...
    HashMap res_um = new HashMap();
    {
      ...
      for (Iterator enm_20 = sq_3.iterator(); enm_20.hasNext(); ) {
        ...
        ntrace = (OmlNamedTrace) elem_4;
        {
          ...
          name = Util.GetNameOfTrace(par_9);
...
// ***** VDMTOOLS START Name=ExpandTraceBinds#2|Vector|Vector KEEP=NO
  private Vector ExpandTraceBinds (final Vector bind_ul, final Vector cxt_ul) throws CGException {
    ...
    Vector c_ul = cxt_ul;
    {
      ...
      for (Iterator enm_18 = bind_ul.iterator(); enm_18.hasNext(); ) {

        IOmlTraceBinding elem_4 = (IOmlTraceBinding) enm_18.next();
        bind = (IOmlTraceBinding) elem_4;
        {
          ...
          c_ul = (Vector) UTIL.ConvertToList(UTIL.clone(c_ul2));
        }
      }
    }
    return c_ul;
...
// ***** VDMTOOLS START Name=ExtractLetBeSetBinding#3|IOmlSetBind|IOmlExpression|Vector KEEP=NO
  private Vector ExtractLetBeSetBinding (final IOmlSetBind bind, final IOmlExpression best, final Vector cxt_ul) throws CGException {
    ...
    Vector unArg_8 = null;
    {
      ...
      Long i = null;
      for (Iterator enm_93 = bind_l_10.iterator(); enm_93.hasNext(); ) {

        Long e_13 = UTIL.NumberToLong(enm_93.next());
        i = e_13;
        Vector reselem_18 = null;
        {
          ...
          if (cond_27.booleanValue()) {
            ...
            HashSet res_s_31 = new HashSet();
            {
              ...
              Object e_set_55 = null;
              if ((val instanceof Record)) 
                if ((val instanceof SEM.TUPLE)) 
                  e_set_55 = ((SEM.TUPLE) val).v;
                else 
                  if ((val instanceof SEM.TOKEN)) 
                    e_set_55 = ((SEM.TOKEN) val).v;
                  else 
                    if ((val instanceof SEM.QUOTE)) 
                      e_set_55 = UTIL.ConvertToList(((SEM.QUOTE) val).v);
                    else 
                      if ((val instanceof SEM.CHAR)) 
                        e_set_55 = ((SEM.CHAR) val).v;
                      else 
                        if ((val instanceof SEM.BOOL)) 
                          e_set_55 = ((SEM.BOOL) val).v;
                        else 
                          if ((val instanceof SEM.SET)) 
                            e_set_55 = ((SEM.SET) val).v;
                          else 
                            if ((val instanceof SEM.SEQ)) 
                              e_set_55 = ((SEM.SEQ) val).v;
                            else 
                              if ((val instanceof SEM.REC)) 
                                e_set_55 = ((SEM.REC) val).v;
                              else 
                                if ((val instanceof SEM.NUM)) 
                                  e_set_55 = ((SEM.NUM) val).v;
                                else 
                                  e_set_55 = ((SEM.MAP) val).v;
              else 
                UTIL.RunTime("Run-Time Error:A record was expected");
              HashSet e1_set_57 = new HashSet();
              if ((e_set_55 instanceof HashSet)) 
                e1_set_57 = (HashSet) e_set_55;
              else 
              ...
              SEM.VAL v = null;
              {
                for (Iterator enm_59 = e1_set_57.iterator(); enm_59.hasNext(); ) {
                  ...
                  Object elem_58 = enm_59.next();
                  succ_54 = true;
                  if (new Boolean((elem_58 instanceof Record)).booleanValue()) 
                    v = (SEM.VAL) elem_58;
                  else 
                    succ_54 = false;
                  if (succ_54) {
                    ...
                    Vector var1_33 = null;
                    HashMap e_seq_34 = new HashMap();
                    if ((1 <= i.intValue()) && (i.intValue() <= cxt_ul.size())) 
                      e_seq_34 = (HashMap) cxt_ul.get(i.intValue() - 1);
                    else 
                      UTIL.RunTime("Run-Time Error:Illegal index");
                    var1_33 = new Vector();
                    var1_33.add(e_seq_34);
                    Vector var2_37 = null;
                    {

                      Vector res_l_38 = new Vector();
                      HashSet resBind_s_40 = new HashSet();
                      HashSet riseq_44 = new HashSet();
                      int max_45 = p_ul.size();
                      for (int i_46 = 1; i_46 <= max_45; i_46++) 
                        riseq_44.add(new Long(i_46));
                      resBind_s_40 = riseq_44;
                      Vector bind_l_39 = null;
                      bind_l_39 = UTIL.Sort(resBind_s_40);
                      Long i_1 = null;
                      for (Iterator enm_53 = bind_l_39.iterator(); enm_53.hasNext(); ) {

                        Long e_42 = UTIL.NumberToLong(enm_53.next());
                        i_1 = e_42;
                        HashMap reselem_47 = new HashMap();
                        IOmlPattern par_48 = null;
                        if ((1 <= i_1.intValue()) && (i_1.intValue() <= p_ul.size())) 
                          par_48 = (IOmlPattern) p_ul.get(i_1.intValue() - 1);
                        else 
                          UTIL.RunTime("Run-Time Error:Illegal index");
                        reselem_47 = eval.PatternMatch((IOmlPattern) par_48, (SEM.VAL) v);
                        res_l_38.add(reselem_47);
                      }
                      var2_37 = res_l_38;
                    }
                    res_s_32 = (Vector) var1_33.clone();
                    res_s_32.addAll(var2_37);
            ...
            c_ul_ul = new Vector();
          {
            ...
            Vector res_l_61 = new Vector();
            HashSet resBind_s_63 = new HashSet();
            HashSet riseq_67 = new HashSet();
            int max_68 = c_ul_ul.size();
            for (int i_69 = 1; i_69 <= max_68; i_69++) 
              riseq_67.add(new Long(i_69));
            resBind_s_63 = riseq_67;
            Vector bind_l_62 = null;
            bind_l_62 = UTIL.Sort(resBind_s_63);
            Long i2 = null;
            for (Iterator enm_91 = bind_l_62.iterator(); enm_91.hasNext(); ) {

              Long e_65 = UTIL.NumberToLong(enm_91.next());
              i2 = e_65;
              Boolean pred_74 = null;
              {

                HashMap c = new HashMap();
                Vector par_77 = null;
                Vector var1_78 = null;
                HashMap e_seq_79 = new HashMap();
                if ((1 <= i.intValue()) && (i.intValue() <= cxt_ul.size())) 
                  e_seq_79 = (HashMap) cxt_ul.get(i.intValue() - 1);
                else 
                  UTIL.RunTime("Run-Time Error:Illegal index");
                var1_78 = new Vector();
                var1_78.add(e_seq_79);
                Vector var2_82 = null;
                if ((1 <= i2.intValue()) && (i2.intValue() <= c_ul_ul.size())) 
                  var2_82 = (Vector) UTIL.ConvertToList(c_ul_ul.get(i2.intValue() - 1));
                else 
                  UTIL.RunTime("Run-Time Error:Illegal index");
                par_77 = (Vector) var1_78.clone();
                par_77.addAll(var2_82);
                c = (HashMap) eval.MergeContextList(par_77);
                SEM.VAL var1_85 = null;
                var1_85 = (SEM.VAL) eval.evaluateExpression((IOmlExpression) best, c);
                SEM.BOOL var2_88 = null;
                var2_88 = new SEM.BOOL(new Boolean(true));
                pred_74 = new Boolean(UTIL.equals(var1_85, var2_88));
              }
              if (pred_74.booleanValue()) {

                HashMap reselem_70 = new HashMap();
                Vector par_71 = null;
                if ((1 <= i2.intValue()) && (i2.intValue() <= c_ul_ul.size())) 
                  par_71 = (Vector) UTIL.ConvertToList(c_ul_ul.get(i2.intValue() - 1));
                else 
                  UTIL.RunTime("Run-Time Error:Illegal index");
                reselem_70 = (HashMap) eval.MergeContextList(par_71);
                res_l_61.add(reselem_70);
              }
            }
            reselem_18 = res_l_61;
          }
    ...
    Vector rdcseq_94 = new Vector();
    for (Iterator enm_97 = unArg_8.iterator(); enm_97.hasNext(); ) {

      Vector e_95 = (Vector) UTIL.ConvertToList(enm_97.next());
      rdcseq_94.addAll(e_95);
    }
    rexpr_7 = rdcseq_94;
    return rexpr_7;
  }
