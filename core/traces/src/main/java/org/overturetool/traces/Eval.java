  ...
  public SEM.VAL evaluateSeqComprehension (final IOmlSequenceComprehension expr, final HashMap cxt) throws CGException {
    ...
    if (cond_12.booleanValue()) {
      ...
      Vector tmpVar_93 = null;
      {
        ...
        Long i = null;
        for (Iterator enm_130 = bind_l_95.iterator(); enm_130.hasNext(); ) {

          Long e_98 = UTIL.NumberToLong(enm_130.next());
          i = e_98;
          Boolean pred_110 = null;
          {
            if (!(pred_110 = new Boolean(UTIL.equals(pred, null))).booleanValue()) {

              Boolean var2_114 = null;
              {

                HashMap cxt2 = new HashMap();
                HashMap modmap_117 = new HashMap();
                SEM.NUM tmpVar2_121 = null;
                tmpVar2_121 = new SEM.NUM(UTIL.NumberToReal(i));
                modmap_117 = new HashMap();
                modmap_117.put(id, tmpVar2_121);
                cxt2 = new HashMap(cxt);
                cxt2.putAll(modmap_117);
                SEM.VAL p_uval = (SEM.VAL) (SEM.VAL) evaluateExpression((IOmlExpression) pred, cxt2);
                SEM.BOOL var2_127 = null;
                var2_127 = new SEM.BOOL(new Boolean(true));
                var2_114 = new Boolean(UTIL.equals(p_uval, var2_127));
              }
              pred_110 = var2_114;
            }
          }
