...
// ***** VDMTOOLS START Name=CombineContexts#2|Vector|Vector KEEP=NO
  public Vector CombineContexts (final Vector c_ul1, final Vector c_ul2) throws CGException {
    ...
    Vector unArg_5 = null;
    {
      ...
      bind_l_7 = UTIL.Sort(resBind_s_8);
      Long i = null;
      for (Iterator enm_36 = bind_l_7.iterator(); enm_36.hasNext(); ) {

        Long e_10 = UTIL.NumberToLong(enm_36.next());
        i = e_10;
        Vector reselem_15 = null;
        {
          ...
          Long j = null;
          for (Iterator enm_34 = bind_l_17.iterator(); enm_34.hasNext(); ) {

            Long e_20 = UTIL.NumberToLong(enm_34.next());
            j = e_20;
            HashMap reselem_25 = new HashMap();
            HashMap seqmap_28 = new HashMap();
            if ((1 <= j.intValue()) && (j.intValue() <= c_ul1.size())) 
              seqmap_28 = (HashMap) c_ul1.get(j.intValue() - 1);
            else 
              UTIL.RunTime("Run-Time Error:Illegal index");
            HashMap modmap_26 = new HashMap();
            if ((1 <= i.intValue()) && (i.intValue() <= c_ul2.size())) 
              modmap_26 = (HashMap) c_ul2.get(i.intValue() - 1);
            else 
              UTIL.RunTime("Run-Time Error:Illegal index");
            reselem_25 = new HashMap(seqmap_28);
            reselem_25.putAll(modmap_26);
    ...
    for (Iterator enm_40 = unArg_5.iterator(); enm_40.hasNext(); ) {
