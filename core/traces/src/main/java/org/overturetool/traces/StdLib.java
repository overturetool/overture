...
// ***** VDMTOOLS START Name=ToStringInt#1|Long KEEP=NO
  static public String ToStringInt (final Long val) throws CGException {
    ...
    String varRes_2 = null;
    {
      ...
      Long result = new Long((int) (val.doubleValue() - new Long(10).doubleValue() * Math.floor(val.doubleValue() / new Long(10).doubleValue())));
      Long rest = new Long((int) (val.intValue() / new Long(10).intValue()));
      if (new Boolean((rest.intValue()) > (new Long(0).intValue())).booleanValue()) 
        varRes_2 = ToStringInt(rest).concat(GetStringFromNum(result));
      else 
...
// ***** VDMTOOLS START Name=LenToStringInt#1|Long KEEP=NO
  static private Long LenToStringInt (final Long val) throws CGException {
    return val;
  }
// ***** VDMTOOLS END Name=LenToStringInt#1|Long
...
// ***** VDMTOOLS START Name=LenSetToSeq#1|HashSet KEEP=NO
  static private Long LenSetToSeq (final HashSet s) throws CGException {
    return new Long(s.size());
  }
// ***** VDMTOOLS END Name=LenSetToSeq#1|HashSet
