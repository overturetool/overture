...
package org.overturetool.traces.astspec.oml2vpp;
...
import org.overturetool.traces.API.StdLib;
import org.overturetool.traces.API.VDMUtil;
...
// ***** VDMTOOLS START Name=printRealField#1|Double KEEP=NO
  private void printRealField (final Double pval) throws CGException {
    ...
    String rhs_2 = null;
    rhs_2 = UTIL.ConvertToString(VDMUtil.val2seq_uof_uchar(pval));
    result = UTIL.ConvertToString(UTIL.clone(rhs_2));
  }
