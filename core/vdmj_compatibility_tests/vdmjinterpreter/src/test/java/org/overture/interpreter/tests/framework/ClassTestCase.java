...
public class ClassTestCase extends InterpreterBaseTestCase
{
	...
	public ClassTestCase(File rootSource, String name, String content)
	{
		super(rootSource, name, content);
	}

	public ClassTestCase(File file, String suiteName, File testSuiteRoot)
	{
	...
	{
		return "C:\\overtureGit\\overture\\core\\vdmj_compatibility_tests\\vdmjinterpreter\\";
	}
