...
public class VdmjModuleSlPoTestCase extends BasicPogTestCase implements IResultStore<ProofObligationList> {
	...
	public VdmjModuleSlPoTestCase() {
		super("test");
		//this.name = "blabla";
	}

	public VdmjModuleSlPoTestCase(File file) {
		super("test");
