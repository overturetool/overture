...
//
// Generated at Fri 02-May-2008 by the VDM++ to JAVA Code Generator
...
// ***** VDMTOOLS START Name=files KEEP=NO
  private HashMap files = new HashMap();
// ***** VDMTOOLS END Name=files

// ***** VDMTOOLS START Name=IntegerStr KEEP=NO
  private String IntegerStr = null;
// ***** VDMTOOLS END Name=IntegerStr
...
// ***** VDMTOOLS START Name=codegenVisitor KEEP=NO
  public codegenVisitor () throws CGException {
    try {
...
// ***** VDMTOOLS END Name=codegenVisitor


// ***** VDMTOOLS START Name=nat2str KEEP=NO
  public String nat2str (final Integer pval) throws CGException {
    if (new Boolean((pval.intValue()) <= (new Integer(9).intValue())).booleanValue()) {
      ...
      rexpr_14 = new String();
      rexpr_14 = rexpr_14 + e_seq_15;
      return rexpr_14;
    }
    else {

      String rexpr_5 = null;
      rexpr_5 = nat2str(new Integer((int) (pval.intValue() / new Integer(10).intValue()))).concat(nat2str(new Integer((int) (pval.doubleValue() - new Integer(10).doubleValue() * Math.floor(pval.doubleValue() / new Integer(10).doubleValue())))));
      return rexpr_5;
    }
  }
// ***** VDMTOOLS END Name=nat2str


// ***** VDMTOOLS START Name=setLong KEEP=NO
  public void setLong () throws CGException {
    IntegerStr = UTIL.ConvertToString(UTIL.clone(new String("Long")));
  }
// ***** VDMTOOLS END Name=setLong


// ***** VDMTOOLS START Name=createFile KEEP=YES
  private Integer createFile (final Vector var_1_1) throws CGException {
    String path ="";
    int cnt = 0;
    while (cnt < var_1_1.size()) {
    	// if ((cnt > 0) && (cnt < var_1_1.size()-1)) {
        if (cnt > 0) {
    		path = path + File.separator;
    	}
    	path = path + (String) var_1_1.elementAt(cnt);
    	cnt++;
    }
    File vnd = new File(path);
    if (vnd.exists()) {
    	System.out.println("File \""+path+"\" does already exist!");
    } else {
    	try {
	    	if (vnd.createNewFile()) {
	    		...
	    		System.out.println("Creating new file \""+path+"\" failed!");    		
	    	}
    	}
...
// ***** VDMTOOLS END Name=createFile


// ***** VDMTOOLS START Name=printFile KEEP=YES
  private void printFile (final Integer var_1_1, final String var_2_2) throws CGException {
    if (files.containsKey(var_1_1)) {
    	...
    	System.out.println("Could not find file identifier "+UTIL.ConvertToString(var_1_1));
    }
  }
// ***** VDMTOOLS END Name=printFile


// ***** VDMTOOLS START Name=closeFiles KEEP=YES
  private void closeFiles () throws CGException {
	  int cnt = 0;
	  while (cnt < files.size()) {
		  ...
		  if (files.containsKey(key)) {
			  ...
			  try {
		    	...
		    	System.out.println("Could not find file identifier "+UTIL.ConvertToString(key));
		  };
		  cnt++;
	  }
  }
// ***** VDMTOOLS END Name=closeFiles


// ***** VDMTOOLS START Name=createDirectory KEEP=YES
  private Boolean createDirectory (final String var_1_1, final Vector var_2_2) throws CGException {
	boolean res = true;
	String path;
	if (var_1_1.length() > 0) {
      path = var_1_1;
      ...
      if (res) {
    	  ...
    	  System.out.println("Root directory \""+path+"\" does not exist!");
      }
	} else {
      path = ".";
	}
    int cnt = 0;
    while (cnt < var_2_2.size() && res) {
    	path += File.separator + (String) var_2_2.elementAt(cnt);
    	File vnd = new File (path);
    	if (vnd.exists()) {
    		res = vnd.isDirectory();
    	} else {
...
// ***** VDMTOOLS END Name=createDirectory


// ***** VDMTOOLS START Name=createInterfaces KEEP=NO
  private void createInterfaces (final AstDefinitions ad) throws CGException {
    ...
    print(new String("Creating interfaces..."));
    {
      ...
      base = tmpVal_5;
      {
        ...
        if (createDirectory(base, root).booleanValue()) {
          ...
          createInterface((AstDefinitions) ad, tmpArg_v_19);
        }
      }
    }
  }
// ***** VDMTOOLS END Name=createInterfaces


// ***** VDMTOOLS START Name=createInterface KEEP=NO
  private void createInterface (final AstDefinitions ad, final Vector path) throws CGException {
          ...
          basevisit = var1_23.concat(new String("Visitor"));
          {
            ...
            baseinfo = var1_29.concat(new String("ContextInfo"));
            {
              ...
              if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
                createDocumentInterface((AstDefinitions) ad, fid, docnm);
              Integer rhs_48 = null;
              Vector par_49 = null;
              Vector var2_51 = null;
              ...
              if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
                createBaseNode((AstDefinitions) ad, fid, basenm);
              Integer rhs_62 = null;
              Vector par_63 = null;
              Vector var2_65 = null;
              ...
              if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
                createBaseVisit((AstDefinitions) ad, fid, basevisit);
              Integer rhs_76 = null;
              Vector par_77 = null;
              Vector var2_79 = null;
              ...
              if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
                createContextInfo((AstDefinitions) ad, fid, baseinfo);
              Integer rhs_90 = null;
              Vector par_91 = null;
              Vector var2_93 = null;
              ...
              if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
                createLexemInterface((AstDefinitions) ad, fid, lexnm);
                  ...
                  composite = elem_107;
                  {
                    ...
                    clnm = tmpVal_111;
                    {
                      ...
                      if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) {
                        ...
                        tmpArg_v_128 = (AstComposite) ad.getComposite(composite);
                        createDefInt((AstDefinitions) ad, (AstComposite) tmpArg_v_128, fid);
                      }
                    }
                  }
                }
              ...
              print(new String("Creating shorthands..."));
              {
                ...
                for (Iterator enm_164 = iset_134.iterator(); enm_164.hasNext(); ) {
                  ...
                  shorthand = elem_135;
                  {
                    ...
                    obj_140 = (AstShorthand) ad.getShorthand(shorthand);
                    obj_139 = (AstType) obj_140.getType();
                    ...
                    if (cond_138.booleanValue()) {
                      ...
                      clnm = tmpVal_143;
                      {
                        ...
                        if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) {
                          ...
                          tmpArg_v_160 = (AstShorthand) ad.getShorthand(shorthand);
                          createShInt((AstDefinitions) ad, (AstShorthand) tmpArg_v_160, path, fid);
                        }
                      }
                    }
                  }
...
// ***** VDMTOOLS END Name=createInterface


// ***** VDMTOOLS START Name=createLexemInterface KEEP=NO
  private void createLexemInterface (final AstDefinitions ad, final Integer fid, final String lexnm) throws CGException {

    String tmpArg_v_6 = null;
    tmpArg_v_6 = createPackage((AstDefinitions) ad, new String("itf")).concat(nl);
...
// ***** VDMTOOLS END Name=createLexemInterface


// ***** VDMTOOLS START Name=createDocumentInterface KEEP=NO
  private void createDocumentInterface (final AstDefinitions ad, final Integer fid, final String docnm) throws CGException {
    ...
    printFile(fid, tmpArg_v_37);
    {
      ...
      sq_40 = ad.getTop();
      String name = null;
      for (Iterator enm_71 = sq_40.iterator(); enm_71.hasNext(); ) {
...
// ***** VDMTOOLS END Name=createDocumentInterface


// ***** VDMTOOLS START Name=createPackage KEEP=NO
  private String createPackage (final AstDefinitions ad, final String str) throws CGException {
...
// ***** VDMTOOLS END Name=createPackage


// ***** VDMTOOLS START Name=createBaseNode KEEP=NO
  private void createBaseNode (final AstDefinitions ad, final Integer fid, final String basenm) throws CGException {
...
// ***** VDMTOOLS END Name=createBaseNode


// ***** VDMTOOLS START Name=createContextInfo KEEP=NO
  private void createContextInfo (final AstDefinitions ad, final Integer fid, final String basenm) throws CGException {
...
// ***** VDMTOOLS END Name=createContextInfo


// ***** VDMTOOLS START Name=createBaseVisit KEEP=NO
  private void createBaseVisit (final AstDefinitions ad, final Integer fid, final String basenm) throws CGException {
    ...
    printFile(fid, tmpArg_v_59);
    {
      ...
      String id = null;
      for (Iterator enm_85 = iset_66.iterator(); enm_85.hasNext(); ) {
    ...
    }
    {
      ...
      for (Iterator enm_109 = iset_86.iterator(); enm_109.hasNext(); ) {
        ...
        id = elem_87;
        {
          ...
          obj_92 = (AstShorthand) ad.getShorthand(id);
          obj_91 = (AstType) obj_92.getType();
...
// ***** VDMTOOLS END Name=createBaseVisit


// ***** VDMTOOLS START Name=createDefInt KEEP=NO
  private void createDefInt (final AstDefinitions ad, final AstComposite composite, final Integer fid) throws CGException {
    ...
    clnm = tmpVal_5;
    {
      ...
      tmpArg_v_12 = createPackage((AstDefinitions) ad, new String("itf")).concat(nl);
      ...
      printFile(fid, tmpArg_v_58);
      {
        ...
        for (Iterator enm_92 = sq_61.iterator(); enm_92.hasNext(); ) {
          ...
          field = (AstField) elem_62;
          {
            ...
            par_65 = ad.getPrefix();
            AstType par_66 = null;
            par_66 = (AstType) field.getType();
            tp = getJavaType(par_65, (AstType) par_66);
...
// ***** VDMTOOLS END Name=createDefInt


// ***** VDMTOOLS START Name=createShInt KEEP=NO
  private void createShInt (final AstDefinitions ad, final AstShorthand shorthand, final Vector path, final Integer fid) throws CGException {
    ...
    clnm = tmpVal_6;
    {
      ...
      AstType obj_13 = null;
      obj_13 = (AstType) shorthand.getType();
        ...
        UTIL.RunTime("Run-Time Error:Pattern match did not succeed in value definition");
      {
        ...
        String tmpArg_v_18 = null;
        tmpArg_v_18 = createPackage((AstDefinitions) ad, new String("itf")).concat(nl);
        printFile(fid, tmpArg_v_18);
        if (rb.booleanValue()) {
        ...
        if (rb.booleanValue()) {
          ...
          createShQuotedTypeInt((AstDefinitions) ad, clnm, path, rs);
          String tmpArg_v_66 = null;
          String var1_67 = null;
          String var1_68 = null;
...
// ***** VDMTOOLS END Name=createShInt


// ***** VDMTOOLS START Name=createShQuotedTypeInt KEEP=NO
  private void createShQuotedTypeInt (final AstDefinitions ad, final String shnm, final Vector path, final HashSet qtnms) throws CGException {
    ...
    clnm = tmpVal_6;
    {
      ...
      if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) {
        ...
        String tmpArg_v_20 = null;
        String var1_21 = null;
        var1_21 = createPackage((AstDefinitions) ad, new String("itf")).concat(nl);
        tmpArg_v_20 = var1_21.concat(nl);
        printFile(fid, tmpArg_v_20);
        String tmpArg_v_29 = null;
        String var1_30 = null;
...
// ***** VDMTOOLS END Name=createShQuotedTypeInt


// ***** VDMTOOLS START Name=getJavaType KEEP=NO
  private String getJavaType (final String prefix, final AstType atp) throws CGException {
                ...
                if (cond_12.booleanValue()) 
                  ...
                  if (cond_10.booleanValue()) 
                    ...
                    if (cond_6.booleanValue()) {
                      ...
                      String rexpr_7 = null;
                      AstType par_9 = null;
                      par_9 = (AstType) aotp.getType();
                      rexpr_7 = getJavaType(prefix, (AstType) par_9);
                      return rexpr_7;
                    }
                    else {
...
// ***** VDMTOOLS END Name=getJavaType


// ***** VDMTOOLS START Name=getVdmType KEEP=NO
  private String getVdmType (final String prefix, final AstType atp) throws CGException {
            ...
            if (cond_38.booleanValue()) 
              ...
              if (cond_32.booleanValue()) {
                ...
                if (cond_26.booleanValue()) {
                  ...
                  String var2_29 = null;
                  AstType par_31 = null;
                  par_31 = (AstType) astp.getType();
                  var2_29 = getVdmType(prefix, (AstType) par_31);
                  ...
                  if (cond_20.booleanValue()) {
                    ...
                    String var2_23 = null;
                    AstType par_25 = null;
                    par_25 = (AstType) astp.getType();
                    var2_23 = getVdmType(prefix, (AstType) par_25);
                    ...
                    if (cond_16.booleanValue()) {
                      ...
                      AstType par_19 = null;
                      par_19 = (AstType) aotp.getType();
                      rexpr_17 = getVdmType(prefix, (AstType) par_19);
                      return rexpr_17;
                    }
                    else {
                      ...
                      if (cond_4.booleanValue()) {
                        ...
                        String var2_9 = null;
                        AstType par_11 = null;
                        par_11 = (AstType) amtp.getDomType();
                        var2_9 = getVdmType(prefix, (AstType) par_11);
                        var1_7 = new String("map ").concat(var2_9);
                        var1_6 = var1_7.concat(new String(" to "));
                        String var2_13 = null;
                        AstType par_15 = null;
                        par_15 = (AstType) amtp.getRngType();
                        var2_13 = getVdmType(prefix, (AstType) par_15);
...
// ***** VDMTOOLS END Name=getVdmType


// ***** VDMTOOLS START Name=createSpecifications KEEP=NO
  private void createSpecifications (final AstDefinitions ad) throws CGException {
    ...
    base = tmpVal_3;
    {
      ...
      if (createDirectory(base, root).booleanValue()) {
        ...
        createSpecification((AstDefinitions) ad, tmpArg_v_12);
      }
    }
  }
// ***** VDMTOOLS END Name=createSpecifications


// ***** VDMTOOLS START Name=createSpecification KEEP=NO
  private void createSpecification (final AstDefinitions ad, final Vector path) throws CGException {
      ...
      basenm = tmpVal_8;
      {
        ...
        basevisit = tmpVal_12;
        {
          ...
          lexnm = tmpVal_16;
          {
            ...
            print(new String("Creating document, lexem, base class and visitor interfaces..."));
            if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
              createVppIDocument((AstDefinitions) ad, fid, docnm);
            Integer rhs_36 = null;
            Vector par_37 = null;
            Vector var2_39 = null;
            ...
            if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
              createVppDocument((AstDefinitions) ad, fid, docnm);
            Integer rhs_50 = null;
            Vector par_51 = null;
            Vector var2_53 = null;
            ...
            if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
              createVppILexem((AstDefinitions) ad, fid, lexnm);
            Integer rhs_66 = null;
            Vector par_67 = null;
            Vector var2_69 = null;
            ...
            if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
              createVppLexem((AstDefinitions) ad, fid, lexnm);
            Integer rhs_80 = null;
            Vector par_81 = null;
            Vector var2_83 = null;
            ...
            if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
              createVppBaseNode((AstDefinitions) ad, fid, basenm);
            Integer rhs_94 = null;
            Vector par_95 = null;
            Vector var2_97 = null;
            ...
            if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
              createVppIBaseVisit((AstDefinitions) ad, fid, basevisit);
            ...
            if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
              createVppBaseVisit((AstDefinitions) ad, fid, basevisit);
                ...
                composite = elem_127;
                {
                  ...
                  clnm = tmpVal_131;
                  {
                    ...
                    if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) {
                      ...
                      tmpArg_v_148 = (AstComposite) ad.getComposite(composite);
                      createDefISpec((AstDefinitions) ad, (AstComposite) tmpArg_v_148, clnm, fid);
                    }
                    ...
                    if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) {
                      ...
                      tmpArg_v_164 = (AstComposite) ad.getComposite(composite);
                      createDefSpec((AstDefinitions) ad, (AstComposite) tmpArg_v_164, clnm, fid);
                    }
                  }
                }
              }
            ...
            print(new String("Creating shorthands..."));
            {
              ...
              for (Iterator enm_219 = iset_171.iterator(); enm_219.hasNext(); ) {
                ...
                shorthand = elem_172;
                {
                  ...
                  obj_177 = (AstShorthand) ad.getShorthand(shorthand);
                  obj_176 = (AstType) obj_177.getType();
                  ...
                  if (cond_175.booleanValue()) {
                    ...
                    clnm = tmpVal_180;
                    {
                      ...
                      if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) {
                        ...
                        tmpArg_v_197 = (AstShorthand) ad.getShorthand(shorthand);
                        createShISpec((AstDefinitions) ad, (AstShorthand) tmpArg_v_197, clnm, path, fid);
                      }
                      ...
                      if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) {
                        ...
                        tmpArg_v_214 = (AstShorthand) ad.getShorthand(shorthand);
                        createShSpec((AstDefinitions) ad, (AstShorthand) tmpArg_v_214, clnm, path, fid);
                      }
                    }
                  }
                }
            ...
            if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
              createVdmVisitor((AstDefinitions) ad, fid, new Boolean(false));
            ...
            if (new Boolean((fid.intValue()) >= (new Integer(0).intValue())).booleanValue()) 
              createVdmVisitor((AstDefinitions) ad, fid, new Boolean(true));
          }
        }
      }
    }
  }
// ***** VDMTOOLS END Name=createSpecification


// ***** VDMTOOLS START Name=createVppIDocument KEEP=NO
  private void createVppIDocument (final AstDefinitions ad, final Integer fid, final String docnm) throws CGException {
    ...
    printFile(fid, tmpArg_v_30);
    {
      ...
      sq_35 = ad.getTop();
      String name = null;
      for (Iterator enm_84 = sq_35.iterator(); enm_84.hasNext(); ) {
...
// ***** VDMTOOLS END Name=createVppIDocument


// ***** VDMTOOLS START Name=createVppDocument KEEP=NO
  private void createVppDocument (final AstDefinitions ad, final Integer fid, final String docnm) throws CGException {
...
// ***** VDMTOOLS END Name=createVppDocument


// ***** VDMTOOLS START Name=createVppILexem KEEP=NO
  private void createVppILexem (final AstDefinitions ad, final Integer fid, final String lexnm) throws CGException {
...
// ***** VDMTOOLS END Name=createVppILexem


// ***** VDMTOOLS START Name=createVppLexem KEEP=NO
  private void createVppLexem (final AstDefinitions ad, final Integer fid, final String lexnm) throws CGException {
...
// ***** VDMTOOLS END Name=createVppLexem


// ***** VDMTOOLS START Name=createVdmVisitor KEEP=NO
  private void createVdmVisitor (final AstDefinitions ad, final Integer fid, final Boolean vpp) throws CGException {
    ...
    createVdmSlFieldVisitors((AstDefinitions) ad, fid, vpp);
    ...
    printFile(fid, tmpArg_v_151);
    createVdmDocLexemVisitors((AstDefinitions) ad, fid, vpp);
    {

      HashSet iset_160 = new HashSet();
      iset_160 = ad.getComposites();
      String composite = null;
      for (Iterator enm_349 = iset_160.iterator(); enm_349.hasNext(); ) {
        ...
        composite = elem_161;
        {
          ...
          clnm = tmpVal_165;
          {
            ...
            cmp = (AstComposite) ad.getComposite(composite);
            ...
            while ( true){
              ...
              if (whCrtl_210.booleanValue()) {
                ...
                par_216 = (AstType) fld.getType();
                ostr = getVdmSlFieldOper((AstType) par_216);
                Boolean cond_217 = null;
                AstType obj_218 = null;
                obj_218 = (AstType) fld.getType();
    ...
    }
    {
      ...
      for (Iterator enm_463 = iset_350.iterator(); enm_463.hasNext(); ) {
        ...
        shorthand = elem_351;
        {
          ...
          obj_357 = (AstShorthand) ad.getShorthand(shorthand);
          obj_356 = (AstType) obj_357.getType();
...
// ***** VDMTOOLS END Name=createVdmVisitor


// ***** VDMTOOLS START Name=createVdmSlFieldVisitors KEEP=NO
  private void createVdmSlFieldVisitors (final AstDefinitions ad, final Integer fid, final Boolean vpp) throws CGException {
...
// ***** VDMTOOLS END Name=createVdmSlFieldVisitors


// ***** VDMTOOLS START Name=getVdmSlFieldOper KEEP=NO
  private String getVdmSlFieldOper (final AstType ast) throws CGException {
            ...
            if (cond_14.booleanValue()) 
              ...
              if (cond_12.booleanValue()) 
                ...
                if (cond_9.booleanValue()) {
                  ...
                  AstType par_11 = null;
                  par_11 = (AstType) aotp.getType();
                  rexpr_10 = getVdmSlFieldOper((AstType) par_11);
                  return rexpr_10;
                }
                else {
...
// ***** VDMTOOLS END Name=getVdmSlFieldOper


// ***** VDMTOOLS START Name=createVdmDocLexemVisitors KEEP=NO
  private void createVdmDocLexemVisitors (final AstDefinitions ad, final Integer fid, final Boolean vpp) throws CGException {
    ...
    pfx = ad.getPrefix();
    {
      ...
      }
      {
        ...
        sq_59 = ad.getTop();
        String name = null;
        for (Iterator enm_81 = sq_59.iterator(); enm_81.hasNext(); ) {
...
// ***** VDMTOOLS END Name=createVdmDocLexemVisitors


// ***** VDMTOOLS START Name=createVppBaseNode KEEP=NO
  private void createVppBaseNode (final AstDefinitions ad, final Integer fid, final String basenm) throws CGException {
...
// ***** VDMTOOLS END Name=createVppBaseNode


// ***** VDMTOOLS START Name=createNormalVisitor KEEP=NO
  private void createNormalVisitor (final AstDefinitions ad, final Integer fid, final String id) throws CGException {
...
// ***** VDMTOOLS END Name=createNormalVisitor


// ***** VDMTOOLS START Name=createNormalIVisitor KEEP=NO
  private void createNormalIVisitor (final AstDefinitions ad, final Integer fid, final String id) throws CGException {
...
// ***** VDMTOOLS END Name=createNormalIVisitor


// ***** VDMTOOLS START Name=createNodeIVisitor KEEP=NO
  private void createNodeIVisitor (final AstDefinitions ad, final Integer fid) throws CGException {
...
// ***** VDMTOOLS END Name=createNodeIVisitor


// ***** VDMTOOLS START Name=createNodeVisitor KEEP=NO
  private void createNodeVisitor (final AstDefinitions ad, final Integer fid) throws CGException {
...
// ***** VDMTOOLS END Name=createNodeVisitor


// ***** VDMTOOLS START Name=createTypeNameUnionVisitor KEEP=NO
  private void createTypeNameUnionVisitor (final AstDefinitions ad, final Integer fid, final String id, final HashSet tnus) throws CGException {
...
// ***** VDMTOOLS END Name=createTypeNameUnionVisitor


// ***** VDMTOOLS START Name=createVppBaseVisit KEEP=NO
  private void createVppBaseVisit (final AstDefinitions ad, final Integer fid, final String basevisit) throws CGException {
    ...
    printFile(fid, tmpArg_v_52);
    {
      ...
      String id = null;
      for (Iterator enm_65 = iset_57.iterator(); enm_65.hasNext(); ) {

        String elem_58 = UTIL.ConvertToString(enm_65.next());
        id = elem_58;
        createNormalVisitor((AstDefinitions) ad, fid, id);
      }
    }
    createNormalVisitor((AstDefinitions) ad, fid, new String("ContextInfo"));
    createNodeVisitor((AstDefinitions) ad, fid);
    {
      ...
      for (Iterator enm_96 = iset_73.iterator(); enm_96.hasNext(); ) {
        ...
        id = elem_74;
        {
          ...
          obj_79 = (AstShorthand) ad.getShorthand(id);
          shtp = (AstType) obj_79.getType();
          ...
          if (cond_81.booleanValue()) {
            ...
            succ_82 = true;
            {
              ...
              if (succ_82 = 2 == e_l_84.size()) {
                ...
                tnus = (HashSet) e_l_84.get(2 - 1);
              }
            }
            if (!succ_82) 
              UTIL.RunTime("Run-Time Error:Pattern match did not succeed in value definition");
            if (sb.booleanValue()) 
              createTypeNameUnionVisitor((AstDefinitions) ad, fid, id, tnus);
            else 
              createNormalVisitor((AstDefinitions) ad, fid, id);
          }
        }
...
// ***** VDMTOOLS END Name=createVppBaseVisit


// ***** VDMTOOLS START Name=createVppIBaseVisit KEEP=NO
  private void createVppIBaseVisit (final AstDefinitions ad, final Integer fid, final String basevisit) throws CGException {
    ...
    printFile(fid, tmpArg_v_48);
    {
      ...
      String id = null;
      for (Iterator enm_61 = iset_53.iterator(); enm_61.hasNext(); ) {

        String elem_54 = UTIL.ConvertToString(enm_61.next());
        id = elem_54;
        createNormalIVisitor((AstDefinitions) ad, fid, id);
      }
    }
    createNormalIVisitor((AstDefinitions) ad, fid, new String("ContextInfo"));
    createNodeIVisitor((AstDefinitions) ad, fid);
    {
      ...
      for (Iterator enm_82 = iset_69.iterator(); enm_82.hasNext(); ) {
        ...
        id = elem_70;
        {
          ...
          obj_75 = (AstShorthand) ad.getShorthand(id);
          shtp = (AstType) obj_75.getType();
...
// ***** VDMTOOLS END Name=createVppIBaseVisit


// ***** VDMTOOLS START Name=createDefSpec KEEP=NO
  private void createDefSpec (final AstDefinitions ad, final AstComposite acmp, final String clnm, final Integer fid) throws CGException {
    ...
    printFile(fid, tmpArg_v_53);
    createDefSpecConstructor((AstDefinitions) ad, (AstComposite) acmp, fid, new Boolean(false));
    createDefSpecConstructor((AstDefinitions) ad, (AstComposite) acmp, fid, new Boolean(true));
    createDefSpecCompInit((AstComposite) acmp, fid);
    {
      ...
      for (Iterator enm_453 = sq_75.iterator(); enm_453.hasNext(); ) {
        ...
        field = (AstField) elem_76;
        {
          ...
          fldnm = new String("iv").concat(var2_82);
          {
            ...
            AstType fldtp = null;
            fldtp = (AstType) field.getType();
            {

              String tp = null;
              String par_85 = null;
              par_85 = ad.getPrefix();
              tp = getVdmType(par_85, (AstType) fldtp);
              String tmpArg_v_89 = null;
              ...
              if (cond_270.booleanValue()) {
                ...
                stp = (AstSeqOfType) field.getType();
                {
                  ...
                  par_275 = (AstType) stp.getType();
                  ntp = getVdmType(par_274, (AstType) par_275);
                  Boolean cond_276 = null;
                  AstType obj_277 = null;
                  obj_277 = (AstType) stp.getType();
              ...
              if (cond_323.booleanValue()) {
                ...
                stp = (AstSetOfType) field.getType();
                {
                  ...
                  par_328 = (AstType) stp.getType();
                  ntp = getVdmType(par_327, (AstType) par_328);
                  Boolean cond_329 = null;
                  AstType obj_330 = null;
                  obj_330 = (AstType) stp.getType();
              ...
              if (cond_376.booleanValue()) {
                ...
                mtp = (AstMapType) field.getType();
                {
                  ...
                  par_381 = (AstType) mtp.getDomType();
                  ndtp = getVdmType(par_380, (AstType) par_381);
                  String nrtp = null;
                  String par_382 = null;
                  par_382 = ad.getPrefix();
                  AstType par_383 = null;
                  par_383 = (AstType) mtp.getRngType();
                  nrtp = getVdmType(par_382, (AstType) par_383);
                  {

                    String dtnm = null;
                    Boolean cond_387 = null;
                    AstType obj_388 = null;
                    obj_388 = (AstType) mtp.getDomType();
                      ...
                      dtnm = ndtp;
                    {
                      ...
                      obj_397 = (AstType) mtp.getRngType();
...
// ***** VDMTOOLS END Name=createDefSpec


// ***** VDMTOOLS START Name=createDefISpec KEEP=NO
  private void createDefISpec (final AstDefinitions ad, final AstComposite acmp, final String clnm, final Integer fid) throws CGException {
        ...
        field = (AstField) elem_35;
        {
          ...
          fldnm = new String("iv").concat(var2_41);
          {
            ...
            fldtp = (AstType) field.getType();
            {
              ...
              String par_44 = null;
              par_44 = ad.getPrefix();
              tp = getVdmType(par_44, (AstType) fldtp);
              String tmpArg_v_48 = null;
...
// ***** VDMTOOLS END Name=createDefISpec


// ***** VDMTOOLS START Name=createDefSpecConstructor KEEP=NO
  private void createDefSpecConstructor (final AstDefinitions ad, final AstComposite acmp, final Integer fid, final Boolean posinfo) throws CGException {
    ...
    clnm = tmpVal_6;
    {
      ...
      fields = acmp.getFields();
      {
        ...
        Integer cnt = new Integer(1);
        while ( new Boolean((cnt.intValue()) <= (new Integer(fields.size()).intValue())).booleanValue()){
            ...
            pname = new String("p").concat(nat2str(cnt));
            {
              ...
              nbody = var1_22.concat(new String(")"));
              {
                ...
                if (1 <= cnt.intValue() && cnt.intValue() <= fields.size()) 
                  ...
                  UTIL.RunTime("Run-Time Error:Illegal index");
                par_36 = (AstType) obj_37.getType();
                btype = getVdmType(par_35, (AstType) par_36);
                {
...
// ***** VDMTOOLS END Name=createDefSpecConstructor


// ***** VDMTOOLS START Name=createDefSpecCompInit KEEP=NO
  private void createDefSpecCompInit (final AstComposite acmp, final Integer fid) throws CGException {
...
// ***** VDMTOOLS END Name=createDefSpecCompInit


// ***** VDMTOOLS START Name=createShSpec KEEP=NO
  private void createShSpec (final AstDefinitions ad, final AstShorthand shorthand, final String clnm, final Vector path, final Integer fid) throws CGException {
    ...
    printFile(fid, tmpArg_v_54);
    {
      ...
      AstType obj_65 = null;
      obj_65 = (AstType) shorthand.getType();
...
// ***** VDMTOOLS END Name=createShSpec


// ***** VDMTOOLS START Name=createShISpec KEEP=NO
  private void createShISpec (final AstDefinitions ad, final AstShorthand shorthand, final String clnm, final Vector path, final Integer fid) throws CGException {
    ...
    }
    {
      ...
      AstType obj_37 = null;
      obj_37 = (AstType) shorthand.getType();
...
// ***** VDMTOOLS END Name=createShISpec


// ***** VDMTOOLS START Name=createDefSpecShInit KEEP=NO
  private void createDefSpecShInit (final AstShorthand ash, final Integer fid) throws CGException {
...
// ***** VDMTOOLS END Name=createDefSpecShInit


// ***** VDMTOOLS START Name=createShQuotedTypeDef KEEP=NO
  private void createShQuotedTypeDef (final String ashnm, final Vector path, final HashSet qtnms) throws CGException {
...
// ***** VDMTOOLS END Name=createShQuotedTypeDef


// ***** VDMTOOLS START Name=createScript KEEP=NO
  private void createScript (final AstDefinitions ad) throws CGException {
    ...
    base = tmpVal_3;
    {
      ...
      if (createDirectory(base, root).booleanValue()) {
        ...
        makeScript((AstDefinitions) ad, tmpArg_v_17);
      }
    }
  }
// ***** VDMTOOLS END Name=createScript


// ***** VDMTOOLS START Name=makeScript KEEP=NO
  private void makeScript (final AstDefinitions ad, final Vector path) throws CGException {
              ...
              dname = var1_32.concat(new String("Document"));
              {
                ...
                if (cond_38.booleanValue()) {
                  ...
                  printPatch(new String("VdmPpVisitor"), fid1);
                  {
                    ...
                    String id = null;
                    for (Iterator enm_185 = iset_163.iterator(); enm_185.hasNext(); ) {
                      ...
                      id = elem_187;
                      {
                        ...
                        clnm = tmpVal_191;
                        {
                          ...
                          base = tmpVal_195;
                          {
                            ...
                            obj_204 = (AstShorthand) ad.getShorthand(id);
                            obj_203 = (AstType) obj_204.getType();
                              ...
                              patchFile(fid1, fid2, clnm, base, new Boolean(false));
                            {
                              ...
                              obj_215 = (AstShorthand) ad.getShorthand(id);
                              obj_214 = (AstType) obj_215.getType();
...
// ***** VDMTOOLS END Name=makeScript


// ***** VDMTOOLS START Name=patchFile KEEP=NO
  private void patchFile (final Integer fid1, final Integer fid2, final String clnm, final String base, final Boolean abstr) throws CGException {
...
// ***** VDMTOOLS END Name=patchFile


// ***** VDMTOOLS START Name=printPatch KEEP=NO
  private void printPatch (final String fname, final Integer fid) throws CGException {
...
// ***** VDMTOOLS END Name=printPatch


// ***** VDMTOOLS START Name=print KEEP=YES
  public void print (final String var_1_1) throws CGException {
...
// ***** VDMTOOLS START Name=visit KEEP=NO
  public void visit (final AstDefinitions ad) throws CGException {
    ...
    print(new String("Start code generation..."));
    {
      ...
      tmpVal_5 = createDirectory(par_6, par_7);
      {
        ...
        createInterfaces((AstDefinitions) ad);
        createSpecifications((AstDefinitions) ad);
        createScript((AstDefinitions) ad);
      }
    }
    closeFiles();
