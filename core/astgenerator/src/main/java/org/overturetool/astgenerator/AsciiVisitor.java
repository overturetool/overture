...
// ***** VDMTOOLS START Name=res KEEP=NO
  public String res = null;
// ***** VDMTOOLS END Name=res


// ***** VDMTOOLS START Name=AsciiVisitor KEEP=NO
  public AsciiVisitor () throws CGException {
    try {
...
// ***** VDMTOOLS END Name=AsciiVisitor


// ***** VDMTOOLS START Name=pushLevel KEEP=NO
  private void pushLevel () throws CGException {
    level = UTIL.NumberToInt(UTIL.clone(new Integer(level.intValue() + new Integer(2).intValue())));
  }
// ***** VDMTOOLS END Name=pushLevel


// ***** VDMTOOLS START Name=popLevel KEEP=NO
  private void popLevel () throws CGException {
    level = UTIL.NumberToInt(UTIL.clone(new Integer(level.intValue() - new Integer(2).intValue())));
  }
// ***** VDMTOOLS END Name=popLevel


// ***** VDMTOOLS START Name=nl KEEP=NO
  private String nl () throws CGException {
      ...
      while ( new Boolean((new Integer(cmps.size()).intValue()) > (new Integer(0).intValue())).booleanValue()){
        ...
        res = UTIL.ConvertToString(UTIL.clone(rhs_14));
        {
            ...
            UTIL.RunTime("Run-Time Error:The binding environment was empty");
          {
            ...
            obj_23 = (AstComposite) ad.getComposite(cmp);
            obj_23.accept((AstVisitor) this);
      ...
      while ( new Boolean((new Integer(shs.size()).intValue()) > (new Integer(0).intValue())).booleanValue()){
        ...
        res = UTIL.ConvertToString(UTIL.clone(rhs_53));
        {
            ...
            UTIL.RunTime("Run-Time Error:The binding environment was empty");
          {
            ...
            obj_62 = (AstShorthand) ad.getShorthand(sh);
            obj_62.accept((AstVisitor) this);
...
// ***** VDMTOOLS START Name=visit KEEP=NO
  public void visit (final AstShorthand ash) throws CGException {
    ...
    AstType obj_16 = null;
    obj_16 = (AstType) ash.getType();
    obj_16.accept((AstVisitor) this);
    String rhs_18 = null;
...
// ***** VDMTOOLS START Name=visit KEEP=NO
  public void visit (final AstTypeName at) throws CGException {
...
// ***** VDMTOOLS START Name=visit KEEP=NO
  public void visit (final AstUnionType aut) throws CGException {
    ...
    res = UTIL.ConvertToString(UTIL.clone(rhs_6));
    AstType obj_10 = null;
    obj_10 = (AstType) aut.getLhs();
    obj_10.accept((AstVisitor) this);
    String rhs_12 = null;
    String var1_13 = null;
...
// ***** VDMTOOLS START Name=visit KEEP=NO
  public void visit (final AstSeqOfType asot) throws CGException {
    ...
    res = UTIL.ConvertToString(UTIL.clone(rhs_2));
    AstType obj_6 = null;
    obj_6 = (AstType) asot.getType();
    obj_6.accept((AstVisitor) this);
    String rhs_8 = null;
...
// ***** VDMTOOLS START Name=visit KEEP=NO
  public void visit (final AstSetOfType asot) throws CGException {
...
// ***** VDMTOOLS START Name=visit KEEP=NO
  public void visit (final AstMapType amt) throws CGException {
    ...
    res = UTIL.ConvertToString(UTIL.clone(rhs_2));
    AstType obj_6 = null;
    obj_6 = (AstType) amt.getDomType();
    obj_6.accept((AstVisitor) this);
    String rhs_8 = null;
    rhs_8 = res.concat(new String(","));
    res = UTIL.ConvertToString(UTIL.clone(rhs_8));
    AstType obj_12 = null;
    obj_12 = (AstType) amt.getRngType();
    obj_12.accept((AstVisitor) this);
    String rhs_14 = null;
