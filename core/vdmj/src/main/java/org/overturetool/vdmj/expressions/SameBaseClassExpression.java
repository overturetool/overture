...
public class SameBaseClassExpression extends Expression
{
	...
	public SameBaseClassExpression(LexLocation start, ExpressionList args)
	{
		super(start);
	...
	public Value eval(Context ctxt)
	{
		...
		try
		{
			...
			TypeList lbases = lv.getBaseTypes();
			TypeList rbases = rv.getBaseTypes();

			for (Type ltype: lbases)
			{
