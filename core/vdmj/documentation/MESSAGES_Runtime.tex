...
\item[4022:] \texttt{"mk_ type argument is not <type>"}
...
\item[4026:] \texttt{"Cannot create post_op environment"}
\item[4027:] \texttt{"Cannot create pre_op environment"}
...
\item[4055:] \texttt{"Precondition failure: <pre_name>"}
\item[4056:] \texttt{"Postcondition failure: <post_name>"}
...
\item[4071:] \texttt{"Precondition failure: <pre_name>"}
\item[4072:] \texttt{"Postcondition failure: <post_name>"}
...
\item[4079:] \texttt{"Type invariant violated by mk_ arguments"}
\item[4080:] \texttt{"Wrong number of fields for <type>"}
\item[4081:] \texttt{"Field not defined: <tag>"}
\item[4082:] \texttt{"Type invariant violated by mk_ arguments"}
...
\item[4130:] \texttt{"Instance invariant violated: <inv_op>"}
\item[4131:] \texttt{"State invariant violated: <inv_op>"}
