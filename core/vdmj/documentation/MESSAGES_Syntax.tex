...
\item[2014:] \texttt{"Recursive type declaration"}
\item[2015:] \texttt{"Expecting =<type> or ::<field list>"}
\item[2016:] \texttt{"Function name cannot start with 'mk_'"}
...
\item[2036:] \texttt{"Expecting mk_<type>"}
\item[2037:] \texttt{"Malformed mk_<type> name <name>"}
\item[2038:] \texttt{"Expecting is_<type>"}
...
\item[2131:] \texttt{"Expecting ')' after mk_ tuple"}
\item[2132:] \texttt{"Expecting is_(expression, type)"}
\item[2133:] \texttt{"Expecting ')' after is_ expression"}
\item[2134:] \texttt{"Expecting pre_(function [,args])"}
...
\item[2183:] \texttt{"Expecting '(' after mk_ tuple"}
\item[2184:] \texttt{"Expecting ')' after mk_ tuple"}
