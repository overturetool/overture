...
\item[3243:] \texttt{"Seq index is not numeric"}
...
\item[3247:] \texttt{"Symbol <name> is not an updatable variable"}
\item[3247:] \texttt{"Operaton call not allowed in state designator"}
\item[3247:] \texttt{"Function apply not allowed in state designator"}
