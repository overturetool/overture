...
\item[3006:] \texttt{"Overriding definition reduces visibility"}
...
\item[3019:] \texttt{"Function parameter visibility less than function definition"}
...
\item[3028:] \texttt{"Operation parameter visibility less than operation definition"}
\item[3029:] \texttt{"Function returns unexpected type"}
\item[3030:] \texttt{"Function parameter visibility less than function definition"}
...
\item[3036:] \texttt{"Operation parameter visibility less than operation definition"}
...
\item[3052:] \texttt{"Value type visibility less than value definition"}
...
\item[3125:] \texttt{"Argument of mk_<type> is the wrong type"}
...
\item[3160:] \texttt{"Left hand of '\\' is not a set"}
\item[3161:] \texttt{"Right hand of '\\' is not a set"}
\item[3162:] \texttt{"Left and right of '\\' are different types"}
...
\item[3200:] \texttt{"Mk_ expression is not a record type"}
