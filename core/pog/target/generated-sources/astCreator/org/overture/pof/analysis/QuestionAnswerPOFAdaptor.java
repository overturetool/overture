...
public abstract class QuestionAnswerPOFAdaptor<Q, A> extends QuestionAnswerAdaptor<Q, A> implements IPOFQuestionAnswer<Q, A>
{
	...
	/**
	* Creates a new {@code QuestionAnswerPOFAdaptor} node with the given nodes as children.
	* The basic child nodes are removed from their previous parents.
	*/
	public QuestionAnswerPOFAdaptor(IQuestionAnswer<Q, A> THIS_)
	{
		super(THIS_);
	...
	/**
	 * Creates a new {@link QuestionAnswerPOFAdaptor} node with no children.
	 */
	...
	*/
	public A defaultPPoTree(PPoTree node, Q question) throws AnalysisException
	{
	...
	*/
	public A caseAVdmPoTree(AVdmPoTree node, Q question) throws AnalysisException
	{
		return defaultPPoTree(node, question);
	}
