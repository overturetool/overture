...
/**
 * A class to create unique names, for use during PO generation. The
 * module/class and location are set during construction from the node passed in
 * (though must be a PExp or PDefinition to do this).
 * 
 * @author Nick Battle
 */
