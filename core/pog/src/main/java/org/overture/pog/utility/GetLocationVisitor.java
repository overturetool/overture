...
class GetLocationVisitor extends AnswerAdaptor<ILexLocation>
	 ...
	 */
		...
		@Override
		public ILexLocation defaultSMapExp(SMapExp node)
				throws AnalysisException
		{
			return node.getLocation();
		}
		...
		@Override
		public ILexLocation defaultSSeqExp(SSeqExp node)
				throws AnalysisException
		{
			return node.getLocation();
		}
		...
		@Override
		public ILexLocation defaultSSetExp(SSetExp node)
				throws AnalysisException
		{
			return node.getLocation();
		}
		...
		@Override
		public ILexLocation defaultSMapType(SMapType node)
				throws AnalysisException
		{
			return node.getLocation();
		}
		...
		@Override
		public ILexLocation defaultSSeqType(SSeqType node)
				throws AnalysisException
		{
			return node.getLocation();
		}
		...
		@Override
		public ILexLocation defaultPPattern(PPattern node)
				throws AnalysisException
		{
			return node.getLocation();
		}
		...
		@Override
		public ILexLocation defaultPTraceCoreDefinition(
				PTraceCoreDefinition node) throws AnalysisException
		{
			return node.getLocation();
		}

		@Override
		public ILexLocation defaultPImport(PImport node)
				throws AnalysisException
		{
			return node.getLocation();
		}
		...
		@Override
		public ILexLocation defaultPExport(PExport node)
				throws AnalysisException
		{
			return node.getLocation();
		}
		...
		@Override
		public ILexLocation defaultSLetDefStm(SLetDefStm node)
				throws AnalysisException
		{
			return node.getLocation();
		}
