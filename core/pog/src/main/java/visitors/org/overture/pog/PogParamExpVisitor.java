...
import org.overture.pog.ACaseAlternativeAssistantPOG;
import org.overture.pog.CasesExhaustiveObligation;
import org.overture.pog.FiniteMapObligation;
import org.overture.pog.FuncComposeObligation;
import org.overture.pog.FunctionApplyObligation;
import org.overture.pog.LetBeExistsObligation;
import org.overture.pog.MapApplyObligation;
import org.overture.pog.MapCompatibleObligation;
import org.overture.pog.MapComposeObligation;
import org.overture.pog.MapIterationObligation;
import org.overture.pog.MapSeqOfCompatibleObligation;
import org.overture.pog.MapSetOfCompatibleObligation;
import org.overture.pog.NonEmptySeqObligation;
import org.overture.pog.NonZeroObligation;
import org.overture.pog.PDefinitionAssistantPOG;
import org.overture.pog.POContextStack;
import org.overture.pog.PODefContext;
import org.overture.pog.POForAllContext;
import org.overture.pog.POForAllPredicateContext;
import org.overture.pog.POImpliesContext;
import org.overture.pog.POLetDefContext;
import org.overture.pog.PONameContext;
import org.overture.pog.PONotImpliesContext;
import org.overture.pog.ProofObligationList;
import org.overture.pog.RecursiveObligation;
import org.overture.pog.SeqApplyObligation;
import org.overture.pog.SubTypeObligation;
import org.overture.pog.TupleSelectObligation;
import org.overture.pog.UniqueExistenceObligation;
...
public class PogParamExpVisitor<Q extends POContextStack, A extends ProofObligationList>
	...
	obligations.add(new org.overture.pog.NonEmptySetObligation(
	...
	if (!node.getMapType().getEmpty()) {
	    obligations
		    .add(new org.overture.pog.InvariantObligation(
			    node, question));
	}
	return obligations;
    }
	...
	if (PTypeAssistantTC.isSeq(lType)) {
	    obligations
		    .add(new org.overture.pog.SeqModificationObligation(
			    node, question));
	}
	...
	if (PTypeAssistantTC.isFunction(lType)) {
	    ...
	    if (preName == null || !preName.equals("")) {
		obligations
			.add(new org.overture.pog.FuncIterationObligation(
	...
	if (finiteTest) {
	    obligations
		    .add(new org.overture.pog.FiniteSetObligation(
