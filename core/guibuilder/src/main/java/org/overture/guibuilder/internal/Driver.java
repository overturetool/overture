...
//					org.overture.guibuilder.internal.ir.IVdmClassReader reader = new org.overture.guibuilder.internal.ir.VdmjVdmClassReader();
...
//							ui.buildAndRender(reader, projectName, files.get(0).getPath().substring(0, files.get(0).getPath().lastIndexOf("/") + 1));
//						} else {
