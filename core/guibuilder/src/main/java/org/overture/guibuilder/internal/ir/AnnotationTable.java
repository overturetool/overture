...
public class AnnotationTable
{
	 ...
	 * 
	 * @param className
	 *            The name of the class that the annotation belongs to.
	 * @param annotationName
	 *            The name of the annotation.
	 * @param value
	 *            The value of the annotation
	 */
	public void addClassAnnotation(String className, String annotationName,
			String value)
	{
	 ...
	 *            The name of the class that the annotation belongs to.
	 * @param opName
	 *            The name of the operation/function that the annotation belongs to.
	 * @param annotationName
	 *            The name of the annotation.
	 * @param value
	 *            The value of the annotation.
	 */
	public void addOpAnnotation(String className, String opName,
			String annotationName, String value)
	{
	 ...
	 * 
	 * @param className
	 *            The name of the class the operation/function belongs to.
	 * @param opName
	 ...
	 * 
	 * @param className
	 *            Name of the class the operation/function belongs to.
	 * @param opName
	 *            The name of the operation/function
	 * @param annotationName
	 ...
	 */
	public boolean opHasAnnotation(String className, String opName,
	 ...
	 *            Name of the class
	 * @param annotationName
	 *            Name of the annotation to check
	 ...
	 */
	public String getValueOf(String annotationName, String parentName,
			boolean isClass)
	{
		if (isClass)
		{
	...
	/**
	 * Returns a "print out" in form of a String of the table. Used mostly for debugging purposes.
	 * 
