...
/**
 *	Class to handle the naming policies between vdm operator/classes/arguments/functions
 *	and gui elements. All information is hard coded.
 * 
 * @author carlos
 *
 */
public class NamingPolicies {
	 ...
	 * @param op - Name of the operation in the specification
	 * @param numArg - the argument's number
	 ...
	 * @param className the name of the vdm++ class
	...
	/**
	 * Given the id of a window fronting for a vdm++ class instance, returns the 
	 * name of the underlying vdm++ class
	 * @param objectWindowId The id of the window representing a class instance
	...
	/**
	 * Returns the id of a button that calls the window that exposes a vdm++ 
	 * class instance to the user
	...
	/**
	 * Returns the name to be given to a new class instance. The name is composed by 
	 * a prefix, a number and the name of the class. The number is a count of total 
	 * created instances.
	 * @param className The name of the class
	...
	/**
	 * Naming policy for a panel/container holding the text input, button and etc. widgets
	 * generated for/by a vdm operation or function.
	 * @param className The name of the class the operation/functions belongs to.
	 * @param methodName The name of the operation/function
	 * @return The id of the panel
	 */
	public static String getMethodsWidgetContainerId(String className, String methodName) {
		return "panel_" + methodName + "_" + className;
	}
	
	/**
	 * Naming policy for a panel/container holding the text input, combo, etc. widgets 
	 * generated for collecting the arguments necessary for a constructor.
	 * @param numConstructor The name of the constructor
	 ...
	 * @param className - The name of the constructor's class
	 * @param numConstructor - The number of the constructor. The count begins at '0'. That is, '0' for the first constructor.
	 * @param numArg - The number of the argument. '0' for the first argument, '1' for the second, etc.
	 * @return - Returns the id of the input widget
	 */
	public static String getConstructorWidgetId(String className, int numConstructor, int numArg) {
	 ...
	 * @param name The name of the vdm++ "method".
	 * @return The id of the label
	 */
