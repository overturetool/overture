...
// Source File Name:   OmlDelayedThreadSwapIn.java
...
public class OmlDelayedThreadSwapIn extends OmlTraceEvent
    implements IOmlDelayedThreadSwapIn
{
	...
	public String identity()
        throws CGException
    {
        return new String("DelayedThreadSwapIn");
    }
	...
	public void accept(IOmlVisitor pVisitor)
        throws CGException
    {
        pVisitor.visitDelayedThreadSwapIn(this);
    }

    public OmlDelayedThreadSwapIn(Long p1, Long p2, String p3, Long p4, Long p5, Long p6, Long p7)
        throws CGException
    {
        this();
        setId(p1);
    ...
    public void setDelay(Long parg)
        throws CGException
    {
        ivDelay = UTIL.NumberToLong(UTIL.clone(parg));
    }
