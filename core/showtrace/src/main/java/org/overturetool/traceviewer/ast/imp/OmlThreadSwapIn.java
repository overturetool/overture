...
// Source File Name:   OmlThreadSwapIn.java
...
public class OmlThreadSwapIn extends OmlTraceEvent
    implements IOmlThreadSwapIn
{
	...
	public String identity()
        throws CGException
    {
        return new String("ThreadSwapIn");
    }
	...
	public void accept(IOmlVisitor pVisitor)
        throws CGException
    {
        pVisitor.visitThreadSwapIn(this);
    }

    public OmlThreadSwapIn(Long p1, Long p2, String p3, Long p4, Long p5, Long p6)
        throws CGException
    {
        this();
        setId(p1);
