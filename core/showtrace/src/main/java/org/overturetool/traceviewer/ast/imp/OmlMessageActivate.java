...
// Source File Name:   OmlMessageActivate.java
...
public class OmlMessageActivate extends OmlTraceEvent
    implements IOmlMessageActivate
{
	...
	public String identity()
        throws CGException
    {
        return new String("MessageActivate");
    }

    public void accept(IOmlVisitor pVisitor)
        throws CGException
    {
        pVisitor.visitMessageActivate(this);
    }

    public OmlMessageActivate(Long p1, Long p2)
        throws CGException
    {
        this();
        setMsgid(p1);
