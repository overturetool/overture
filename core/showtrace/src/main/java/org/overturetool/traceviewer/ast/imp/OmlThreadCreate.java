...
// Source File Name:   OmlThreadCreate.java
...
public class OmlThreadCreate extends OmlTraceEvent
    implements IOmlThreadCreate
{
	...
	public String identity()
        throws CGException
    {
        return new String("ThreadCreate");
    }
	...
	public void accept(IOmlVisitor pVisitor)
        throws CGException
    {
        pVisitor.visitThreadCreate(this);
    }

    public OmlThreadCreate(Long p1, Boolean p2, Long p3, String p4, Long p5, Long p6)
        throws CGException
    {
        this();
        setId(p1);
        ...
        throws CGException
    {
        ...
        fname = new String("period");
        Boolean cond_13 = null;
        cond_13 = new Boolean(data.containsKey(fname));
        if(cond_13.booleanValue())
            setPeriod((Boolean)data.get(fname));
    ...
    public void setPeriod(Boolean parg)
        throws CGException
    {
        ivPeriod = (Boolean)UTIL.clone(parg);
    }
