...
// Source File Name:   OmlOpActivate.java
...
public class OmlOpActivate extends OmlTraceEvent
    implements IOmlOpActivate
{
	...
	public String identity()
        throws CGException
    {
        return new String("OpActivate");
    }

    public void accept(IOmlVisitor pVisitor)
        throws CGException
    {
        pVisitor.visitOpActivate(this);
    }

    public OmlOpActivate(Long p1, String p2, Long p3, String p4, Long p5, Boolean p6, Long p7)
        throws CGException
    {
        this();
        setId(p1);
