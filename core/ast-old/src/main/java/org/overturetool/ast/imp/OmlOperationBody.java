...
// ***** VDMTOOLS START Name=getStatement KEEP=NO
  public IOmlStatement getStatement () throws CGException {
    ...
    if (!this.pre_getStatement().booleanValue()) 
      UTIL.RunTime("Run-Time Error:Precondition failure in getStatement");
    return (IOmlStatement) ivStatement;
  }
// ***** VDMTOOLS END Name=getStatement


// ***** VDMTOOLS START Name=pre_getStatement KEEP=NO
  public Boolean pre_getStatement () throws CGException {
    return hasStatement();
  }
// ***** VDMTOOLS END Name=pre_getStatement
