...
public class JavaClassDefinition extends JavaDefinition implements IJavaClassDefinition
{
	// private member variable (Nested)
	private Boolean m_Nested = new Boolean(false);
	...
	public void setNested(Boolean p_Nested)
	{
		// consistency check (field must be non null!)
		assert(p_Nested != null);
	...
	// visitor support
	public void accept(IJavaVisitor pVisitor) { pVisitor.visitClassDefinition(this); }

	// the identity function
	public String identify() { return "JavaClassDefinition"; }
}
