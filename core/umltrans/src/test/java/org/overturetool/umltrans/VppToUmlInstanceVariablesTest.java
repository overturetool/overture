...
public class VppToUmlInstanceVariablesTest extends XMLTestCase
{
	...
	public VppToUmlInstanceVariablesTest()
	{
		super("VDM to UML - Instance Variable Test");
	}

	public void test_simpleClass() throws Exception
	{
		VppToUmlTestRunner tc = new VppToUmlTestRunner("simpleClass.vpp");
		tc.test(this);
	}

	public void test_basicInstanceVariablesClass() throws Exception
	{
		VppToUmlTestRunner tc = new VppToUmlTestRunner("instanceVariables",
				"basicInstanceVariablesClass.vpp");
		tc.test(this);
	}
	...
	{
		VppToUmlTestRunner tc = new VppToUmlTestRunner("instanceVariables",
				"basicDefaultInstanceVariablesClass.vpp");
		tc.test(this);
	}
	...
	{
		VppToUmlTestRunner tc = new VppToUmlTestRunner("instanceVariables",
				"objectDefaultRefInstanceVariablesClass.vpp");
		tc.test(this);
	}
