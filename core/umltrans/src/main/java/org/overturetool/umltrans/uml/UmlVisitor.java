...
// ***** VDMTOOLS START Name=visitNode#1|IUmlNode KEEP=NO
  public void visitNode (final IUmlNode pNode) throws CGException {
    if (new Boolean(pNode instanceof IUmlParameters).booleanValue()) 
      visitParameters((IUmlParameters) pNode);
    else 
      if (new Boolean(pNode instanceof IUmlOperation).booleanValue()) 
        visitOperation((IUmlOperation) pNode);
      else {
        if (new Boolean(pNode instanceof IUmlModel).booleanValue()) 
          visitModel((IUmlModel) pNode);
        else {
          if (new Boolean(pNode instanceof IUmlAssociation).booleanValue()) 
            visitAssociation((IUmlAssociation) pNode);
          else {
            if (new Boolean(pNode instanceof IUmlType).booleanValue()) 
              visitType((IUmlType) pNode);
            else {
              if (new Boolean(pNode instanceof IUmlLifeLine).booleanValue()) 
                visitLifeLine((IUmlLifeLine) pNode);
              else {
                if (new Boolean(pNode instanceof IUmlNestedClassifiers).booleanValue()) 
                  visitNestedClassifiers((IUmlNestedClassifiers) pNode);
                else {
                  if (new Boolean(pNode instanceof IUmlConstraint).booleanValue()) 
                    visitConstraint((IUmlConstraint) pNode);
                  else {
                    if (new Boolean(pNode instanceof IUmlIntegerType).booleanValue()) 
                      visitIntegerType((IUmlIntegerType) pNode);
                    else {
                      if (new Boolean(pNode instanceof IUmlCallEvent).booleanValue()) 
                        visitCallEvent((IUmlCallEvent) pNode);
                      else {
                        if (new Boolean(pNode instanceof IUmlOwnedOperations).booleanValue()) 
                          visitOwnedOperations((IUmlOwnedOperations) pNode);
                        else {
                          if (new Boolean(pNode instanceof IUmlProperty).booleanValue()) 
                            visitProperty((IUmlProperty) pNode);
                          else {
                            if (new Boolean(pNode instanceof IUmlCombinedFragment).booleanValue()) 
                              visitCombinedFragment((IUmlCombinedFragment) pNode);
                            else {
                              if (new Boolean(pNode instanceof IUmlClassNameType).booleanValue()) 
                                visitClassNameType((IUmlClassNameType) pNode);
                              else {
                                if (new Boolean(pNode instanceof IUmlInteractionConstraint).booleanValue()) 
                                  visitInteractionConstraint((IUmlInteractionConstraint) pNode);
                                else {
                                  if (new Boolean(pNode instanceof IUmlMos).booleanValue()) 
                                    visitMos((IUmlMos) pNode);
                                  else {
                                    if (new Boolean(pNode instanceof IUmlBoolType).booleanValue()) 
                                      visitBoolType((IUmlBoolType) pNode);
                                    else {
                                      if (new Boolean(pNode instanceof IUmlInteractionFragment).booleanValue()) 
                                        visitInteractionFragment((IUmlInteractionFragment) pNode);
                                      else {
                                        if (new Boolean(pNode instanceof IUmlTemplateSignature).booleanValue()) 
                                          visitTemplateSignature((IUmlTemplateSignature) pNode);
                                        else {
                                          if (new Boolean(pNode instanceof IUmlParameter).booleanValue()) 
                                            visitParameter((IUmlParameter) pNode);
                                          else {
                                            if (new Boolean(pNode instanceof IUmlVisibilityKind).booleanValue()) 
                                              visitVisibilityKind((IUmlVisibilityKind) pNode);
                                            else {
                                              if (new Boolean(pNode instanceof IUmlModelElement).booleanValue()) 
                                                visitModelElement((IUmlModelElement) pNode);
                                              else {
                                                if (new Boolean(pNode instanceof IUmlParameterDirectionKind).booleanValue()) 
                                                  visitParameterDirectionKind((IUmlParameterDirectionKind) pNode);
                                                else {
                                                  if (new Boolean(pNode instanceof IUmlInteraction).booleanValue()) 
                                                    visitInteraction((IUmlInteraction) pNode);
                                                  else {
                                                    if (new Boolean(pNode instanceof IUmlTemplateParameter).booleanValue()) 
                                                      visitTemplateParameter((IUmlTemplateParameter) pNode);
                                                    else {
                                                      if (new Boolean(pNode instanceof IUmlMessageKind).booleanValue()) 
                                                        visitMessageKind((IUmlMessageKind) pNode);
                                                      else {
                                                        if (new Boolean(pNode instanceof IUmlLiteralInteger).booleanValue()) 
                                                          visitLiteralInteger((IUmlLiteralInteger) pNode);
                                                        else {
                                                          if (new Boolean(pNode instanceof IUmlMessage).booleanValue()) 
                                                            visitMessage((IUmlMessage) pNode);
                                                          else {
                                                            if (new Boolean(pNode instanceof IUmlCharType).booleanValue()) 
                                                              visitCharType((IUmlCharType) pNode);
                                                            else {
                                                              if (new Boolean(pNode instanceof IUmlMultiplicityElement).booleanValue()) 
                                                                visitMultiplicityElement((IUmlMultiplicityElement) pNode);
                                                              else {
                                                                if (new Boolean(pNode instanceof IUmlValueSpecification).booleanValue()) 
                                                                  visitValueSpecification((IUmlValueSpecification) pNode);
                                                                else {
                                                                  if (new Boolean(pNode instanceof IUmlMessageSort).booleanValue()) 
                                                                    visitMessageSort((IUmlMessageSort) pNode);
                                                                  else {
                                                                    if (new Boolean(pNode instanceof IUmlDefinitionBlock).booleanValue()) 
                                                                      visitDefinitionBlock((IUmlDefinitionBlock) pNode);
                                                                    else {
                                                                      if (new Boolean(pNode instanceof IUmlStringType).booleanValue()) 
                                                                        visitStringType((IUmlStringType) pNode);
                                                                      else {
                                                                        if (new Boolean(pNode instanceof IUmlInteractionOperatorKind).booleanValue()) 
                                                                          visitInteractionOperatorKind((IUmlInteractionOperatorKind) pNode);
                                                                        else {
                                                                          if (new Boolean(pNode instanceof IUmlBes).booleanValue()) 
                                                                            visitBes((IUmlBes) pNode);
                                                                          else {
                                                                            if (new Boolean(pNode instanceof IUmlVoidType).booleanValue()) 
                                                                              visitVoidType((IUmlVoidType) pNode);
                                                                            else {
                                                                              if (new Boolean(pNode instanceof IUmlInteractionOperand).booleanValue()) 
                                                                                visitInteractionOperand((IUmlInteractionOperand) pNode);
                                                                              else {
                                                                                if (new Boolean(pNode instanceof IUmlCollaboration).booleanValue()) 
                                                                                  visitCollaboration((IUmlCollaboration) pNode);
                                                                                else {
                                                                                  if (new Boolean(pNode instanceof IUmlClass).booleanValue()) 
                                                                                    visitClass((IUmlClass) pNode);
                                                                                  else {
                                                                                    if (new Boolean(pNode instanceof IUmlLiteralString).booleanValue()) 
                                                                                      visitLiteralString((IUmlLiteralString) pNode);
                                                                                    else {
                                                                                      if (new Boolean(pNode instanceof IUmlOwnedProperties).booleanValue()) 
                                                                                        visitOwnedProperties((IUmlOwnedProperties) pNode);
                                                                                      else {
                                                                                        if (new Boolean(pNode instanceof IUmlUnlimitedNatural).booleanValue()) 
                                                                                          visitUnlimitedNatural((IUmlUnlimitedNatural) pNode);
                                                                                        else {

                                                                                          UTIL.RunTime("Run-Time Error:Can not evaluate an error statement");
throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); //                                                                                           return;
                                                                                        }
                                                                                      }
                                                                                    }
                                                                                  }
