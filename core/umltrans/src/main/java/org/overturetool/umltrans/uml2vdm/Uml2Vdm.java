...
// ***** VDMTOOLS START Name=Init#1|IUmlModel KEEP=NO
  public IOmlDocument Init (final IUmlModel model) throws CGException {
    ...
    constraints = res_s_13;
    {
      ...
      rexpr_24 = new OmlDocument(arg_25, new OmlSpecifications(FilterIlligalClassNames(BuildClasses((IUmlModel) model))), new Vector());
...
// ***** VDMTOOLS START Name=FilterIlligalClassNames#1|Vector KEEP=NO
  private Vector FilterIlligalClassNames (final Vector classes) throws CGException {
    ...
    Vector rexpr_2 = null;
    {
      ...
      Long i = null;
      for (Iterator enm_35 = bind_l_4.iterator(); enm_35.hasNext(); ) {

        Long e_7 = UTIL.NumberToLong(enm_35.next());
        i = e_7;
        Boolean pred_15 = null;
        Boolean var1_16 = null;
        HashSet var2_18 = new HashSet();
        String unArg_19 = null;
        IOmlClass obj_20 = null;
        if ((1 <= i.intValue()) && (i.intValue() <= classes.size())) 
          obj_20 = (IOmlClass) classes.get(i.intValue() - 1);
        else 
          UTIL.RunTime("Run-Time Error:Illegal index");
        unArg_19 = obj_20.getIdentifier();
        HashSet set_23 = new HashSet();
        Enumeration enm_24 = ((Vector) UTIL.ConvertToList(unArg_19)).elements();
        while ( enm_24.hasMoreElements())
          set_23.add(enm_24.nextElement());
        var2_18 = set_23;
        var1_16 = new Boolean(!var2_18.contains(new Character('$')));
        {
          if ((pred_15 = var1_16).booleanValue()) {

            Boolean var2_25 = null;
            HashSet var2_27 = new HashSet();
            String unArg_28 = null;
            IOmlClass obj_29 = null;
            if ((1 <= i.intValue()) && (i.intValue() <= classes.size())) 
              obj_29 = (IOmlClass) classes.get(i.intValue() - 1);
            else 
              UTIL.RunTime("Run-Time Error:Illegal index");
            unArg_28 = obj_29.getIdentifier();
            HashSet set_32 = new HashSet();
            Enumeration enm_33 = ((Vector) UTIL.ConvertToList(unArg_28)).elements();
            while ( enm_33.hasMoreElements())
              set_32.add(enm_33.nextElement());
            var2_27 = set_32;
            var2_25 = new Boolean(!var2_27.contains(new Character(':')));
            pred_15 = var2_25;
          }
        }
        if (pred_15.booleanValue()) {

          IOmlClass reselem_12 = null;
          if ((1 <= i.intValue()) && (i.intValue() <= classes.size())) 
            reselem_12 = (IOmlClass) classes.get(i.intValue() - 1);
          else 
            UTIL.RunTime("Run-Time Error:Illegal index");
...
// ***** VDMTOOLS END Name=FilterIlligalClassNames#1|Vector


// ***** VDMTOOLS START Name=BuildClasses#1|IUmlModel KEEP=NO
  public Vector BuildClasses (final IUmlModel model) throws CGException {

    HashMap traceDefMap = BuildTraces((IUmlModel) model);
      ...
      IUmlClass c = null;
      {
        for (Iterator enm_32 = classes.iterator(); enm_32.hasNext(); ) {
          ...
          IOmlClass res_s_17 = null;
          {
            ...
            res_s_17 = (IOmlClass) (IOmlClass) BuildClass((IUmlClass) c, (IOmlTraceDefinitions) traceDef);
          }
...
// ***** VDMTOOLS END Name=BuildClasses#1|IUmlModel


// ***** VDMTOOLS START Name=BuildClass#2|IUmlClass|IOmlTraceDefinitions KEEP=NO
  public IOmlClass BuildClass (final IUmlClass c, final IOmlTraceDefinitions traceDef) throws CGException {
    ...
    HashSet res_s_30 = new HashSet();
    {
      ...
      IUmlDefinitionBlock d = null;
      {
        for (Iterator enm_36 = e_set_34.iterator(); enm_36.hasNext(); ) {
          ...
          res_s_30.add(BuildDefs((IUmlDefinitionBlock) d));
        }
      }
    }
    unArg_29 = res_s_30;
...
// ***** VDMTOOLS END Name=BuildClass#2|IUmlClass|IOmlTraceDefinitions


// ***** VDMTOOLS START Name=BuildDefs#1|IUmlDefinitionBlock KEEP=NO
  public HashSet BuildDefs (final IUmlDefinitionBlock db) throws CGException {
    ...
    boolean succ_2 = true;
    {
      ...
      if (succ_2) {
        ...
        var1_17 = new HashSet();
        var1_17.add((IOmlDefinitionBlock) BuildDefValues((IUmlOwnedProperties) tmp));
        HashSet var2_20 = new HashSet();
        var2_20 = new HashSet();
        var2_20.add((IOmlDefinitionBlock) BuildDefInstanceVariables((IUmlOwnedProperties) tmp));
        ...
        if (succ_2) {
          ...
          return BuildDefOperations((IUmlOwnedOperations) tmp);
        }
        else 
          return new HashSet();
      }
...
// ***** VDMTOOLS END Name=BuildDefs#1|IUmlDefinitionBlock


// ***** VDMTOOLS START Name=BuildDefValues#1|IUmlOwnedProperties KEEP=NO
  public IOmlDefinitionBlock BuildDefValues (final IUmlOwnedProperties block) throws CGException {
    ...
    HashSet res_s_17 = new HashSet();
    {
      ...
      IUmlProperty v = null;
      {
        for (Iterator enm_23 = valueProps.iterator(); enm_23.hasNext(); ) {
          ...
          res_s_17.add((IOmlValueDefinition) BuildValue((IUmlProperty) v));
        }
      }
    }
    val = res_s_17;
...
// ***** VDMTOOLS END Name=BuildDefValues#1|IUmlOwnedProperties


// ***** VDMTOOLS START Name=BuildValue#1|IUmlProperty KEEP=NO
  public IOmlValueDefinition BuildValue (final IUmlProperty prop) throws CGException {
    ...
    type = (IOmlType) ConvertType((IUmlType) par_17, (IUmlMultiplicityElement) multiplicity);
    IOmlExpression expr = null;
    IUmlValueSpecification par_20 = null;
    par_20 = (IUmlValueSpecification) prop.getDefault();
    expr = (IOmlExpression) GetDefaultExpression((IUmlValueSpecification) par_20, (IOmlType) type);
    IOmlExpression expression = null;
    if (new Boolean(UTIL.equals(expr, null)).booleanValue()) 
      expression = (IOmlExpression) new OmlUndefinedExpression();
    else 
      expression = (IOmlExpression) expr;
...
// ***** VDMTOOLS END Name=BuildValue#1|IUmlProperty


// ***** VDMTOOLS START Name=BuildDefInstanceVariables#1|IUmlOwnedProperties KEEP=NO
  public IOmlDefinitionBlock BuildDefInstanceVariables (final IUmlOwnedProperties block) throws CGException {
    ...
    HashSet res_s_17 = new HashSet();
    {
      ...
      IUmlProperty v = null;
      {
        for (Iterator enm_23 = valueProps.iterator(); enm_23.hasNext(); ) {
          ...
          IUmlProperty elem_22 = (IUmlProperty) enm_23.next();
          v = (IUmlProperty) elem_22;
          res_s_17.add((IOmlInstanceVariable) BuildInstanceVariable((IUmlProperty) v));
        }
      }
    }
    val = res_s_17;
...
// ***** VDMTOOLS END Name=BuildDefInstanceVariables#1|IUmlOwnedProperties


// ***** VDMTOOLS START Name=BuildInstanceVariable#1|IUmlProperty KEEP=NO
  public IOmlInstanceVariable BuildInstanceVariable (final IUmlProperty prop) throws CGException {
    ...
    if (cond_19.booleanValue()) {
      ...
      IUmlValueSpecification par_20 = null;
      par_20 = (IUmlValueSpecification) prop.getDefault();
      expression = (IOmlExpression) GetDefaultExpression((IUmlValueSpecification) par_20, (IOmlType) type);
    }
    else 
      expression = null;
...
// ***** VDMTOOLS END Name=BuildInstanceVariable#1|IUmlProperty


// ***** VDMTOOLS START Name=BuildDefOperations#1|IUmlOwnedOperations KEEP=NO
  public HashSet BuildDefOperations (final IUmlOwnedOperations block) throws CGException {

    HashSet props = new HashSet();
    props = block.getOperationList();
    ...
    HashSet res_s_12 = new HashSet();
    {
      ...
      IUmlOperation v = null;
      {
        for (Iterator enm_20 = valOps.iterator(); enm_20.hasNext(); ) {
          ...
          if (pred_15.booleanValue()) {
            res_s_12.add((IOmlOperationDefinition) BuildOperation((IUmlOperation) v));
          }
        }
      }
    }
      ...
      IUmlOperation v = null;
      {
        for (Iterator enm_29 = valOps.iterator(); enm_29.hasNext(); ) {
          ...
          if (pred_25.booleanValue()) {
            res_s_22.add((IOmlFunctionDefinition) BuildFunction((IUmlOperation) v));
          }
        }
      }
    }
...
// ***** VDMTOOLS END Name=BuildDefOperations#1|IUmlOwnedOperations


// ***** VDMTOOLS START Name=BuildOperation#1|IUmlOperation KEEP=NO
  public IOmlOperationDefinition BuildOperation (final IUmlOperation prop) throws CGException {
...
// ***** VDMTOOLS END Name=BuildOperation#1|IUmlOperation
...
// ***** VDMTOOLS START Name=BuildParameters#2|Vector|Boolean KEEP=NO
  private Tuple BuildParameters (final Vector parms, final Boolean buildFunction) throws CGException {
    if (new Boolean(UTIL.equals(parms, new Vector())).booleanValue()) {
      ...
      IOmlType type = (IOmlType) (IOmlType) BuildParameterType(parms, buildFunction);
...
// ***** VDMTOOLS START Name=Flip#1|Vector KEEP=NO
  public Vector Flip (final Vector list) throws CGException {
    ...
    if (new Boolean(new Long(list.size()).intValue() == new Long(1).intValue()).booleanValue()) {
      ...
      varRes_2 = new Vector();
      varRes_2.add((IOmlPatternIdentifier) list.get(0));
    }
    else 
      if (new Boolean(UTIL.equals(list, new Vector())).booleanValue()) 
        varRes_2 = new Vector();
      else {

        Vector var2_11 = null;
        var2_11 = new Vector();
        var2_11.add((IOmlPatternIdentifier) list.get(0));
        varRes_2 = (Vector) Flip(new Vector(list.subList(1, list.size()))).clone();
        varRes_2.addAll(var2_11);
      }
    return varRes_2;
  }
...
// ***** VDMTOOLS START Name=LenPL#1|Vector KEEP=NO
  private Long LenPL (final Vector list) throws CGException {
    return new Long(list.size());
  }
// ***** VDMTOOLS END Name=LenPL#1|Vector
...
// ***** VDMTOOLS START Name=BuildFunction#1|IUmlOperation KEEP=NO
  public IOmlFunctionDefinition BuildFunction (final IUmlOperation prop) throws CGException {
...
// ***** VDMTOOLS END Name=BuildFunction#1|IUmlOperation
...
// ***** VDMTOOLS START Name=ExtractBinaryAssociation#1|HashSet KEEP=NO
  public void ExtractBinaryAssociation (final HashSet props) throws CGException {
    ...
    HashSet res_s_58 = new HashSet();
    {
      ...
      IUmlProperty p = null;
      {
        for (Iterator enm_64 = props.iterator(); enm_64.hasNext(); ) {

          IUmlProperty elem_63 = (IUmlProperty) enm_64.next();
          p = (IUmlProperty) elem_63;
          Boolean pred_60 = null;
          pred_60 = p.hasQualifier();
          if (pred_60.booleanValue()) {

            IUmlType res_s_59 = null;
            res_s_59 = (IUmlType) p.getQualifier();
    ...
    qualifiers = res_s_58;
    IOmlType tmpType = null;
    IUmlType par_66 = null;
    par_66 = (IUmlType) pTypeEnd.getType();
    tmpType = (IOmlType) ConvertType((IUmlType) par_66, (IUmlMultiplicityElement) multiplicity);
    Object tmpVal_68 = null;
    if (new Boolean(new Long(qualifiers.size()).intValue() == new Long(0).intValue()).booleanValue()) 
      tmpVal_68 = tmpType;
    else {

      HashSet tmpSet_74 = new HashSet();
      tmpSet_74 = qualifiers;
      IUmlType a = null;
      boolean succ_76 = false;
      for (Iterator enm_78 = tmpSet_74.iterator(); enm_78.hasNext() && !succ_76; ) {

        IUmlType tmpElem_77 = (IUmlType) enm_78.next();
        succ_76 = true;
        a = (IUmlType) tmpElem_77;
      }
      if (!succ_76) 
        UTIL.RunTime("Run-Time Error:The binding environment was empty");
      tmpVal_68 = new OmlGeneralMapType((IOmlType) ConvertType((IUmlType) a, null), tmpType);
    }
    Object type = null;
    type = tmpVal_68;
...
// ***** VDMTOOLS START Name=CreateInstanceVar#2|IUmlProperty|IOmlType KEEP=NO
  public IOmlInstanceVariable CreateInstanceVar (final IUmlProperty prop, final IOmlType type) throws CGException {
    ...
    if (cond_20.booleanValue()) {
      ...
      expression = (IOmlExpression) GetDefaultExpression((IUmlValueSpecification) par_21, (IOmlType) type1);
    }
    else 
      expression = null;
    OmlAssignmentDefinition assignmentDef = null;
...
throw new CGException(); //             return new IOmlScope();
          }
        }
      }
    }
  ...
  public IOmlType ConvertType (final IUmlType t, final IUmlMultiplicityElement mul) throws CGException {
    ...
    boolean succ_3 = true;
    {
      ...
      if (succ_3) {
        ...
        IOmlType rexpr_37 = null;
        OmlTypeName par_38 = null;
        OmlName arg_39 = null;
        String arg_41 = null;
        arg_41 = tmp.getName();
        arg_39 = new OmlName(null, arg_41);
        par_38 = new OmlTypeName(arg_39);
        rexpr_37 = (IOmlType) ApplyMultiplicity((IOmlType) par_38, (IUmlMultiplicityElement) mul);
        return (IOmlType) rexpr_37;
      }
      else {
...
// ***** VDMTOOLS START Name=ApplyMultiplicity#2|IOmlType|IUmlMultiplicityElement KEEP=NO
  private IOmlType ApplyMultiplicity (final IOmlType t, final IUmlMultiplicityElement mul) throws CGException {
    if (new Boolean(UTIL.equals(mul, null)).booleanValue()) 
      ...
      Boolean var1_16 = null;
      Long var1_17 = null;
      var1_17 = mul.getLower();
      var1_16 = new Boolean(var1_17.intValue() == new Long(0).intValue());
      {
        if ((cond_15 = var1_16).booleanValue()) {

          Boolean var2_19 = null;
          Boolean unArg_20 = null;
          unArg_20 = mul.hasUpper();
...
// ***** VDMTOOLS START Name=BuildTraces#1|IUmlModel KEEP=NO
  private HashMap BuildTraces (final IUmlModel model) throws CGException {
      ...
      HashSet res_s_20 = new HashSet();
      {
        ...
        IUmlInteraction interaction = null;
        {
          for (Iterator enm_26 = collOwnedBehavior.iterator(); enm_26.hasNext(); ) {
            ...
            res_s_20.add(BuildTrace((IUmlInteraction) interaction));
          }
        }
      }
      unArg_19 = res_s_20;
...
// ***** VDMTOOLS END Name=BuildTraces#1|IUmlModel


// ***** VDMTOOLS START Name=BuildTrace#1|IUmlInteraction KEEP=NO
  private HashMap BuildTrace (final IUmlInteraction interaction) throws CGException {
    ...
    HashMap varRes_2 = new HashMap();
    {
      ...
      messages = interaction.getMessages();
      {
        ...
        defs = (IOmlTraceDefinition) GetTraceDefinition(messages, par_9, null);
        {
          ...
          Vector arg_29 = null;
          OmlNamedTrace e_seq_30 = null;
          Vector arg_31 = null;
          arg_31 = new Vector();
          arg_31.add(name);
          e_seq_30 = new OmlNamedTrace(arg_31, defs);
          arg_29 = new Vector();
          arg_29.add(e_seq_30);
...
// ***** VDMTOOLS END Name=BuildTrace#1|IUmlInteraction
...
// ***** VDMTOOLS START Name=GetTraceDefinition#3|Vector|HashSet|IUmlInteractionOperand KEEP=NO
  private IOmlTraceDefinition GetTraceDefinition (final Vector msgs, final HashSet fg, final IUmlInteractionOperand io) throws CGException {
    ...
    if (new Boolean((new Long(msgs.size()).intValue()) > (new Long(0).intValue())).booleanValue()) {
      ...
      cfg = res_s_21;
      IUmlInteractionOperand op = (IUmlInteractionOperand) (IUmlInteractionOperand) GetOperand((IUmlMessage) m, cfg);
      ...
      if (cond_33.booleanValue()) {
        ...
        {
          if ((cond_76 = new Boolean(!UTIL.equals(op, null))).booleanValue()) {

            Boolean var2_80 = null;
            Long var1_81 = null;
            IUmlInteractionOperatorKind obj_82 = null;
            obj_82 = (IUmlInteractionOperatorKind) (IUmlInteractionOperatorKind) GetCfIoKind(fg, (IUmlInteractionOperand) op);
            var1_81 = obj_82.getValue();
            var2_80 = new Boolean(var1_81.intValue() == UmlInteractionOperatorKindQuotes.IQLOOP.intValue());
            cond_76 = var2_80;
          }
        }
        if (cond_76.booleanValue()) {
          ...
          {
            if ((cond_46 = new Boolean(!UTIL.equals(op, null))).booleanValue()) {

              Boolean var2_50 = null;
              Long var1_51 = null;
              IUmlInteractionOperatorKind obj_52 = null;
              obj_52 = (IUmlInteractionOperatorKind) (IUmlInteractionOperatorKind) GetCfIoKind(fg, (IUmlInteractionOperand) op);
              var1_51 = obj_52.getValue();
              var2_50 = new Boolean(var1_51.intValue() == UmlInteractionOperatorKindQuotes.IQALT.intValue());
              cond_46 = var2_50;
            }
          }
  ...
  private IOmlTraceRepeatPattern GetRpEx (final IUmlInteractionOperand iOperand) throws CGException {
    ...
    if (new Boolean(UTIL.equals(iOperand, null)).booleanValue()) 
      ...
      if (cond_7.booleanValue()) {
        ...
        {
          if ((var1_22 = new Boolean(!UTIL.equals(min, null))).booleanValue()) 
            var1_22 = new Boolean(min.intValue() == new Long(0).intValue());
        }
        {
          if ((cond_21 = var1_22).booleanValue()) 
            cond_21 = new Boolean(UTIL.equals(max, null));
        }
        if (cond_21.booleanValue()) 
          ...
          Boolean var1_62 = null;
          {
            if ((var1_62 = new Boolean(!UTIL.equals(min, null))).booleanValue()) 
              var1_62 = new Boolean(min.intValue() == new Long(1).intValue());
          }
          {
            if ((cond_61 = var1_62).booleanValue()) 
              cond_61 = new Boolean(UTIL.equals(max, null));
          }
  ...
  private IOmlTraceDefinition GetAltDef (final Vector msgs, final IUmlMessage m, final HashSet fg, final IUmlInteractionOperand io) throws CGException {
    ...
    OmlTraceChoiceDefinition varRes_5 = null;
    {
      ...
      if (new Boolean(!UTIL.equals(vdm_rest, null)).booleanValue()) {
        ...
        defs = new Vector();
        defs.add(new OmlTraceDefinitionItem(new Vector(), mapp, null));
        defs.add(vdm_rest);
      }
      else {
  ...
  private IUmlInteractionOperatorKind GetCfIoKind (final HashSet fms, final IUmlInteractionOperand io) throws CGException {
    ...
    IUmlInteractionOperatorKind varRes_3 = null;
    {
      ...
      HashSet res_s_8 = new HashSet();
      {
        ...
        IUmlCombinedFragment f = null;
        {
          for (Iterator enm_22 = fms.iterator(); enm_22.hasNext(); ) {

            IUmlCombinedFragment elem_21 = (IUmlCombinedFragment) enm_22.next();
            f = (IUmlCombinedFragment) elem_21;
            Boolean pred_10 = null;
            {
              if ((pred_10 = new Boolean(f instanceof IUmlCombinedFragment)).booleanValue()) {
                ...
                unArg_16 = f.getOperand();
                HashSet set_17 = new HashSet();
                Enumeration enm_18 = unArg_16.elements();
                while ( enm_18.hasMoreElements())
                  set_17.add(enm_18.nextElement());
                var2_15 = set_17;
                var2_13 = new Boolean(var2_15.contains(io));
                pred_10 = var2_13;
              }
            }
            if (pred_10.booleanValue()) {
      ...
      for (Iterator enm_23 = tmpSet_4.iterator(); enm_23.hasNext() && !succ_6; ) {

        IUmlCombinedFragment tmpElem_7 = (IUmlCombinedFragment) enm_23.next();
        succ_6 = true;
