...
throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); //             return new IOmlScope();
          }
        }
      }
    }
  ...
  public IOmlType ConvertType (final IUmlType t, final IUmlMultiplicityElement mul) throws CGException {
    ...
    boolean succ_3 = true;
    {
      ...
      if (succ_3) {
        ...
        IOmlType rexpr_35 = null;
        OmlTypeName par_36 = null;
        OmlName arg_37 = null;
        {
          ...
          String arg_41 = null;
          arg_41 = tmp.getName();
          arg_37 = new OmlName(null, arg_41);
        }
        par_36 = new OmlTypeName(arg_37);
        rexpr_35 = (IOmlType) ApplyMultiplicity((IOmlType) par_36, (IUmlMultiplicityElement) mul);
  ...
  private IOmlType ApplyMultiplicity (final IOmlType t, final IUmlMultiplicityElement mul) throws CGException {
    if (new Boolean(UTIL.equals(mul, null)).booleanValue()) 
      ...
      if (cond_6.booleanValue()) 
        ...
        Long var1_14 = null;
        var1_14 = mul.getLower();
        var1_13 = new Boolean(var1_14.intValue() == new Long(1).intValue());
        {
          if ((cond_12 = var1_13).booleanValue()) {

            Boolean var2_16 = null;
            Boolean unArg_17 = null;
            unArg_17 = mul.hasUpper();
