...
// ***** VDMTOOLS START Name=CreateXmlFile#1|IUmlModel KEEP=NO
  protected void CreateXmlFile (final IUmlModel m) throws CGException {
    ...
    doc.StartA(new String("xmi:type"), new String("uml:Model"));
    ...
    AddStdTypes();
    HashSet tmpArg_v_49 = new HashSet();
    tmpArg_v_49 = m.getDefinitions();
    GenerateClassIds(tmpArg_v_49);
    HashSet tmpArg_v_51 = new HashSet();
    HashSet res_s_52 = new HashSet();
    {

      HashSet e_set_57 = new HashSet();
      e_set_57 = m.getDefinitions();
      IUmlModelElement d = null;
      {
        for (Iterator enm_59 = e_set_57.iterator(); enm_59.hasNext(); ) {

          IUmlModelElement elem_58 = (IUmlModelElement) enm_59.next();
          d = (IUmlModelElement) elem_58;
    ...
    tmpArg_v_51 = res_s_52;
    AddDefinitions(tmpArg_v_51);
    HashSet tmpArg_v_61 = new HashSet();
    HashSet res_s_62 = new HashSet();
    {

      HashSet e_set_67 = new HashSet();
      e_set_67 = m.getDefinitions();
      IUmlModelElement d = null;
      {
        for (Iterator enm_69 = e_set_67.iterator(); enm_69.hasNext(); ) {

          IUmlModelElement elem_68 = (IUmlModelElement) enm_69.next();
          d = (IUmlModelElement) elem_68;
    ...
    tmpArg_v_61 = res_s_62;
    AddDefinitions(tmpArg_v_61);
    HashSet tmpArg_v_71 = new HashSet();
    HashSet res_s_72 = new HashSet();
    {

      HashSet e_set_77 = new HashSet();
      e_set_77 = m.getDefinitions();
      IUmlModelElement d = null;
      {
        for (Iterator enm_79 = e_set_77.iterator(); enm_79.hasNext(); ) {

          IUmlModelElement elem_78 = (IUmlModelElement) enm_79.next();
          d = (IUmlModelElement) elem_78;
    ...
    tmpArg_v_71 = res_s_72;
    AddDefinitions(tmpArg_v_71);
...
// ***** VDMTOOLS START Name=AddOperstionParameters#1|Vector KEEP=NO
  protected void AddOperstionParameters (final Vector pars) throws CGException {
    ...
    iset_2 = riseq_11;
    Long i = null;
    for (Iterator enm_47 = iset_2.iterator(); enm_47.hasNext(); ) {

      Long elem_3 = UTIL.NumberToLong(enm_47.next());
      i = elem_3;
      {

        Boolean cond_14 = null;
        Boolean unArg_15 = null;
        IUmlType obj_16 = null;
        IUmlParameter obj_17 = null;
        if ((1 <= i.intValue()) && (i.intValue() <= pars.size())) 
          obj_17 = (IUmlParameter) pars.get(i.intValue() - 1);
        else 
          UTIL.RunTime("Run-Time Error:Illegal index");
        obj_16 = (IUmlType) obj_17.getType();
        unArg_15 = new Boolean(obj_16 instanceof IUmlVoidType);
        cond_14 = new Boolean(!unArg_15.booleanValue());
        if (cond_14.booleanValue()) {

          doc.StartE(new String("ownedParameter"));
          String par_24 = null;
          IUmlParameter obj_25 = null;
          if ((1 <= i.intValue()) && (i.intValue() <= pars.size())) 
            obj_25 = (IUmlParameter) pars.get(i.intValue() - 1);
          else 
            UTIL.RunTime("Run-Time Error:Illegal index");
          par_24 = obj_25.getName();
          doc.StartA(new String("name"), par_24);
          String par_30 = null;
          IUmlParameterDirectionKind par_31 = null;
          IUmlParameter obj_32 = null;
          if ((1 <= i.intValue()) && (i.intValue() <= pars.size())) 
            obj_32 = (IUmlParameter) pars.get(i.intValue() - 1);
          else 
            UTIL.RunTime("Run-Time Error:Illegal index");
          par_31 = (IUmlParameterDirectionKind) obj_32.getDirection();
          par_30 = ConvertParameterDirectionKind((IUmlParameterDirectionKind) par_31);
          doc.StartA(new String("direction"), par_30);
          doc.StartA(ID_uTAG, GetNextId());
          String par_40 = null;
          IUmlType par_41 = null;
          IUmlParameter obj_42 = null;
          if ((1 <= i.intValue()) && (i.intValue() <= pars.size())) 
            obj_42 = (IUmlParameter) pars.get(i.intValue() - 1);
          else 
            UTIL.RunTime("Run-Time Error:Illegal index");
          par_41 = (IUmlType) obj_42.getType();
          par_40 = GetTypeId((IUmlType) par_41);
          doc.StartA(new String("type"), par_40);
...
// ***** VDMTOOLS START Name=AddNestedClassifiers#2|String|IUmlNestedClassifiers KEEP=NO
  protected void AddNestedClassifiers (final String ownerId, final IUmlNestedClassifiers nc) throws CGException {
    ...
    IUmlType a = null;
    for (Iterator enm_46 = iset_3.iterator(); enm_46.hasNext(); ) {

      IUmlType elem_4 = (IUmlType) enm_46.next();
      a = (IUmlType) elem_4;
      if (new Boolean(a instanceof IUmlClassNameType).booleanValue()) {
        ...
        IUmlClassNameType ct = (IUmlClassNameType) a;
        {
          ...
          doc.StartA(new String("supplier"), ownerId);
          {
            ...
            cond_29 = new Boolean(classes.containsKey(name));
            if (cond_29.booleanValue()) {

              doc.StartA(new String("client"), UTIL.ConvertToString(classes.get(name)));
              Tuple mr_39 = new Tuple(2);
              mr_39 = new Tuple(2);
              mr_39.SetField(1, ownerId);
              mr_39.SetField(2, UTIL.ConvertToString(classes.get(name)));
              dependencies.put(ncId, mr_39);
            }
          }
