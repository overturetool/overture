      ...
      if (new Boolean(a instanceof IUmlClassNameType).booleanValue()) {
        ...
        IUmlClassNameType ct = (IUmlClassNameType) a;
        {
          ...
          doc.StartA(new String("supplier"), ownerId);
          {
            ...
            String var1_30 = null;
            var1_30 = ct.getName();
            cond_29 = new Boolean(classes.containsKey(var1_30));
            if (cond_29.booleanValue()) {

              String par_34 = null;
              String tmppar_36 = null;
              tmppar_36 = ct.getName();
              par_34 = UTIL.ConvertToString(classes.get(tmppar_36));
              doc.StartA(new String("client"), par_34);
              Tuple mr_39 = new Tuple(2);
              mr_39 = new Tuple(2);
              mr_39.SetField(1, ownerId);
              String tmpVar_41 = null;
              String tmppar_43 = null;
              tmppar_43 = ct.getName();
              tmpVar_41 = UTIL.ConvertToString(classes.get(tmppar_43));
              mr_39.SetField(2, tmpVar_41);
