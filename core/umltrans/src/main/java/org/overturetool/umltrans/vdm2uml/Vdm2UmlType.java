...
// ***** VDMTOOLS START Name=child KEEP=NO
  static protected external_Vdm2UmlType child = new external_Vdm2UmlType();
...
// ***** VDMTOOLS START Name=GenFnType#2|Vector|Vector KEEP=NO
  static public IOmlPartialFunctionType GenFnType (final Vector pattype_ul, final Vector restype_ul) throws CGException {

    IOmlPartialFunctionType childResult_3 = child.impl_GenFnType(pattype_ul, restype_ul);
    return childResult_3;
  }
// ***** VDMTOOLS END Name=GenFnType#2|Vector|Vector
