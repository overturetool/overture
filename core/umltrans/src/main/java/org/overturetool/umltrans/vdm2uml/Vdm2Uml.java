...
// ***** VDMTOOLS START Name=Init#1|IOmlSpecifications KEEP=NO
  public IUmlModel Init (final IOmlSpecifications specs) throws CGException {
    ...
    tmpVal_3 = (UmlModel) (UmlModel) BuildUml((IOmlSpecifications) specs);
    UmlModel model = null;
...
// ***** VDMTOOLS START Name=BuildClass#1|IOmlClass KEEP=NO
  public IUmlClass BuildClass (final IOmlClass c) throws CGException {
    ...
    log.addNewClassInfo(par_3);
    {
      ...
      Vector tmpVal_68 = null;
      tmpVal_68 = GetSuperClasses((IOmlInheritanceClause) inh);
      Vector supers = null;
      supers = tmpVal_68;
      ...
      Vector par_73 = null;
      par_73 = c.getGenericTypes();
      templateParameters = (IUmlTemplateSignature) GetGenericTypes(par_73);
