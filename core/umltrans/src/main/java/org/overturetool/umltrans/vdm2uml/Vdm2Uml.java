  ...
  public IUmlOperation BuildOperation (final IOmlOperationDefinition var_1_1, final String var_2_2) throws CGException {
      ...
      UTIL.RunTime("Run-Time Error:Pattern match failed in operation call in operation BuildOperation");
    {
      ...
      if (new Boolean(shapegeneric instanceof IOmlExplicitOperation).booleanValue()) {
        ...
        Vector pars = null;
        Vector par_73 = null;
        par_73 = shape.getParameterList();
        {

          Vector par_74 = null;
          par_74 = shape.getParameterList();
          IOmlType par_75 = null;
          par_75 = (IOmlType) shape.getType();
          pars = (Vector) UTIL.ConvertToList(buildParameters(par_74, par_75));
        }
        ...
        if (new Boolean(shapegeneric instanceof IOmlExtendedExplicitOperation).booleanValue()) {
          ...
          UmlOperation rexpr_56 = null;
          UmlParameters arg_63 = null;
          Vector arg_64 = null;
          arg_64 = (Vector) pars.clone();
          arg_64.addAll(res);
          arg_63 = new UmlParameters(arg_64);
          rexpr_56 = new UmlOperation(name, visibility, multiplicity, new Boolean(false), type, isStatic, arg_63);
          return (IUmlOperation) rexpr_56;
        }
        else {
          ...
          pars = (Vector) UTIL.ConvertToList(buildParameters(pattype_ul));
          Vector res = buildFnResult(restype_ul);
          UmlOperation rexpr_31 = null;
          UmlParameters arg_38 = null;
          Vector arg_39 = null;
          arg_39 = (Vector) pars.clone();
          arg_39.addAll(res);
          arg_38 = new UmlParameters(arg_39);
          rexpr_31 = new UmlOperation(name, visibility, multiplicity, new Boolean(false), type, isStatic, arg_38);
          return (IUmlOperation) rexpr_31;
        }
    }
  }
  ...
  public IUmlOperation BuildFunction (final IOmlFunctionDefinition var_1_1, final String var_2_2) throws CGException {
      ...
      UTIL.RunTime("Run-Time Error:Pattern match failed in operation call in operation BuildFunction");
    {
      ...
      if (new Boolean(shapegeneric instanceof IOmlExplicitFunction).booleanValue()) {
        ...
        name = shape.getIdentifier();
        IUmlType type = null;
        IOmlType par_88 = null;
        par_88 = (IOmlType) shape.getType();
        type = (IUmlType) Vdm2UmlType.ConvertType(par_88);
        IOmlParameter pnames = null;
        Boolean cond_91 = null;
        Long var1_92 = null;
        Vector unArg_93 = null;
        unArg_93 = shape.getParameterList();
        var1_92 = new Long(unArg_93.size());
        cond_91 = new Boolean(var1_92.intValue() == new Long(0).intValue());
        if (cond_91.booleanValue()) 
          pnames = null;
        else {

          Vector unArg_95 = null;
          unArg_95 = shape.getParameterList();
          pnames = (IOmlParameter) unArg_95.get(0);
        }
        Vector pars = null;
        Vector par_99 = null;
        if (new Boolean(!UTIL.equals(pnames, null)).booleanValue()) 
          par_99 = pnames.getPatternList();
        else 
          par_99 = new Vector();
        {
          ...
          Vector par_104 = null;
          if (new Boolean(!UTIL.equals(pnames, null)).booleanValue()) 
            par_104 = pnames.getPatternList();
          else 
            par_104 = new Vector();
          IOmlType par_109 = null;
          par_109 = (IOmlType) shape.getType();
          pars = (Vector) UTIL.ConvertToList(buildParameters(par_104, par_109));
        }
        ...
        if (new Boolean(shapegeneric instanceof IOmlImplicitFunction).booleanValue()) {
          ...
          pars = (Vector) UTIL.ConvertToList(buildParameters(pattype_ul));
          Vector res = buildFnResult(restype_ul);
          UmlOperation rexpr_73 = null;
          UmlParameters arg_80 = null;
          Vector arg_81 = null;
          arg_81 = (Vector) pars.clone();
          arg_81.addAll(res);
          arg_80 = new UmlParameters(arg_81);
          rexpr_73 = new UmlOperation(name, visibility, multiplicity, new Boolean(true), type, isStatic, arg_80);
          return (IUmlOperation) rexpr_73;
        }
        else {
          if (new Boolean(shapegeneric instanceof IOmlExtendedExplicitFunction).booleanValue()) {
            ...
            pars = (Vector) UTIL.ConvertToList(buildParameters(pattype_ul));
            Vector res = buildFnResult(restype_ul);
            UmlOperation rexpr_47 = null;
            UmlParameters arg_54 = null;
            Vector arg_55 = null;
            arg_55 = (Vector) pars.clone();
            arg_55.addAll(res);
            arg_54 = new UmlParameters(arg_55);
            rexpr_47 = new UmlOperation(name, visibility, multiplicity, new Boolean(true), type, isStatic, arg_54);
            return (IUmlOperation) rexpr_47;
          }
          else {
