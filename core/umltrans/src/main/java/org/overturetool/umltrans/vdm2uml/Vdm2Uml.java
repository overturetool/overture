...
// ***** VDMTOOLS START Name=build_uuml#1|IOmlSpecifications KEEP=NO
  public UmlModel build_uuml (final IOmlSpecifications specs) throws CGException {
    ...
    Vector uml_uclasses = null;
    {
      ...
      Long i = null;
      for (Iterator enm_28 = bind_l_6.iterator(); enm_28.hasNext(); ) {

        Long e_9 = UTIL.NumberToLong(enm_28.next());
        i = e_9;
        ...
        var1_19 = obj_20.getIdentifier();
        HashSet var2_23 = new HashSet();
        HashSet set_25 = new HashSet();
        Enumeration enm_26 = classFilter.elements();
        while ( enm_26.hasMoreElements())
          set_25.add(enm_26.nextElement());
        var2_23 = set_25;
        pred_18 = new Boolean(!var2_23.contains(var1_19));
    ...
    UmlModel rexpr_29 = null;
    HashSet arg_31 = new HashSet();
    HashSet set_33 = new HashSet();
    Enumeration enm_34 = uml_uclasses.elements();
    while ( enm_34.hasMoreElements())
      set_33.add(enm_34.nextElement());
    arg_31 = set_33;
    rexpr_29 = new UmlModel(new String("Root"), arg_31);
    return (UmlModel) rexpr_29;
  }
