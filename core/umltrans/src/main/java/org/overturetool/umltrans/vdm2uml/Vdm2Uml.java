...
@SuppressWarnings({"all","unchecked","unused"})
  public Boolean HasSubclassResponsibilityDefinition (final Vector dBlock) throws CGException {
    ...
    HashSet hasIsSubClassResp2 = new HashSet();
    HashSet res_s_52 = new HashSet();
    {

      HashSet e_set_66 = new HashSet();
      HashSet riseq_68 = new HashSet();
      int max_69 = opList.size();
      for (int i_70 = 1; i_70 <= max_69; i_70++) 
        riseq_68.add(new Long(i_70));
      e_set_66 = riseq_68;
      Long i = null;
      {
        for (Iterator enm_72 = e_set_66.iterator(); enm_72.hasNext(); ) {

          Long elem_71 = UTIL.NumberToLong(enm_72.next());
          i = elem_71;
          Boolean pred_60 = null;
          IOmlOperationShape obj_61 = null;
          IOmlOperationDefinition obj_62 = null;
          if ((1 <= i.intValue()) && (i.intValue() <= opList.size())) 
            obj_62 = (IOmlOperationDefinition) opList.get(i.intValue() - 1);
          else 
            UTIL.RunTime("Run-Time Error:Illegal index");
          obj_61 = (IOmlOperationShape) obj_62.getShape();
          pred_60 = new Boolean(obj_61 instanceof IOmlExtendedExplicitOperation);
          if (pred_60.booleanValue()) {

            Boolean res_s_53 = null;
            {

              IOmlExtendedExplicitOperation explicitOp = null;
              IOmlOperationDefinition obj_56 = null;
              if ((1 <= i.intValue()) && (i.intValue() <= opList.size())) 
                obj_56 = (IOmlOperationDefinition) opList.get(i.intValue() - 1);
              else 
                UTIL.RunTime("Run-Time Error:Illegal index");
              explicitOp = (IOmlExtendedExplicitOperation) obj_56.getShape();
              IOmlOperationBody obj_59 = null;
              obj_59 = (IOmlOperationBody) explicitOp.getBody();
              res_s_53 = obj_59.getSubclassResponsibility();
            }
    ...
    hasIsSubClassResp2 = res_s_52;
    Boolean rexpr_73 = null;
    HashSet var2_75 = new HashSet();
    var2_75 = (HashSet) hasIsSubClassResp.clone();
    var2_75.addAll(hasIsSubClassResp2);
    rexpr_73 = new Boolean(var2_75.contains(new Boolean(true)));
    return rexpr_73;
  }
...
// ***** VDMTOOLS START Name=BuildOperation#2|IOmlOperationDefinition|String KEEP=NO
  public IUmlOperation BuildOperation (final IOmlOperationDefinition var_1_1, final String var_2_2) throws CGException {
      ...
      UTIL.RunTime("Run-Time Error:Pattern match failed in operation call in operation BuildOperation");
    {
      ...
      Boolean isStatic = null;
      isStatic = access.getStaticAccess();
      IOmlOperationShape shapegeneric = null;
      shapegeneric = (IOmlOperationShape) op.getShape();
      IUmlVisibilityKind visibility = (IUmlVisibilityKind) (IUmlVisibilityKind) ConvertScopeToVisibility((IOmlScope) scope);
      ...
      IUmlType type = null;
      if (new Boolean(shapegeneric instanceof IOmlExplicitOperation).booleanValue()) {

        IOmlExplicitOperation shape = (IOmlExplicitOperation) shapegeneric;
        String name = null;
        name = shape.getIdentifier();
        Vector pars = null;
        Vector par_77 = null;
        par_77 = shape.getParameterList();
        {

          Vector par_78 = null;
          par_78 = shape.getParameterList();
          IOmlType par_79 = null;
          par_79 = (IOmlType) shape.getType();
          pars = (Vector) UTIL.ConvertToList(buildParameters(par_78, par_79));
        }
        ...
        if (new Boolean(shapegeneric instanceof IOmlExtendedExplicitOperation).booleanValue()) {

          IOmlExtendedExplicitOperation shape = (IOmlExtendedExplicitOperation) shapegeneric;
          String name = null;
          name = shape.getIdentifier();
          ...
          Object tmpVal_51 = null;
          tmpVal_51 = null;
          IUmlType type_1 = null;
          type_1 = (IUmlType) tmpVal_51;
          IOmlParameter pnames = null;
          Vector pars = null;
          pars = (Vector) UTIL.ConvertToList(buildParameters(pattype_ul));
          Vector res = buildFnResult(restype_ul);
          UmlOperation rexpr_60 = null;
          UmlParameters arg_67 = null;
          Vector arg_68 = null;
          arg_68 = (Vector) pars.clone();
          arg_68.addAll(res);
          arg_67 = new UmlParameters(arg_68);
          rexpr_60 = new UmlOperation(name, visibility, multiplicity, new Boolean(false), type_1, isStatic, arg_67);
          return (IUmlOperation) rexpr_60;
        }
        else {

          IOmlImplicitOperation shape = (IOmlImplicitOperation) shapegeneric;
          String name = null;
          name = shape.getIdentifier();
          Vector pattype_ul = null;
          pattype_ul = shape.getPatternTypePairList();
          Vector restype_ul = null;
          restype_ul = shape.getIdentifierTypePairList();
          Object tmpVal_24 = null;
          tmpVal_24 = null;
          IUmlType type_1 = null;
          type_1 = (IUmlType) tmpVal_24;
          IOmlParameter pnames = null;
          Vector pars = null;
          pars = (Vector) UTIL.ConvertToList(buildParameters(pattype_ul));
          Vector res = buildFnResult(restype_ul);
          UmlOperation rexpr_33 = null;
          UmlParameters arg_40 = null;
          Vector arg_41 = null;
          arg_41 = (Vector) pars.clone();
          arg_41.addAll(res);
          arg_40 = new UmlParameters(arg_41);
          rexpr_33 = new UmlOperation(name, visibility, multiplicity, new Boolean(false), type_1, isStatic, arg_40);
          return (IUmlOperation) rexpr_33;
        }
    }
  }
  ...
  public IUmlOperation BuildFunction (final IOmlFunctionDefinition var_1_1, final String var_2_2) throws CGException {
      ...
      UTIL.RunTime("Run-Time Error:Pattern match failed in operation call in operation BuildFunction");
    {
      ...
      if (new Boolean(shapegeneric instanceof IOmlExplicitFunction).booleanValue()) {
        ...
        name = shape.getIdentifier();
        IUmlType type = null;
        IOmlType par_94 = null;
        par_94 = (IOmlType) shape.getType();
        type = (IUmlType) Vdm2UmlType.ConvertType(par_94);
        IOmlParameter pnames = null;
        Boolean cond_97 = null;
        Long var1_98 = null;
        Vector unArg_99 = null;
        unArg_99 = shape.getParameterList();
        var1_98 = new Long(unArg_99.size());
        cond_97 = new Boolean(var1_98.intValue() == new Long(0).intValue());
        if (cond_97.booleanValue()) 
          pnames = null;
        else {

          Vector unArg_101 = null;
          unArg_101 = shape.getParameterList();
          pnames = (IOmlParameter) unArg_101.get(0);
        }
        Vector pars = null;
        Vector par_105 = null;
        if (new Boolean(!UTIL.equals(pnames, null)).booleanValue()) 
          par_105 = pnames.getPatternList();
        else 
          par_105 = new Vector();
        {
          ...
          Vector par_110 = null;
          if (new Boolean(!UTIL.equals(pnames, null)).booleanValue()) 
            par_110 = pnames.getPatternList();
          else 
            par_110 = new Vector();
          IOmlType par_115 = null;
          par_115 = (IOmlType) shape.getType();
          pars = (Vector) UTIL.ConvertToList(buildParameters(par_110, par_115));
        }
        ...
        if (new Boolean(shapegeneric instanceof IOmlImplicitFunction).booleanValue()) {
          ...
          pars = (Vector) UTIL.ConvertToList(buildParameters(pattype_ul));
          Vector res = buildFnResult(restype_ul);
          UmlOperation rexpr_79 = null;
          UmlParameters arg_86 = null;
          Vector arg_87 = null;
          arg_87 = (Vector) pars.clone();
          arg_87.addAll(res);
          arg_86 = new UmlParameters(arg_87);
          rexpr_79 = new UmlOperation(name, visibility, multiplicity, new Boolean(true), type, isStatic, arg_86);
          return (IUmlOperation) rexpr_79;
        }
        else {
          if (new Boolean(shapegeneric instanceof IOmlExtendedExplicitFunction).booleanValue()) {

            IOmlExtendedExplicitFunction shape = (IOmlExtendedExplicitFunction) shapegeneric;
            String name = null;
            name = shape.getIdentifier();
            Vector pattype_ul = null;
            pattype_ul = shape.getPatternTypePairList();
            Vector restype_ul = null;
            restype_ul = shape.getIdentifierTypePairList();
            IUmlType fntype = null;
            IUmlType type = null;
            IOmlParameter pnames = null;
            Vector pars = null;
            pars = (Vector) UTIL.ConvertToList(buildParameters(pattype_ul));
            Vector res = buildFnResult(restype_ul);
            UmlOperation rexpr_51 = null;
            UmlParameters arg_58 = null;
            Vector arg_59 = null;
            arg_59 = (Vector) pars.clone();
            arg_59.addAll(res);
            arg_58 = new UmlParameters(arg_59);
            rexpr_51 = new UmlOperation(name, visibility, multiplicity, new Boolean(true), type, isStatic, arg_58);
            return (IUmlOperation) rexpr_51;
          }
          else {

            IOmlTypelessExplicitFunction shape = (IOmlTypelessExplicitFunction) shapegeneric;
            String name = null;
            name = shape.getIdentifier();
            IUmlType fntype = null;
            IUmlType type = null;
  ...
  public void CreateAssociationFromPropertyProductType (final IUmlProperty property, final IOmlType omlType) throws CGException {
    ...
    props = rduset_20;
    {
      ...
      if (new Boolean((new Long(props.size()).intValue()) > (new Long(1).intValue())).booleanValue()) {
        ...
        UmlAssociation elem_30 = null;
        HashSet arg_32 = new HashSet();
        arg_32 = new HashSet();
        arg_32.add(prop);
        elem_30 = new UmlAssociation(props, arg_32, null, GetNextId());
        associations.add(elem_30);
      }
    }
  }
