  ...
  private IUmlMultiplicityElement GetMultiplicity (final XmlEntity e) throws CGException {
    ...
    if (cond_44.booleanValue()) 
      ...
      Long upVal = null;
      {
        ...
        if (!succ_69) 
          UTIL.RunTime("Run-Time Error:The binding environment was empty");
        if (new Boolean(UTIL.equals(p, new String("*"))).booleanValue()) 
          upVal = new Long(-new Long(1).intValue());
        else 
      ...
      {
        if (!(cond_80 = new Boolean(new Long(upperSet.size()).intValue() == new Long(0).intValue())).booleanValue()) 
          cond_80 = new Boolean((upVal.intValue()) < (new Long(0).intValue()));
      }
