...
// ***** VDMTOOLS START Name=exstractClass#1|XmlEntity KEEP=NO
  private IUmlClass exstractClass (final XmlEntity e) throws CGException {
    ...
    UmlVisibilityKind tmpVal_44 = null;
    tmpVal_44 = (UmlVisibilityKind) new UmlVisibilityKind(UmlVisibilityKindQuotes.IQPUBLIC);
    IUmlVisibilityKind visibility = null;
    visibility = (IUmlVisibilityKind) tmpVal_44;
...
// ***** VDMTOOLS START Name=build_uProperty#2|XmlEntity|String KEEP=NO
  private IUmlProperty build_uProperty (final XmlEntity e, final String ownerClass) throws CGException {
    ...
    String name = null;
    name = ((XmlAttribute) getAttribute((XmlEntity) e, new String("name"))).val;
    Object tmpVal_8 = null;
    if (hasAttribute((XmlEntity) e, new String("visibility")).booleanValue()) 
      tmpVal_8 = GetVisibility((XmlAttribute) (XmlAttribute) getAttribute((XmlEntity) e, new String("visibility")));
    else 
      tmpVal_8 = new UmlVisibilityKind(UmlVisibilityKindQuotes.IQPRIVATE);
    IUmlVisibilityKind visibility = null;
...
// ***** VDMTOOLS START Name=build_uOperation#1|XmlEntity KEEP=NO
  private IUmlOperation build_uOperation (final XmlEntity e) throws CGException {
    ...
    String name = null;
    name = tmpVal_3;
    IUmlVisibilityKind tmpVal_7 = null;
    tmpVal_7 = (IUmlVisibilityKind) (IUmlVisibilityKind) GetVisibility((XmlAttribute) (XmlAttribute) getAttribute((XmlEntity) e, new String("visibility")));
    IUmlVisibilityKind visibility = null;
    visibility = (IUmlVisibilityKind) tmpVal_7;
...
throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); // throw new CGException(); //             return new IUmlInteractionFragment();
          }
        }
      }
    }
