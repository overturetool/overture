...
import org.overture.vdmtools.interpreter.Interpreter;
import org.overture.vdmtools.parser.Parser;

public class VDMToolsProject {
	private static boolean VDMToolsProcessStarted = false;
	public static Logger logger = Logger.getLogger("org.overtures.vdmtoolsapi");
