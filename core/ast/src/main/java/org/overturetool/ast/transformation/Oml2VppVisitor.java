...
//***** VDMTOOLS START Name=printNatField#1|Long KEEP=YES
  private void printNatField (final Long pval) throws CGException {

    String rhs_2 = null;
    rhs_2 = UTIL.ConvertToString(pval.intValue());
    result = UTIL.ConvertToString(UTIL.clone(rhs_2));
  }
// ***** VDMTOOLS END Name=printNatField#1|Long


// ***** VDMTOOLS START Name=printRealField#1|Double KEEP=YES
  private void printRealField (final Double pval) throws CGException {

    String rhs_2 = null;
    rhs_2 = UTIL.ConvertToString(pval.toString());
    result = UTIL.ConvertToString(UTIL.clone(rhs_2));
  }
