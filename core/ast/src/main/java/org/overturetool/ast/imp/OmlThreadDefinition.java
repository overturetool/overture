...
// ***** VDMTOOLS START Name=getThreadSpecification KEEP=NO
  public IOmlThreadSpecification getThreadSpecification () throws CGException {
    ...
    if (!this.pre_getThreadSpecification().booleanValue()) 
      UTIL.RunTime("Run-Time Error:Precondition failure in getThreadSpecification");
    return (IOmlThreadSpecification) ivThreadSpecification;
  }
// ***** VDMTOOLS END Name=getThreadSpecification


// ***** VDMTOOLS START Name=pre_getThreadSpecification KEEP=NO
  public Boolean pre_getThreadSpecification () throws CGException {
    return hasThreadSpecification();
  }
// ***** VDMTOOLS END Name=pre_getThreadSpecification
